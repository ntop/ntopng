      ...
      buildData: function (data, type) {
        ...
        for (var len = selectOptions.length, i = startIndex; i < len; i++) {
          ...
          if (children && children.length) {
            // NTOP_FIX :: for duplicate select entries, see the comment: https://github.com/snapappointments/bootstrap-select/issues/2562#issuecomment-809732488
            // From issue: https://github.com/snapappointments/bootstrap-select/issues/2607
