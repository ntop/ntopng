...
const load_filters_data = async function() {    
    ...
    FILTERS_CONST.sort((a, b) => a.id.localeCompare(b.id));
    i18n_ext.tags = {};
    TAG_OPERATORS = {};
    DEFINED_TAGS = {};
...
export default {
    ...
    components: {	  
   	'data-time-range-picker': Vue.defineAsyncComponent( () => ntopng_vue_loader.loadModule(`${base_path}/vue/components/data-time-range-picker.vue`, ntopng_vue_loader.loadOptions) ),
	'modal-filters': Vue.defineAsyncComponent( () => ntopng_vue_loader.loadModule(`${base_path}/vue/components/modal-filters.vue`, ntopng_vue_loader.loadOptions) ),
    },
    /**
