...
PROTOCOL AS proto,
IPv4NumToString(IPV4_SRC_ADDR) AS cli_ip,
IPv6NumToString(IPV6_SRC_ADDR) AS cli_ip_v6,
IP_SRC_PORT AS cli_port,
IPv4NumToString(IPV4_DST_ADDR) AS srv_ip,
IPv6NumToString(IPV6_DST_ADDR) AS srv_ip_v6,
