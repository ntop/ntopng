...
ALTER TABLE `flows`
  ...
  ADD COLUMN IF NOT EXISTS `APPL_LATENCY_US` UInt32,
  ...
  ADD COLUMN IF NOT EXISTS `NEXT_HOP_IP` IPv6,
  ADD COLUMN IF NOT EXISTS `NEXT_HOP_SITE` UInt16,
...
@
ALTER TABLE `flows`
  MODIFY COLUMN `FLOW_ID` COMMENT 'Unique identifier assigned by ntopng to the flow',
  ...
  MODIFY COLUMN `NEXT_HOP_IP` COMMENT 'IPv4 or IPv6 address of the next hop router for this flow; IPv4 addresses are stored as IPv4-mapped IPv6 (::ffff:a.b.c.d)',
  MODIFY COLUMN `NEXT_HOP_SITE` COMMENT 'Site/location identifier of the flow next hop',
  ...
  MODIFY COLUMN `APPL_LATENCY_US` COMMENT 'Application-level latency in microseconds (time between the first client request and the first server response payload)',
  ...
  MODIFY COLUMN `DOMAIN_NAME` COMMENT 'Domain name contacted extracted from the flow (from SNI, DNS, or HTTP Host header)',
...
ALTER TABLE `active_monitoring_alerts`
  ...
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert';
@
...
@
ALTER TABLE `engaged_active_monitoring_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
  MODIFY COLUMN `alert_status` COMMENT 'Alert lifecycle status (0=engaged/active, 1=released/archived)',
...
@
ALTER TABLE `engaged_host_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
  MODIFY COLUMN `alert_status` COMMENT 'Alert lifecycle status (0=engaged/active, 1=released/archived)',
...
@
ALTER TABLE `engaged_mac_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
  MODIFY COLUMN `alert_status` COMMENT 'Alert lifecycle status (0=engaged/active, 1=released/archived)',
...
@
ALTER TABLE `engaged_snmp_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
  MODIFY COLUMN `alert_status` COMMENT 'Alert lifecycle status (0=engaged/active, 1=released/archived)',
...
@
ALTER TABLE `engaged_network_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `local_network_id` COMMENT 'ntopng internal identifier of the local network subnet',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
...
@
ALTER TABLE `engaged_interface_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `ifid` COMMENT 'ntopng internal interface index',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
...
@
ALTER TABLE `engaged_user_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
  MODIFY COLUMN `alert_status` COMMENT 'Alert lifecycle status (0=engaged/active, 1=released/archived)',
...
@
ALTER TABLE `engaged_system_alerts`
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this alert',
  MODIFY COLUMN `rowid` COMMENT 'Unique identifier for this alert row (UUID v4)',
  MODIFY COLUMN `alert_id` COMMENT 'Alert type identifier (maps to ntopng alert type enum)',
  MODIFY COLUMN `alert_status` COMMENT 'Alert lifecycle status (0=engaged/active, 1=released/archived)',
...
@
ALTER TABLE `vulnerability_scan_data`
  ...
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that performed this scan';
@
...
@
ALTER TABLE `vulnerability_scan_report`
  ...
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that generated this report';
@
...
ALTER TABLE `assets`
  ...
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance that observed this asset';
@
...
@
ALTER TABLE `ai_chat_history`
  MODIFY COLUMN `chat_id` COMMENT 'Unique identifier for a chat session',
  MODIFY COLUMN `sequence` COMMENT 'Seq number to preserve message order within a chat',
  MODIFY COLUMN `created_at` COMMENT 'Message creation timestamp',
  MODIFY COLUMN `username` COMMENT 'Identifier of the user who created the chat',
  MODIFY COLUMN `message_role` COMMENT 'Role of message sender (user = 1, assistant = 2, summary = 3)',
  MODIFY COLUMN `message_content` COMMENT 'Raw message content (user input or assistant response)',
  MODIFY COLUMN `provider` COMMENT 'LLM provider used (local llm, anthropic, openAI)',
  MODIFY COLUMN `model` COMMENT 'Model name used for generation',
  MODIFY COLUMN `completion_time_sec` COMMENT 'Time taken to generate the assistant response (seconds)',
  MODIFY COLUMN `tokens_per_second` COMMENT 'Generation speed in tokens per second',
  MODIFY COLUMN `artifact_json` COMMENT 'JSON-encoded artifact spec (chart, ping, etc.) for assistant messages; empty for user messages',
  MODIFY COLUMN `evidence_json` COMMENT 'JSON audit trail of how the answer was produced: tool calls with inputs and result metadata',
  MODIFY COLUMN `context_summary` COMMENT 'Rolling incremental summary of the conversation up to this point (set only on summary rows where message_role = 3)',
  MODIFY COLUMN `page_context` COMMENT 'JSON describing the UI page/entity where the chat originated (e.g. {"page":"flow_details","ifid":0,"flow_key":123,"flow_hash_id":456})',
  MODIFY COLUMN `pinned` COMMENT '1 if this chat is pinned by the user, 0 otherwise';
@
...
@
ALTER TABLE `ai_token_usage`
  MODIFY COLUMN `chat_id` COMMENT 'Links to ai_chat_history session',
  MODIFY COLUMN `call_seq` COMMENT 'Iteration index within the agentic loop (1-based)',
  MODIFY COLUMN `chat_title` COMMENT 'Title of the chat (first user message, populated only on call_seq=1 of sequence=1)',
  MODIFY COLUMN `created_at` COMMENT 'Timestamp of this LLM API call',
  MODIFY COLUMN `username` COMMENT 'User who owns the chat',
  MODIFY COLUMN `call_type` COMMENT 'initial_call | tool_followup | final_response | retry',
  MODIFY COLUMN `provider` COMMENT 'LLM provider (llm_local, llm_anthropic, llm_openai)',
  MODIFY COLUMN `model` COMMENT 'Model name used for this call',
  MODIFY COLUMN `prompt_tokens` COMMENT 'Tokens sent to the model (input)',
  MODIFY COLUMN `completion_tokens` COMMENT 'Tokens generated by the model (output)',
  MODIFY COLUMN `completion_time_ms` COMMENT 'Wall time for this LLM call in milliseconds',
  MODIFY COLUMN `tool_name` COMMENT 'Tool dispatched in this call (empty if not a tool call)',
  MODIFY COLUMN `tool_params` COMMENT 'Raw parameters passed to the tool (empty if not a tool call)';
@
...
@
ALTER TABLE `ai_audit_log`
  MODIFY COLUMN `timestamp` COMMENT 'When the action was performed',
  MODIFY COLUMN `username` COMMENT 'ntopng user who triggered or approved the action',
  MODIFY COLUMN `triggered_by` COMMENT 'llm = autonomous agent action inside chatbot | user = direct UI action without chatbot',
  MODIFY COLUMN `tool_name` COMMENT 'Logical action key: create_ai_policy | add_host_alert_exclusion | add_domain_alert_exclusion | add_certificate_alert_exclusion | add_active_monitoring_script',
  MODIFY COLUMN `action_label` COMMENT 'Human-readable one-line description of what was done (e.g. "Created policy: 192.168.2.38 >10 DNS/hr")',
  MODIFY COLUMN `content` COMMENT 'JSON-encoded input parameters passed to the action',
  MODIFY COLUMN `result` COMMENT 'JSON-encoded result or error returned by the action',
  MODIFY COLUMN `success` COMMENT '1 if the action succeeded, 0 if it failed',
  MODIFY COLUMN `chat_id` COMMENT 'Chat session that triggered the action (empty for direct user actions)';
@
...
ALTER TABLE `ai_model_prices`
  MODIFY COLUMN `provider` COMMENT 'LLM provider (llm_local, llm_anthropic, llm_openai)',
  MODIFY COLUMN `model` COMMENT 'Model name',
  MODIFY COLUMN `input_price_usd` COMMENT 'Cost per million input/prompt tokens in USD',
  MODIFY COLUMN `output_price_usd` COMMENT 'Cost per million output/completion tokens in USD',
...
@
ALTER TABLE `analyst_pipelines`
  MODIFY COLUMN `pipeline_id` COMMENT 'Unique identifier for this playbook',
  MODIFY COLUMN `ifid` COMMENT 'Interface scope',
  MODIFY COLUMN `name` COMMENT 'User-defined playbook name',
  MODIFY COLUMN `description` COMMENT 'Human-readable description of the investigation',
  MODIFY COLUMN `definition` COMMENT 'Full JSON blob: {params, stages, explanation}',
  MODIFY COLUMN `created_by` COMMENT 'Username who created the playbook',
  MODIFY COLUMN `provider` COMMENT 'LLM provider used to generate the playbook (e.g. llm_anthropic, llm_openai, llm_qwen)',
  MODIFY COLUMN `llm_model` COMMENT 'Specific LLM model used (e.g. claude-opus-4-6, gpt-4o)',
  MODIFY COLUMN `created_at` COMMENT 'Creation timestamp',
  MODIFY COLUMN `updated_at` COMMENT 'Last update timestamp (used by ReplacingMergeTree)',
  MODIFY COLUMN `is_active` COMMENT '1 = active playbook, 0 = soft-deleted',
  MODIFY COLUMN `ntopng_instance_name` COMMENT 'Name of the ntopng instance this playbook is scoped to';
@
...
@
ALTER TABLE `alert_id_info`
  MODIFY COLUMN `ALERT_ID` COMMENT 'ntopng alert type identifier (maps to alert_id column in all alert tables)',
  MODIFY COLUMN `ENTITY_ID` COMMENT 'ntopng entity type: 0=interface 1=host 2=network 3=snmp 4=flow 5=mac 7=user 8=am_host 9=system 10=as',
  MODIFY COLUMN `NAME` COMMENT 'Internal Lua module name of the alert definition (e.g. flow_alert_type_blacklisted)',
  MODIFY COLUMN `LABEL` COMMENT 'Human-readable i18n alert label (e.g. "Blacklisted Flow")',
  MODIFY COLUMN `DESCRIPTION` COMMENT 'Human-readable i18n alert description (e.g. "Flow matching a known-bad threat-intel list")';
@
...
@
ALTER TABLE `flow_l4_map`
  MODIFY COLUMN `PROTOCOL` COMMENT 'IANA IP protocol number (matches flows.PROTOCOL, e.g. 6=TCP 17=UDP 1=ICMP)',
  MODIFY COLUMN `NAME` COMMENT 'Protocol name (e.g. "TCP", "UDP", "ICMP")';
@
