<template>
  <div id="navbar">
    <page-navbar id="page_navbar" :main_title="navbar_context.main_title" :base_url="navbar_context.base_url"
      :help_link="navbar_context.help_link" :items_table="navbar_context.items_table" @click_item="click_item">
    </page-navbar>
  </div>
    ...
    <div class="card">
      ...
      <div class="card-footer">
        ...
        <button type="button" id='btn-edit-all-devices-status'  class="btn btn-secondary">
          <i class='fas fa-edit'></i> {{ i18n("edit_check.edit_all_devices_status") }}
        </button>
      </div>
    </div>
  </div>
