...
.ntopng-table thead th {
  ...
  border: none !important;
  padding: 0.75rem 0.75rem !important; /* Reduced from 1rem to 0.75rem */
...
/* Row styling - consistent height for all rows, including empty ones */
.ntopng-table tbody tr {
  border: none !important;
  transition: background-color 0.2s ease !important;
  height: 2.75rem !important; /* Fixed height for consistency */
}
...
.ntopng-table tbody tr td {
  ...
  border: none !important;
  border-bottom: 1px solid #e9ecef !important;
  height: 2.75rem !important; /* Same height as tr */
  position: relative !important;
  overflow: visible !important;
}

/* Ensure empty rows have the same height */
...
input[type="search"]:focus {
  ...
  width: 220px !important; /* Slight expansion on focus */
}
...
.page-link {
  border: none !important;
  border-radius: 4px !important;
  padding: 0.4rem 0.65rem !important; /* Compact padding */
  color: #495057 !important;
  font-weight: 500 !important;
