...
import { scan_type_f,last_scan_f, duration_f, scan_frequency_f, is_ok_last_scan_f, tcp_ports_f, tcp_port_f, hosts_f, host_f, cves_f, tcp_ports_list_f  } from "../utilities/vs_report_formatter.js"; 
