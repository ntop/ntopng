        ...
        <template v-slot:body>
            <form>
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-5">
                        <SelectSearch :selected_option="selected_measurement" :options="measurements_list"
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-5">
                        <SelectSearch :selected_option="selected_granularity" :options="granularities_list"
                ...
                <div v-if="!disable_interface" class="form-group mb-3 row">
                    ...
                    <div class="col-5">
                        <SelectSearch :selected_option="selected_interface"
                            :options="interfaces_list">
                        </SelectSearch>
                    </div>
                </div>
            </form>
...
const disable_interface = ref(true);
