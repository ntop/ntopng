    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="table_asset">
                        <modal-delete-confirm ref="modal_delete_all" :title="title_delete" :body="body_delete"
                            @delete="delete_all">
                        </modal-delete-confirm>

                        <tab-list ref="asset_tab_list" id="asset_tab_list" :tab_list="tab_list"
                ...
                <div class="card-footer">
                    <button type="button" id='btn-delete-all' class="btn btn-danger me-1"><i class='fas fa-trash'></i>
                        {{ i18n("map_page.delete_assets") }}</button>
                    <a v-bind:href="get_url" class="btn btn-primary" role="button" aria-disabled="true"
                        download="asset_map.json" target="_blank"><i class="fas fa-download"></i></a>
                </div>
            </div>
