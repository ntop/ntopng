        ...
        <template v-slot:body>
            <form>
                ...
                <template v-if="!is_edit_page">
                    <div class="form-group ms-2 me-2 mt-3 row">
                        ...
                        <div class="col-sm-5 pe-0">
                            <input v-model="snmp_host" @input="check_host_regex" class="form-control"
                                :class="{ 'invalid': !is_host_correct }" type="text" :placeholder="host_placeholder"
                                required />
                ...
                <div class="form-group ms-2 me-2 mt-3 row">
                    ...
                    <div class="col-sm-5">
                        <SelectSearch v-model:selected_option="selected_version" :options="snmp_versions"
                            @select_option="update_v3_fields">
                        </SelectSearch>
                ...
                <div v-if="enable_v3_options == false" class="form-group ms-2 me-2 mt-3 row">
                    ...
                    <div class="col-sm-5">
                        <input v-model="snmp_read_community" class="form-control" type="text"
                            :class="{ 'invalid': !is_community_correct }" :placeholder="community_place_holder"
                            @input="check_community" required />
                        <small class="text-muted">{{ _i18n("snmp.descriptions.read_community") }}</small>
                    </div>
                </div>

                <!-- SNMP Write Community -->
                <div v-if="props.context.snmp_set_available && enable_v3_options == false"
                ...
                <template v-if="enable_v3_options">
                    ...
                    <div class="form-group ms-2 me-2 mt-3 row">
                        <label class="col-form-label col-sm-4">
                            <b>{{ _i18n("snmp.context") }}</b>
                        </label>
                        <div class="col-sm-5">
                            <input v-model="snmp_context" class="form-control" type="text" />
                            <small class="text-muted">{{ _i18n("snmp.descriptions.context")
                                }}</small>
                        </div>
                    </div>
                    ...
                    <template v-if="with_auth">
                        ...
                        <div class="form-group ms-2 me-2 mt-3 row">
                            ...
                            <div class="col-sm-5">
                                <SelectSearch v-model:selected_option="selected_auth_protocol"
                                    :options="snmp_auth_protocols">
                                </SelectSearch>
                                <small class="text-muted">{{ _i18n("snmp.descriptions.authentication_protocol")
                                    }}</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ms-2 me-2 mt-3 row">
                            ...
                            <div class="col-sm-5">
                                <input v-model="snmp_auth_passphrase" class="form-control" type="password"
                                    autocomplete="current-password" required @input="check_snmp_auth_passphrase"
                                    :class="{ 'invalid': !is_snmp_auth_passphrase_valid }" />
                                <small class="text-muted">{{ _i18n("snmp.descriptions.authentication_passphrase")
                                    }}</small>
                            </div>
                        </div>
                    </template>
                    ...
                    <template v-if="with_privacy">
                        <div class="form-group ms-2 me-2 mt-3 row">
                            ...
                            <div class="col-sm-5">
                                <SelectSearch v-model:selected_option="selected_privacy_protocol"
                                    :options="snmp_privacy_protocols">
                                </SelectSearch>
                        ...
                        <div class="form-group ms-2 me-2 mt-3 row">
                            ...
                            <div class="col-sm-5">
                                <input v-model="snmp_privacy_passphrase" class="form-control"
                                    autocomplete="current-password" type="password" required
                                    @input="check_snmp_privacy_passphrase"
                                    :class="{ 'invalid': !is_snmp_privacy_passphrase_valid }" />
        ...
        if (selected_version.value.id == '2') {
            ...
            snmp_entry = {
                ...snmp_entry, ...{
                    ...
                    snmp_context: snmp_context.value
                }
            }
        }
        is_data_not_ok.value = false;
