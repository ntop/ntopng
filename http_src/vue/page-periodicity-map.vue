  ...
  <div class="col-md-12 col-lg-12">
    <div class="card card-shadow">
      ...
      <div class="card-body">
          ...
          <network-map ref="periodicity_map"
      ...
      <div class="card-footer">
        ...
        <a v-bind:href="download_url" class="btn btn-primary" role="button" aria-disabled="true"  download="periodicity_map.json" target="_blank"><i class="fas fa-download"></i></a>
      </div>
    </div>
  </div>
</div>
...
export default {
  ...
  mounted() {
    ...
    ntopng_events_manager.on_custom_event("page_periodicity_map", ntopng_custom_events.CHANGE_PAGE_TITLE, (node) => {
      this.hide_dropdowns();
    });
