...
<template>
  <!-- Normal table -->
  <table v-if="!(horizontal) || (horizontal == false)" class="table table-bordered table-striped ntopng-table" style="table-layout: fixed">
  ...
  <table v-else class="table table-bordered table-striped ntopng-table">
    <tbody>
      <tr v-for="row in rows">
