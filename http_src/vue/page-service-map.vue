  ...
  <div class="col-md-12 col-lg-12">
    <div class="card card-shadow">
      ...
      <div class="card-footer">
        ...
        <a v-bind:href="download_url" class="btn btn-primary" role="button" aria-disabled="true"  download="service_map.json" target="_blank"><i class="fas fa-download"></i></a>
      </div>
    </div>
  </div>
</div>
