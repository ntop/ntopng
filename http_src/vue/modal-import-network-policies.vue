    ...
    <template v-slot:body>
      ...
      <div class="custom-file">
        <label class='form-label' for='import-input'>
          {{ _i18n("network_configuration.browse_network_policies", {}) }}
        </label>
...
let title = _i18n('network_configuration.import_policies');
let message = "";
...
const note_list = [
  i18n("network_configuration.import_network_policies_notes")
];
