...
const ntopChartApex = function () {
    ...
    // define default chartOptions for area chart type.
    const _default_TS_BAR_ChartOptions = function () {
        let chartOptions = ntopng_utility.clone(_default_BASE_ChartOptions);
        let TS_BAR_ChartOptions = {
            chart: {
                type: "bar",
                height: 300
            },
        ...
        ntopng_utility.copy_object_keys(TS_BAR_ChartOptions, chartOptions, true);
        return chartOptions;
    }();
    ...
    return {
        ...
        newChart: function (type) {
            ...
            } else if (type == this.typeChart.BAR) {
                _chartOptions = ntopng_utility.clone(_default_TS_BAR_ChartOptions);
