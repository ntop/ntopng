...
DeviceProtoStatus Ntop::getDeviceAllowedProtocolStatus(DeviceType dev_type,
  ...
  u_int16_t master_proto = ndpi_map_user_proto_id_to_ndpi_id(iface[0]->get_ndpi_struct(),
							     proto.proto.master_protocol);
  u_int16_t app_proto = ndpi_map_user_proto_id_to_ndpi_id(iface[0]->get_ndpi_struct(),
