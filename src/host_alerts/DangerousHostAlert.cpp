...
DangerousHostAlert::DangerousHostAlert(HostCallback *c, Host *f, u_int8_t cli_score, u_int8_t srv_score, u_int64_t _score, u_int8_t _consecutive_high_score) : HostAlert(c, f, cli_score, srv_score) {
  score = _score;
