...
P2PTrafficAlert::P2PTrafficAlert(HostCheck *c, Host *f, u_int8_t cli_score, u_int8_t srv_score, u_int64_t _p2p_bytes, u_int64_t _p2p_bytes_threshold) : HostAlert(c, f, cli_score, srv_score) {
