...
CountriesContactsAlert::CountriesContactsAlert(HostCheck *c, Host *f, risk_percentage cli_pctg, u_int32_t _countries_contacts, u_int32_t _countries_contacts_threshold) : HostAlert(c, f, cli_pctg) {
