...
void LocalHostStats::deserialize(json_object *o) {
  ...
  if(json_object_object_get_ex(o, "port_unreachable_flows.as_client", &obj))  port_unreachable_flows_as_client = json_object_get_int(obj);
  if(json_object_object_get_ex(o, "port_unreachable_flows.as_server", &obj))  port_unreachable_flows_as_server = json_object_get_int(obj);
