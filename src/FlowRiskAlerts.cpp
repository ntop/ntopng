...
static const FlowAlertTypeExtended risk_enum_to_alert_type[NDPI_MAX_RISK] {
    ...
    {{flow_alert_ndpi_tls_old_protocol_version, alert_category_security},
     "ndpi_tls_old_protocol_version"},

    /* NDPI_TLS_WEAK_CIPHER */
    {{flow_alert_ndpi_tls_unsafe_ciphers, alert_category_security},
     "tls_unsafe_ciphers"},

    /* NDPI_TLS_CERTIFICATE_EXPIRED */
    {{flow_alert_ndpi_tls_certificate_expired, alert_category_security},
     "tls_certificate_expired"},

    /* NDPI_TLS_CERTIFICATE_MISMATCH */
    {{flow_alert_ndpi_tls_certificate_mismatch, alert_category_security},
    ...
    {{flow_alert_ndpi_numeric_ip_host, alert_category_security},
     "ndpi_numeric_ip_host"},
    ...
    {{flow_alert_ndpi_tls_uncommon_alpn, alert_category_other},
     "ndpi_tls_uncommon_alpn"},
    ...
    {{flow_alert_ndpi_tls_suspicious_extension, alert_category_security},
     "ndpi_tls_suspicious_extension"},

    /* NDPI_TLS_FATAL_ALERT */
    {{flow_alert_ndpi_tls_fatal_alert, alert_category_other},
     "ndpi_tls_fatal_alert"},

    /* NDPI_SUSPICIOUS_ENTROPY */
    {{flow_alert_ndpi_suspicious_entropy, alert_category_security},
     "ndpi_suspicious_entropy"},
    ...
    {{flow_alert_ndpi_anonymous_subscriber, alert_category_security},
     "ndpi_anonymous_subscriber"},

    /* NDPI_UNIDIRECTIONAL_TRAFFIC */
    {{flow_alert_ndpi_unidirectional_traffic, alert_category_network},
     "ndpi_unidirectional_traffic"},

    /* NDPI_HTTP_OBSOLETE_SERVER */
    {{flow_alert_ndpi_http_obsolete_server, alert_category_security},
     "ndpi_http_obsolete_server"},

    /* NDPI_PERIODIC_FLOW */
    {{flow_alert_ndpi_periodic_flow, alert_category_network},
     "ndpi_periodic_flow"},

    /* NDPI_MINOR_ISSUES */
    {{flow_alert_ndpi_minor_issues, alert_category_network},
     "ndpi_minor_issues"},
