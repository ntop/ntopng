...
static const FlowAlertTypeExtended risk_enum_to_alert_type[NDPI_MAX_RISK]
  {
    ...
    { { flow_alert_binary_application_transfer, alert_category_security }, "binary_application_transfer" },
      
      /* NDPI_KNOWN_PROTOCOL_ON_NON_STANDARD_PORT */
    { { flow_alert_known_proto_on_non_std_port, alert_category_security }, "known_proto_on_non_std_port" },
      
      /* NDPI_TLS_SELFSIGNED_CERTIFICATE */
    { { flow_alert_tls_certificate_selfsigned, alert_category_security }, "tls_certificate_selfsigned" },
      
      /* NDPI_TLS_OBSOLETE_VERSION */
    { { flow_alert_tls_old_protocol_version, alert_category_security }, "tls_old_protocol_version" },
      
      /* NDPI_TLS_WEAK_CIPHER */
    { { flow_alert_tls_unsafe_ciphers, alert_category_security }, "tls_unsafe_ciphers" },
      
      /* NDPI_TLS_CERTIFICATE_EXPIRED */
    { { flow_alert_tls_certificate_expired,  alert_category_security }, "tls_certificate_expired" },
      
      /* NDPI_TLS_CERTIFICATE_MISMATCH */
    { { flow_alert_tls_certificate_mismatch, alert_category_security }, "tls_certificate_mismatch" },
