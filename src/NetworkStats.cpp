...
NetworkStats::NetworkStats(NetworkInterface *iface, u_int8_t _network_id) : OtherAlertableEntity(iface, alert_entity_network), GenericTrafficElement(), Score(iface) {
  const char *netname;
