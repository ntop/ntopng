...
function handler.handle_risk(risk_id, flow_score, cli_score, srv_score)
   ...
   alerts_api.trigger_status(suspicious_file_transfer_type, flow_consts.status_types.status_suspicious_file_transfer.alert_severity, cli_score or 0, srv_score or 0, flow_score or 0)
