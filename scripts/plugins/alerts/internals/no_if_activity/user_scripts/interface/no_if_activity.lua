...
local function check_interface_activity(params)
   ...
   local delta_flows = alerts_api.interface_delta_val(params.user_script.key..".flows" --[[ metric name --]], params.granularity, num_flows or 0)
   local delta_logs = alerts_api.interface_delta_val(params.user_script.key..".logs" --[[ metric name --]], params.granularity, num_logs or 0)
