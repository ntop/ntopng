...
page_utils.print_navbar(title, nav_url, {
	...
	},
	{
		...
		page_name = "alerts",
		url = http_prefix
			.. "/lua/alert_stats.lua?&page=network&network_name="
			.. network_name
			.. flowfilter_utils.SEPARATOR
			.. "eq",
...
elseif page == "overview" then
	...
	template_utils.render("pages/vue_page.template", { vue_page_name = "PageHostsListNetworksWrapper", page_context = json_context })
