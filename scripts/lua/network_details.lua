...
if page == "historical" then
    ...
    if ntop.isPro() then
      local pro_timeseries = {
        ...
        {schema="subnet:traffic_rx_behavior", label=i18n("graphs.iface_traffic_rx_behavior"), split_directions = true, first_timeseries_only = true, value_formatter = {"NtopUtils.fbits_from_bytes"}, metrics_labels = {i18n("graphs.traffic_rcvd"), i18n("graphs.lower_bound"), i18n("graphs.upper_bound")}},
        {schema="subnet:traffic_tx_behavior", label=i18n("graphs.iface_traffic_tx_behavior"), split_directions = true, first_timeseries_only = true, value_formatter = {"NtopUtils.fbits_from_bytes"}, metrics_labels = {i18n("graphs.traffic_sent"), i18n("graphs.lower_bound"), i18n("graphs.upper_bound")}},
      }
