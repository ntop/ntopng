...
local endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/host/alert/list.lua"
...
local pages = {
   {
        ...
        page_name = "all",
        label = i18n("all"),
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/all/alert/list.lua",
   ...
   },
   {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/host/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/interface/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/network/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/pro/rest/v2/get/snmp/device/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/flow/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/mac/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/system/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/am_host/alert/list.lua",
    ...
    },
    {
        ...
        endpoint_list = ntop.getHttpPrefix().."/lua/rest/v2/get/user/alert/list.lua",
