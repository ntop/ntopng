...
print [[
      ...
      <tr id="tr-disk_space">
        ...
        <td colspan=2>
          <input type="number" style="width:127px;display:inline;" class="form-control" name="disk_space" placeholder="" min="1" step="1" max="]] print(ternary((max_space/1024)>1, (max_space/1024), 1)) print [[" value="]] print(disk_space) print [["></input><span style="vertical-align: middle"> GB (]] print(i18n('traffic_recording.max_space_note', { max_space = ternary((max_space/1024)>1, (max_space/1024), 1) })) print[[)</span><br>
