...
<li class="divider"></li><li><a href="https://www.ntop.org/guides/ntopng/]]

if ntop.isnEdge() then   
   print("edge/")
end

print [[" target="_blank"><i class="fa fa-book"></i> ]] print(i18n("about.readme_and_manual")) print[[ <i class="fa fa-external-link"></i></a></li>
