...
if(info["pro.release"] == false) then
   ...
   print("<A HREF=\"https://www.ntop.org/support/faq/what-is-the-end-user-license-agreement-for-binary-products/\" target=\"_blank\">EULA</A> <i class='fas fa-external-link-alt'></i><br>")
end
