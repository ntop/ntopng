...
for k,v in pairs(lc) do
   ...
   local stop_href = "<A HREF=".. ntop.getHttpPrefix() .."/lua/stop_live_capture.lua?capture_id="..v.id.."><span class=\"badge badge-danger\">Stop <i class=\"fa fa-download\"></i></span></A>"
