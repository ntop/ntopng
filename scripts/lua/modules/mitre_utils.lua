    ...
    tactic = {
      ...
      technique = {
        ...
        ingress_tool_transfer = {
          id = 1105,
          i18n_label = "mitre.technique.ingress_tool_transfer"
        },
        internal_spearphishing = {
          id = 1534,
          i18n_label = "mitre.technique.internal_spearphishing"
        ...
        network_sniffing = {
          id = 1040,
          i18n_label = "mitre.technique.network_sniffing"
        },
        non_app_layer_proto = {
          id = 1095,
          i18n_label = "mitre.technique.non_app_layer_proto"
        ...
        scheduled_transfer = {
          id = 1029,
          i18n_label = "mitre.technique.scheduled_transfer"
        },
        search_open_tech_db = {
          id = 1596,
          i18n_label = "mitre.technique.search_open_tech_db"
      ...
      sub_technique = {
        arp_cache_poisoning = {
          id = 155702,
          i18n_label = "mitre.sub_technique.arp_cache_poisoning"
        },
        dhcp_spoofing = {
          id = 155703,
          i18n_label = "mitre.sub_technique.dhcp_spoofing"
