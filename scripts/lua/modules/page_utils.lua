...
page_utils.menu_entries = {
   ...
   -- Dashboard
    ...
    iface_traffic_rules   = {key = "iface_traffic_rules", i18n_title = "if_stats_config.traffic_rules", section = "if_stats", help_link = "https://www.ntop.org/guides/ntopng/advanced_features/host_rules.html"},
