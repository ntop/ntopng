...
local script = {
   ...
   alert_id = flow_alert_keys.flow_alert_unexpected_server_connection,
   ...
   default_value = {
      ...
      gui = {
         i18n_title        = "flow_checks.unexpected_server_connection_title",
         i18n_description  = "flow_checks.unexpected_server_connection_description",
      }
