...
flow_consts.flow_status_types = {
   [flow_consts.status_normal]                       = { i18n = i18n("flow_details.normal") },
   [flow_consts.status_slow_tcp_connection]          = { i18n = i18n("flow_details.slow_tcp_connection") },
   [flow_consts.status_slow_application_header]      = { i18n = i18n("flow_details.slow_application_header") },
   [flow_consts.status_slow_data_exchange]           = { i18n = i18n("flow_details.slow_data_exchange") },
   [flow_consts.status_low_goodput]                  = { i18n = i18n("flow_details.low_goodput") },
   [flow_consts.status_suspicious_tcp_syn_probing]   = { i18n = i18n("flow_details.suspicious_tcp_syn_probing") },
   [flow_consts.status_tcp_connection_issues]        = { i18n = i18n("flow_details.tcp_connection_issues") },
   [flow_consts.status_suspicious_tcp_probing]       = { i18n = i18n("flow_details.suspicious_tcp_probing") },
   [flow_consts.status_flow_when_interface_alerted]  = { i18n = i18n("flow_details.flow_emitted") },
   [flow_consts.status_tcp_connection_refused]       = { i18n = i18n("flow_details.tcp_connection_refused") },
   [flow_consts.status_ssl_certificate_mismatch]     = { i18n = i18n("flow_details.ssl_certificate_mismatch") },
   [flow_consts.status_dns_invalid_query]            = { i18n = i18n("flow_details.dns_invalid_query") },
   [flow_consts.status_remote_to_remote]             = { i18n = i18n("flow_details.remote_to_remote") },
   [flow_consts.status_blacklisted]                  = { i18n = i18n("flow_details.blacklisted_flow") },
   [flow_consts.status_blocked]                      = { i18n = i18n("flow_details.flow_blocked_by_bridge") },
   [flow_consts.status_web_mining_detected]          = { i18n = i18n("flow_details.web_mining_detected") },
   [flow_consts.status_device_protocol_not_allowed]  = { i18n = i18n("flow_details.suspicious_device_protocol") },
   [flow_consts.status_elephant_local_to_remote]     = { i18n = i18n("flow_details.elephant_flow_l2r") },
   [flow_consts.status_elephant_remote_to_local]     = { i18n = i18n("flow_details.elephant_flow_r2l") },
   [flow_consts.status_longlived]                    = { i18n = i18n("flow_details.longlived_flow") },
   [flow_consts.status_not_purged]                   = { i18n = i18n("flow_details.not_purged") },
   [flow_consts.status_ids_alert]                    = { i18n = i18n("alerts_dashboard.ids_alert") },
   [flow_consts.status_tcp_severe_connection_issues] = { i18n = i18n("flow_details.tcp_severe_connection_issues") },
   [flow_consts.status_ssl_unsafe_ciphers]           = { i18n = i18n("flow_details.ssl_unsafe_ciphers") },
   [flow_consts.status_data_exfiltration]            = { i18n = i18n("flow_details.data_exfiltration") },
   [flow_consts.status_ssl_old_protocol_version]     = { i18n = i18n("flow_details.ssl_old_protocol_version") },
   [flow_consts.status_potentially_dangerous]        = { i18n = i18n("flow_details.potentially_dangerous_protocol") },
   [flow_consts.status_malicious_signature]          = { i18n = i18n("alerts_dashboard.malicious_signature_detected") },
}
