...
local function formatFlowHost(flow, cli_or_srv, historical_bounds, hyperlink_suffix)
  ...
  if(flow[cli_or_srv .. ".localhost"] == true) then
     host_name = host_name .. ' <span class="badge badge-success">'..i18n("details.label_short_local_host")..'</span> '
  else 
     host_name = host_name .. ' <span class="badge badge-secondary">'..i18n("details.label_short_remote_host")..'</span> '
  end
