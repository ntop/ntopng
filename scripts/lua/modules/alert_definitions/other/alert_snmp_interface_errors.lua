...
local alert_snmp_interface_errors = classes.class(alert)

-- ##############################################

alert_snmp_interface_errors.meta = {
  alert_key = other_alert_keys.alert_snmp_interface_errors,
  i18n_title = "alerts_dashboard.snmp_interface_errors",
...
function alert_snmp_interface_errors:init(device_ip, device_name, if_index, interface_name, errors)
...
function alert_snmp_interface_errors.format(ifid, alert, alert_type_params)
  return(i18n("alerts_dashboard.snmp_interface_errors_description", {
...
return alert_snmp_interface_errors
