...
local pro_timeseries = {
  { schema = "iface:score_anomalies",         group = i18n("graphs.behavior"), priority = 1, label = i18n("graphs.iface_score_anomalies"),     measure_unit = "number", scale = 0, timeseries = { anomaly            = { label = i18n('graphs.iface_score_anomalies'),     color = timeseries_utils.get_timeseries_color('default') }}, nedge_exclude = true },
  { schema = "iface:traffic_anomalies",       group = i18n("graphs.behavior"), priority = 1, label = i18n("graphs.iface_traffic_anomalies"),   measure_unit = "number", scale = 0, timeseries = { anomaly            = { label = i18n('graphs.iface_traffic_anomalies'),   color = timeseries_utils.get_timeseries_color('default') }}, nedge_exclude = true },
  ...
  { schema = "host:srv_active_flows_anomalies", group = i18n("graphs.behavior"), priority = 1, label = i18n("graphs.srv_active_flows_anomalies"), measure_unit = "number", scale = 0, timeseries = { anomaly         = { label = i18n('graphs.iface_traffic_anomalies'),   color = timeseries_utils.get_timeseries_color('default') }}, nedge_exclude = true },
  { schema = "host:cli_active_flows_anomalies", group = i18n("graphs.behavior"), priority = 1, label = i18n("graphs.cli_active_flows_anomalies"), measure_unit = "number", scale = 0, timeseries = { anomaly         = { label = i18n('graphs.iface_traffic_anomalies'),   color = timeseries_utils.get_timeseries_color('default') }}, nedge_exclude = true },
