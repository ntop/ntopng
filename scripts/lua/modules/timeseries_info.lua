...
local community_timeseries = {
  ...
  { schema = "iface:hosts_anomalies",         label = i18n("graphs.hosts_anomalies"),           priority = 0, measure_unit = "number", scale = i18n('graphs.metric_labels.anomalies'), timeseries = { num_loc_hosts_anom = { label = i18n('graphs.loc_host_anomalies'),        color = timeseries_utils.get_timeseries_color('hosts') },       num_rem_hosts_anom = { label = i18n('graphs.rem_host_anomalies'), draw_type = "line", color = timeseries_utils.get_timeseries_color('hosts') }}},
...
local pro_timeseries = {
  ...
  { schema = "iface:traffic_rx_behavior_v2",  group = i18n("graphs.behavior"), priority = 1, label = i18n("graphs.iface_traffic_rx_behavior"), measure_unit = "bps",    scale = 0, timeseries = { value              = { label = i18n('graphs.traffic_rcvd'),              color = timeseries_utils.get_timeseries_color('bytes') }, lower_bound = { label = i18n('graphs.lower_bound'), draw_type = "line", color = timeseries_utils.get_timeseries_color('bytes') }, upper_bound = { label = i18n('graphs.upper_bound'), draw_type = "line", color = timeseries_utils.get_timeseries_color('bytes') }}, nedge_exclude = true },
  { schema = "iface:traffic_tx_behavior_v2",  group = i18n("graphs.behavior"), priority = 1, label = i18n("graphs.iface_traffic_tx_behavior"), measure_unit = "bps",    scale = 0, timeseries = { value              = { label = i18n('graphs.traffic_sent'),              color = timeseries_utils.get_timeseries_color('bytes') }, lower_bound = { label = i18n('graphs.lower_bound'), draw_type = "line", color = timeseries_utils.get_timeseries_color('bytes') }, upper_bound = { label = i18n('graphs.upper_bound'), draw_type = "line", color = timeseries_utils.get_timeseries_color('bytes') }}, nedge_exclude = true },
