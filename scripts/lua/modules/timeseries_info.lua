...
local community_timeseries = {
  ...
  { schema = "system:cpu_states",             id = timeseries_id.system, label = i18n("about.cpu_load"),                   priority = 0, measure_unit = "percentage", scale = i18n('graphs.metric_labels.load'), timeseries = { iowait_pct    = { label = i18n('about.iowait'),    color = timeseries_info.get_timeseries_color('default') },  active_pct = { label = i18n('about.active'), color = timeseries_info.get_timeseries_color('default') },  idle_pct    = { label = i18n('about.idle'),    color = timeseries_info.get_timeseries_color('default') } }, default_visible = true },
