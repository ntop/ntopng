...
local defined_toats = {
    ...
    },
    {
        ...
        dismissable = true,
        has_priority = false,
        predicate = predicates.unexpected_scripts,
        pages = EMPTY_PAGES,
        subpages = EMPTY_PAGES,
    ...
    },
    {
        ...
        dismissable = true,
        has_priority = true,
        predicate = predicates.mirrored_traffic,
        pages = EMPTY_PAGES,
        subpages = EMPTY_PAGES,
        excluded_pages = EMPTY_PAGES,
        excluded_subpages = EMPTY_PAGES
    ...
    },
    {
        ...
        dismissable = true,
        has_priority = false,
        predicate = predicates.active_scan,
        pages = {pages.active_scan.key},
        subpages = EMPTY_PAGES,
        excluded_pages = EMPTY_PAGES,
        excluded_subpages = EMPTY_PAGES
    },
    {
        ...
        dismissable = false,
        has_priority = false,
        predicate = predicates.service_map,
        pages = {pages.analysis_map.key},
        subpages = EMPTY_PAGES,
        excluded_pages = EMPTY_PAGES,
        excluded_subpages = EMPTY_PAGES
    },
    ...
    },
    {
        ...
        dismissable = true,
        has_priority = false,
        predicate = predicates.no_local_hosts,
        pages = EMPTY_PAGES,
        subpages = EMPTY_PAGES,
        excluded_pages = EMPTY_PAGES,
        excluded_subpages = EMPTY_PAGES
