...
--
-- This file specified what timeseries are shown under historical of the system interface
--
...
local timeseries_list = {
   {
	 ...
	 active_pct = {
      ...
      always_visibile = ntop.isLinux(),
      default_visible = ntop.isLinux(),
      draw_stacked = true,
   },
   {
