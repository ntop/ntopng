...
schema = ts_utils.newSchema("snmp_if:packets", {step=300, rrd_heartbeat=3000, rrd_fname="packets", is_system_schema = true})
schema:addTag("ifid")
schema:addTag("device")
schema:addTag("if_index")
...
schema = ts_utils.newSchema("am_host:val_5mins", { step = 300, metrics_type = ts_utils.metrics.gauge, aggregation_function = ts_utils.aggregation.max, is_system_schema = true })
schema:addTag("ifid")
schema:addTag("host")
...
schema = ts_utils.newSchema("am_host:https_stats_5mins", { step = 300, metrics_type = ts_utils.metrics.gauge, aggregation_function = ts_utils.aggregation.max, is_system_schema = true })
schema:addTag("ifid")
schema:addTag("host")
schema:addTag("metric")
schema:addMetric("lookup_ms")
...
schema = ts_utils.newSchema("am_host:upload_5mins", { step = 300, metrics_type = ts_utils.metrics.gauge, is_system_schema = true })
schema:addTag("ifid")
schema:addTag("host")
...
schema = ts_utils.newSchema("am_host:latency_5mins", { step = 300, metrics_type = ts_utils.metrics.gauge, is_system_schema = true })
schema:addTag("ifid")
schema:addTag("host")
