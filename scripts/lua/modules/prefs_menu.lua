...
local menu_subpages = {{
				    ...
				    },
   {
	 ...
	 mac_address_cache_duration = {
      ...
      advanced = true,
      pro_only = true,
      hidden = not ((ntop.isEnterpriseM and ntop.isEnterpriseM()) or (ntop.isnEdgeEnterprise and ntop.isnEdgeEnterprise())) or not ntop.isClickHouseEnabled(),
      entries = {
	 flow_data_retention = {
            title = i18n("prefs.flows_and_alerts_data_retention"),
            description = i18n("prefs.flows_and_alerts_data_retention_descr")
	 },
	 aggregated_asn_data_retention = {
	       ...
	       },
   {
	 ...
	 reports_data_retention_time = {
      ...
      advanced = true,
      pro_only = true,
      hidden = not ((ntop.isEnterpriseM and ntop.isEnterpriseM()) or have_nedge),
      nedge_hidden = false,
      entries = {
	 toggle_snmp_rrds = {
