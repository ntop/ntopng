...
function alert_utils.getConfigsetURL(script_key, subdir)
    return string.format('%s/lua/admin/edit_configset.lua?subdir=%s&check=%s#all', ntop.getHttpPrefix(),
        url_encode(subdir or "all"), url_encode(script_key or "all"))
end
        ...
        if (alert_entity) and (alert_entity == alert_entities.am_host.entity_id) then
            ...
            if host then
                ...
                return string.format(
                    ...
                    ntop.getHttpPrefix(), host, ternary(measurement, "&measurement=" .. measurement, ""),
            ...
            return (' <a href="' .. alert_utils.getConfigsetURL(alert_name or info.script_key, info.subdir) .. '">' ..
