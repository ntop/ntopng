...
<li> <small>]] print(i18n("geo_map.note_google_maps_browser_api_key",{url_google="https://cloud.google.com/console/google/maps-apis/overview", url_prefs=ntop.getHttpPrefix().."/lua/admin/prefs.lua?tab=misc"})) print[[</small>
</ol>
</small>
]]
