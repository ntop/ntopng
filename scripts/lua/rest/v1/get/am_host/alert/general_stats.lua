...
-- Example: curl -u admin:admin -H "Content-Type: application/json" -d '{"ifid": "1"}' http://localhost:3000/lua/rest/v1/get/am/alert/general_stats.lua
--
...
local res = am_alert_store:get_stats()
local top_alerts = {}
