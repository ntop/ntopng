...
for key, value in pairs(links) do
   ...
   print('\n{"source": "'..key..'", "source_num": '.. links[key]["num"]..', "source_type": "host", "source_pid": -1, "source_name": "'..ntop.getResolvedHostAddress(hostkey2hostinfo(key))..'", "target": "'..value["peer"]..'", "target_num": '.. value["num"]..', "target_type": "host", "target_pid": -1, "target_name": "'.. ntop.getResolvedHostAddress(hostkey2hostinfo(value["peer"]))..'", "type": "host2host"}')
   n = n + 1
end
print("\n]\n")
