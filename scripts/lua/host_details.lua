    ...
    if ((page == "overview") or (page == nil)) then
        ...
        if (host["ip"] ~= nil) then
            ...
            if ((host["privatehost"] == false) and (host["is_multicast"] == false) and (host["is_broadcast"] == false)) then
                ...
                print(' <A class="ntopng-external-link" href="https://www.greynoise.io/viz/ip/' .. host["ip"] ..
                          '" target=_blank><small>GreyNoise</small> <i class=\"fas fa-external-link-alt\"></i></A>')
            end
        ...
        print("</th><td>")
        print("<span id=num_contacted_peers_with_tcp_flows_no_response>" ..
                  formatContacts(host.num_contacted_peers_with_tcp_flows_no_response) ..
                  "</span> <span id=num_contacted_peers_with_tcp_flows_no_response_trend></span> \n")
        print("</td><td>")
        print("<span id=num_incoming_peers_that_sent_tcp_flows_no_response>" ..
                  formatContacts(host.num_incoming_peers_that_sent_tcp_flows_no_response) ..
                  "</span> <span id=num_incoming_peers_that_sent_tcp_flows_no_response_trend></span> \n")
        print("</td>")
        print("</tr>\n")
...
if (not only_historical) and (host ~= nil) and (page ~= "traffic") and (page ~= "historical") then
   ...
   $(document).ready(function() {
    ...
    print("var last_num_contacted_peers_with_tcp_flows_no_response = " ..
              host["num_contacted_peers_with_tcp_flows_no_response"] .. ";\n")
    print("var last_num_incoming_peers_that_sent_tcp_flows_no_response = " ..
              host["num_incoming_peers_that_sent_tcp_flows_no_response"] .. ";\n")
