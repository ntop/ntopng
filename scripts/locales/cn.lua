local lang = {
  ...
  ["about"] = {
    ...
    ["licence_generation"] = "单击上面的URL生成您的专业版本许可证,或在<a title=\"%{purchase_url}\">电子商店购买 <i class =\"fas fa-external-link-alt\"> </i></a>。<br>如果您是非营利组织,研究机构或教育机构,请阅读<a href=\"%{universities_url}\">此处</a> <i class = \" fas fa-external-link-alt \"> </i>。",
    ["licence_status"] = "许可证",
    ["maintenance"] = "维护",
    ["maintenance_expired"] = "%{product}维护已过期",
    ["maintenance_left"] = "直到%{_ until} [还剩%{days_left}天]",
    ["maxmind"] = "包括对<a title=\"%{maxmind_url}\"> MaxMind <i class = \" fas fa-external-link-alt \"> </i> </a>和<a title ='https： //db-ip.com'>DB-IP <i class = \" fas fa-external-link-alt \"> </i> </a>地理位置数据库的支持。",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_create_custom_scripts"] = "创建用于执行回调程序的自定义脚本的文档可在以下 <a title=\"%{url}\">链路 <i class=\"fas fa-external-link-alt\"> </i></a>。",
  ...
  ["dns_page"] = {
    ...
    ["doh_dot_servers"] = "已连接 <A title=\"https://en.wikipedia.org/wiki/DNS_over_HTTPS\" target=_blank>DoH <i class='fas fa-external-link-alt'></i></A> /<A title=\"https://en.wikipedia.org/wiki/DNS_over_TLS\" target=_blank>DoT <i class='fas fa-external-link-alt'></i></A> 服务器",
    ["error_replies"] = "错误响应",
    ["note"] = "注意",
...
["network_behavior_check_list_example"] = "要分析的网络列表，用逗号分隔",
    ...
    ["note_add_custom_scripts"] = "%{product} 在这些 <a href=\"%{url}\"> <i class=\"fas fa-folder\"></i> 目录</a>中查找自定义脚本。",
    ["note_create_custom_scripts"] = "创建用于执行回调的自定义脚本的文档可在以下 <a title=\"%{url}\">link <i class=\"fas fa-external-link-alt\"> </i></a>。",
  ...
  ["flow_details"] = {
    ...
    ["payload_type"] = "有效载荷类型",
    ["potentially_dangerous_protocol"] = "潜在危险协议",
    ["process_information_report_warning"] = "除非您将 ntopng 与 <A HREF='%{url}'>nProbe</A> 和 sprobe 插件一起使用,否则进程信息报告是有限的",
    ...
    ["tos"] = "<A target='_blank' title='https://en.wikipedia.org/wiki/Differentiated_services'>DSCP <i class='fas fa-external-link-alt'></i></A> /<A target='_blank' title='https://en.wikipedia.org/wiki/Explicit_Congestion_Notification'>ECN <i class='fas fa-external-link-alt'></i></A> [ 客户端/服务器 ]",
  ...
  ["login"] = {
    ...
    ["blacklisted_ip_notice"] = "用户认证Token",
...
["periodic_activities_descr"] = {
 ...
 ["prefs"] = {
    ...
    ["housekeeping_frequency_description"] = "一些主机统计信息,例如吞吐量会定期更新。此超时控制了 %{product} 更新这些统计信息的频率。较大的值计算量较小,并且往往会平均微小的变化。较小的值计算量更大密集并倾向于突出微小的变化。几秒钟的值是安全的。仅对数据包接口有效。对于 ZMQ 接口,超时是自动确定的。默认值：5 秒。",
    ...
    ["n2n_supernode_description"] = "<a title=\"%{url}\">n2n的地址<i class=\"fas fa-external-link-alt\"></i></a>超级节点。设置您自己的超级节点以获得完全私有的远程访问。<br><b>注意</b>：此更改仅在远程协助重启后才会生效。",
