local lang = {
  ...
  ["about"] = {
    ...
    ["licence_generation"] = "单击上面的URL生成您的专业版本许可证,或在<a href=\"%{purchase_url}\">电子商店购买</a> <i class =\"fas fa-external-link-alt\"> </i>。<br>如果您是非营利组织,研究机构或教育机构,请阅读<a href=\"%{universities_url}\">此处</a> <i class = \" fas fa-external-link-alt \"> </i>。",
    ["licence_status"] = "许可证",
    ["maintenance"] = "维护",
    ["maintenance_expired"] = "%{product}维护已过期",
    ["maintenance_left"] = "直到%{_ until} [还剩%{days_left}天]",
    ["maxmind"] = "包括对<a href=\"%{maxmind_url}\"> MaxMind <i class = \" fas fa-external-link-alt \"> </i> </a>和<a href ='https： //db-ip.com'>DB-IP <i class = \" fas fa-external-link-alt \"> </i> </a>地理位置数据库的支持。",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_create_custom_scripts"] = "创建用于执行回调程序的自定义脚本的文档可在以下 <a href=\"%{url}\">链路</a> <i class=\"fas fa-external-link-alt\"> </i>。",
  ...
  ["dns_page"] = {
    ...
    ["doh_dot_servers"] = "已连接 <A HREF=\"https://en.wikipedia.org/wiki/DNS_over_HTTPS\" target=_blank>DoH <i class='fas fa-external-link-alt'></i></A> /<A HREF=\"https://en.wikipedia.org/wiki/DNS_over_TLS\" target=_blank>DoT <i class='fas fa-external-link-alt'></i></A> 服务器",
    ["error_replies"] = "错误响应",
    ["note"] = "注意",
...
["network_behavior_check_list_example"] = "要分析的网络列表，用逗号分隔",
    ...
    ["note_add_custom_scripts"] = "%{product} 在这些 <a href=\"%{url}\"> <i class=\"fas fa-folder\"></i> 目录</a>中查找自定义脚本。",
    ["note_create_custom_scripts"] = "创建用于执行回调的自定义脚本的文档可在以下 <a href=\"%{url}\">link</a> <i class=\"fas fa-external-link-alt\"> </i>。",
  ...
  ["flow_details"] = {
    ...
    ["tos"] = "<A target='_blank' HREF='https://en.wikipedia.org/wiki/Differentiated_services'>DSCP</A> <i class='fas fa-external-link-alt'></i> /<A target='_blank' HREF='https://en.wikipedia.org/wiki/Explicit_Congestion_Notification'>ECN</A> <i class='fas fa-external-link-alt'></i> [ 客户端/服务器 ]",
...
["periodic_activities_descr"] = {
 ...
 ["prefs"] = {
    ...
    ["n2n_supernode_description"] = "<a href=\"%{url}\">n2n</a>的地址<i class=\"fas fa-external-link-alt\"></i>超级节点。设置您自己的超级节点以获得完全私有的远程访问。<br><b>注意</b>：此更改仅在远程协助重启后才会生效。",
