local lang = {
  ...
  ["error_rrd_low_resolution"] = "RRDで利用可能なものよりも低解像度なデータのフェッチが指示されました。これはinvalid dataにつながります。<br>もしも同程度のデータ粒度が必要であれば <a href=\"%{prefs}\">Protocol/Networks Timeseries</a> 設定で設定してください",
  ["flow"] = "Flow",
