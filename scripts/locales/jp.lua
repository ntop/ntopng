local lang = {
  ...
  ["db_explorer"] = {
    ...
    ["pcaps"] = "Pcaps",
    ["protocol_flows_between"] = " %{peer1} と %{peer2}の%{proto} プロトコル flows",
  ...
  ["flow_devices"] = {
    ...
    ["note_condition_2"] = "SNMP and flow devices timeseries <A HREF=\"%{url}\"><i class=\"fa fa-flask\"></i> 設定</A> (Expert View)から有効化される必要があります",
    ...
    ["timeseries_descr"] = "Flow devices timeseries can be enabled from the <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> 設定</a>. Few minutes are necessary to see the first data points",
  },
  ...
  ["graphs"] = {
    ...
    ["custom"] = "Custom",
    ["export_flows_as_txt"] = "エクスポート flows as TXT file",
  ...
  ["if_stats_overview"] = {
    ...
    ["family"] = "Family",
    ["flows_export_statistics"] = "Flows エクスポート Statistics",
  ...
  ["nedge"] = {
    ["a_member_address_is"] = "A member address is a rule to assign devices to a ユーザ. The following order applies:",
    ...
    ["interfaces_configuration"] = "Interfaces 設定",
  ...
  ["prefs"] = {
    ...
    ["toggle_flow_db_dump_export_description"] = "数パケットしかないtiny flowsのエクスポートのオン・オフをします。データベース上でのデータ紐づけを抑止するためデータ挿入や検索を早くします。ダンプ情報の可視性を保ちながらデータ紐づけについては制限します",
    ["toggle_flow_db_dump_export_title"] = "Tiny Flows エクスポート",
  ...
  ["show_アラート"] = {
    ...
    ["delete_アラート_configuration"] = "Delete アラート 設定",
    ["delete_all"] = "Delete All",
    ["delete_config_btn"] = "Delete %{conf}s Common 設定",
    ...
    ["host_delete_config_confirm"] = "Do you really want to delete the %{granularity} アラート 設定 for host",
    ["hourly"] = "Hourly",
    ["iface_delete_config_btn"] = "Delete Interface %{iface} 設定",
  ...
  ["snmp"] = {
    ...
    ["snmp_timeseries_descr"] = "SNMP devices timeseriesは<a href=\"%{url}\"><i class=\"fa fa-flask\"></i> 設定</a>から有効化できます. 最初のデータポイントをみるためには数分間かかります",
