local  en = {
   ...
   similarity = "類似",
   quotas = "数量",
   l7_protocol = "レイヤ7プロトコル",
   l7_protocols = "レイヤ7プロトコル",
   activity = "アクティビティ",
   ["os"] = "OS",
   download = "ダウンロード",
   notes = "ノート:",
   ...
   refresh = "リフレッシュ",
   l4_protocol = "レイヤ4プロトコル",
   l4_protocols = "レイヤ4プロトコル",
   throughput = "スループット",
   seen_since = "以降確認",
   language = "言語",
   ...
   graphs = {
      ...
      num_ms_srv_nw_ltn = "サーバネットワーク遅延 ms",
      tcp_packets_lost = "TCPパケット損失",
      tcp_packets_ooo = "TCPパケット順序不正",
      tcp_packets_retr = "TCP再送信パケット",
      tcp_retr_ooo_lost = "TCP 再送 順序不正 損失",
      ...
      average_traffic = "平均 トラフィック/秒",
      top_senders = "トップ送信者",
      top_receivers = "トップ受信者",
      top_profiles = "トッププロファイル",
      all_ndpi_protocols  = "全アプリケーション",
      all_ndpi_categories = "全カテゴリー",
      note_click_to_zoom = "表を左クリックしてズームイン、左クリックしてズームアウト",
      note_protocols_shown = "選択した時間フレームにないプロトコルはドロップダウンに一覧表示されません",
      note_ases_traffic = "表示されたトラフィックはASによって送受信されます",
      note_ases_sent = "送信されたトラフィックはASによって送信されたものです",
      note_ases_rcvd = "受信されたトラフィックはASによって送信されたものです",
   },

   flows_page = {
      recently_active_flows = "最近のアクティブ %{filter} フロー",
      idle_flows_not_listed = "一覧表示されないアイドルフロー",
      active_flows = "アクティブ %{filter} フロー",
      flows = "%{filter} フロー",
      ...
      direction = "向き",
      all_flows = "すべてのフロー",
      one_way_multicast = "一方向のマルチキャスト/ブロードキャスト",
      one_way_non_multicast = "一方向の非マルチキャスト/非ブロードキャスト",
      ...
      inIfIdx = "入力インターフェース",
      all_inIfIdx = "すべての入力インターフェース",
      outIfIdx = "出力インターフェース",
      all_outIfIdx = "すべての出力インターフェース",
      vlan = "VLAN",
   ...
   traffic_report = {
      ...
      monthly = "月計",
      header_daily = "日毎レポート",
      header_weekly = "週毎レポート",
      header_monthly = "月毎レポート",
      current_day = "現在の日",
      current_week = "現在の週",
      current_month = "現在の月",
      previous_day = "前の日",
   ...
   report = {
      period = "間隔",
      begin_date_time = "開始日/時間",
      end_date_time = "終了日/時間",
      date = "%{month}-%{date}-%{year}",
      generate = "生成",
      invalid_begin_date = "不正な開始日時",
      please_check_format = "フォーマットを確認してください",
      please_choose_valid = "有効な開始/終了日時と時間を選択してください",
      invalid_begin_end = "無効な開始/終了",
      invalid_begin = "無効な開始",
      please_choose_valid_date_and_time = "有効な日付と時間を選択してください",
      invalid_to = "無効",
      traffic_report = "トラフィックレポート",
      starting = "開始",
      network_interface = "ネットワークインターフェース",
      report_for_subject = "レポート - %{num_min} - %{subject} 開始 %{dt}",
      filter_report = "レポートフィルタ",
      toggle_all = "すべてトグル",
      submit_filter = "フィルタを投稿",
      application_breakdown = "アプリケーションブレークダウン",
      local_networks = "ローカルネットワーク",
      local_remote = "ローカル/リモート",
      remote_local = "リモート/ローカル",
      total_traffic = "全トラフィック",
      applications = "アプリケーション",
      top_talkers = "トップ送信者",
      top_countries = "トップ国",
      top_local_hosts = "トップローカルホスト",
      top_remote_hosts = "トップリモートホスト",
      top_local_os = "トップローカル OS",
      top_non_local_os = "トップノンローカル OS",
      top_asn = "トップ ASN",
      top_networks = "トップネットワーク",
      reports_professional_only = "レポーターはプロフェッショナルバージョンでのみ利用できます",
      senders = "送信者",
      receivers = "受信者",
      use_server_timezone = "サーバーのタイムゾーンを利用",
   },
   ...
   shaping = {
      protocols = "プロトコル",
      manage_policies = "ポリシーを管理",
      bandwidth_manager = "帯域を管理",
      shaper0_message = "シェイパー0はシェイパーが定義されていない今日からホストで利用されるデフォルトのシェイパーです",
      set_max_rate_to = "最大レートを設定",
      for_no_shaping = "シェイピングなし",
      for_dropping_all_traffic = "すべてのトラフィックをドロップ",
      protocols_policies = "プロトコルポリシー",
      select_to_clone = "プロトコルルールを複製する既存のネットワークを選択",
      initial_empty_protocols = "初期プロトコルルールは空になります",
      initial_clone_protocols = "初期プロトコルルールは複製されます",
      shaper_id = "シェイパーID",
      applied_to = "適用先",
      notes = "ノート",
      shapers_in_use_message = "どのネットワークにも適用されないシェイパーは削除されます",
      no_shapers_available = "どのシェイパーも利用できません",
      protocol_families = "プロトコルファミリー",
      traffic_to = "トラフィック先",
      traffic_from = "トラフィック元",
      protocol_policy = "トラフィックポリシー",
      daily_traffic_quota = "日次トラフィック制限",
      daily_time_quota = "日次時間制限",
      daily_traffic = "日次トラフィック (現在 / 制限)",
      no_quota_data = "制限が設定されていません",
      no_quota_applied = "制限なし",
      daily_time = "日次時間(現在 / 制限)",
      ...
      note_drop_core = "コアプロトコルをドロップすることは他のプロトコルに副作用を及ぼす可能性があります 例えばDNSをブロックすると,<br>ホスト名は解決されず, 数字のIPで動作する通信だけになります",
      note_default_pool_config = "ポリシーと制限はユーザ定義ホストプールにのみ適用されます 異なるプールを選択するか新しいものを <a href='%{url}'>こちらで</a>作成",
      note_quota_unlimited = "無制限のトラフィックのためにトラフィックと時間の制限を0に設定",
      note_target_type = "<a href=\"%{url}\">トラフィック設定</a>のエキスパートビューにあるポリシーターゲット種別フィールドを通してターゲット列に何を表示するか修正できます",
      note_traffic_categories = "<a href=\"%{url}\">プロトコルページ</a>からトラフィックカテゴリを設定できます",
      see_quotas_here = "完全なアクティブホストプールの制限のためにホストプールの<a href='%{url}'>制限ページ</a>を参照",
      no_quota_traffic = "これまでのところ関連するトラフィック制限はありません",
      delete_all_policies = "すべてのポリシーを削除",
      confirm_delete_all_policies = "本当にすべての\"%{pool_name}\" プールポリシーを削除しますか",
   },

   alert_messages = {
      open_files_limit_too_small = "NtopngはMySQLが開くことのできる最大ファイル数が潜在的に少なすぎることを検出しました"..
	 "これにより以下のようなエラーのためフローデータの損失となることがあります"..
	 "[Out of resources when opening file './ntopng/flowsv6#P#p22.MYD' (Errcode: 24 - Too many open files)][23]. "..
	 "open_files_limitを増やしているか確認するかこの警告を無視したいだけなら設定からチェックをはずしてください",
   ...
   show_alerts = {
      ...
      older_1_month_ago = "1か月以上前",
      older_6_months_ago = "6か月以上前",
      ...
      alert_duration = "時間",
      alert_description = "記述",
      alert_counts = "回数",
      last_minute = "過去1分",
      last_hour = "過去1時間",
      last_day = "過去1日",
      delete_alerts_configuration = "警告設定を削除",
      delete_config_btn = "ローカル %{conf}s 共通設定を削除",
      delete_config_message = "本当に共通の %{granularity} ローカル %{conf}s の警告設定を削除しますか",
      delete_all = "すべてを削除",
      iface_delete_config_btn = "インターフェース %{iface} 設定を削除",
      iface_delete_config_confirm = "本当に インターフェースの %{granularity} 警告設定を削除しますか",
      network_delete_config_btn = "ネットワーク %{network} 警告設定を削除",
      network_delete_config_confirm = "本当にネットワークの %{granularity} 警告設定を削除しますか",
      host_delete_config_btn = "ホスト %{host} 警告設定を削除",
      host_delete_config_confirm = "本当にホストの %{granularity} 警告設定を削除しますか",
      explorer = "エクスプローラー",
      purge_num_alerts = "[%{num_alerts} 警告]を解放",
      delete_alert = "警告を削除",
      confirm_delete_alert = "本当にこの警告を削除しますか",
      reset_alert_database = "警告データをリセット",
      reset_alert_database_message = "この操作は以下を含むすべての警告に関するデータを削除します<ul>"..
            "<li>現在のアラート状態</li>"..
            "<li>アラート設定</li>"..
            "<li>SQLiteストレージに継続されているアラート</li>"..
            "</ul><br>進めてよいですか",
      flush_data = "データをリセット",
      minute = "分",
      five_minutes = "5分",
      ...
      daily = "日次",
      startup = "開始",
      no_recorded_alerts_message = "インターフェース %{ifname} について記録された警告はありません",
      alerts_are_disabled_message = "警告は無効です。設定ページを確認して有効にしてください",
   },

   alerts_dashboard = {
      flow_alert_origins  = "フロー警告元",
      flow_alert_targets  = "フロー警告先",
      engaged_for_longest = "もっとも長く使用中だった過去の警告",
      starting_on = "開始",
      total_alerts = "全アラート",
      no_alerts = "アラートなし",
      not_engaged = "使用中なし",

      trailing_msg = "時刻ウインドウ",
      one_min = "過去1分",
      five_mins = "過去5分",
      one_hour = "過去1時間",
      one_day = "過去1日",

      involving_msg = "含まれるフロー警告",
      all_hosts = "全ホスト",
      local_only = "ローカルホストのみ",
      remote_only = "リモートホストのみ",
      local_origin_remote_target = "ローカル元 - リモート先",
      remote_origin_local_target = "リモート元 - ローカル先",
   ...
   flow_alerts_explorer = {
      label = "フロー警告エクスプローラー",
      flow_alert_origin  = "警告元",
      flow_alert_target  = "警告先",

      type_explorer = "種別エクスプローラー",
      type_alerts_by_type = "種別ごとのフロー警告",
      by_target_port = "対象ポートごと",
      origins = "元",
      targets = "先",
      ...
      summary_total = "すべてのフロー警告",
      summary_n_origins = "すべての元",
      summary_n_targets = "すべての先",
      summary_cli2srv = "全ての元からトラフィック先",
      summary_srv2cli = "全ての先からトラフィック元"
   },

   db_explorer = {
      observation_period = "調査期間",
      client_server_host = "クライアント/サーバー ホスト",
      application_protocol = "アプリケーションプロトコル",
      search_flows = "フローを検索",
      pcaps = "Pcaps",
      unable_to_find_flow = "特定のフローを探せません",
      flow_peers = "フロー端",
      vlan_id = "VLAN ID",
      first_last_seen = "最初 / 最後 表示",
      client_server_breakdown = "クライアント対サーバ トラフィックブレークダウン",
      this_flow_has_been_reset = "このフローはリセットされたのでおそらくサーバアプリケーションはダウンしています",
      this_flow_is_completed = "このフローは完了しまもなく切れます",
      this_flow_is_active = "このフローはアクティブです",
      network_latency_breakdown = "ネットワーク遅延ブレークダウン",
      ...
      selected_saved = "保存したものを選択",
      extract_pcap = "pcapを展開",
      request_failed = "要求が失敗",
      ok_request_sent = "OK, リクエスト送信",
      all = "すべて",
      unsave = "削除",
      application_flows = "アプリケーションフロー",
      talkers_with_this_host = "このホストへの送信者",
      host_name = "ホスト名",
      traffic_sent = "送信済トラフィック",
      traffic_received = "受信トラフィック",
      total_traffic = "全トラフィック",
      total_packets = "全パケット",
      query_in_progress = "データベースの問い合わせを行っています。結果を受け取るまでお待ちください。",
      abort = "中止",
      total_flows = "全フロー",
      total_packets = "全パケット",
      traffic_rate = "平均トラフィック速度",
      packet_rate = "平均パケット速度",
      summary = "サマリ",
      applications_between = "%{peer1} と %{peer2} の間のアプリケーション",
      host_talkers = "%{host} 送信者",
      app_talkers = "%{app} 送信者",
      app_talkers_with = "%{app} 送信者 と %{peer}",
      app_flows_between = "%{peer1} と %{peer2} の間の %{app} アプリケーション",
      traffic_volume = "トラフィック量",
      protocol_id = "プロトコルID",
      l4_proto = "L4 プロトコル",
      average_throughput = "平均 スループット",
      pcap_requests_and_status = "Pcap 要求と状態",
      task_id = "タスク Id",
      filter_bpf = "フィルター (BPF)",
      top_proto_ipv4_flows = "トップ %{proto} IPv4 フロー",
      top_proto_ipv6_flows = "トップ %{proto} IPv6 フロー",
      top_flows_ipv4 = "トップ IPv4 フロー [%{date_from} - %{date_to}]",
      top_flows_ipv6 = "トップ IPv6 フロー [%{date_from} - %{date_to}]",
      app_between_talkers_pairs = "送信者ペア間のアプリケーション",
      protocol_flows_between = "%{peer1} と %{peer2}との間の%{proto} プロトコル フロー",
      get_proto_talkers = "このプロトコルを利用する送信者を取得",
      hosts_talking_proto_with = "{host} と %{proto} で通信中",
      last_hour_flows = "過去一時間でのフロー",
      download_flows = "フローをダウンロード",
      empty_query_response = "空のクエリ応答 (データベースがダウンもしくはクエリが終了/タイムアウト?)",
   },

   traffic_profiles = {
      edit_traffic_profiles = "トラフィックポリシーを編集",
      traffic_filter_bpf = "トラフィックフィルター (nBPF フォーマット)",
      ...
      see_ndpi_protos = "(%{option} を用いてすべての nDPI がサポートされたプロトコルを出力します)",
      destination_network = "宛先ネットワーク",
      simple_filter_examples = "単純なフィルタ例",
      advanced_filter_examples = "進んだフィルタ例",
      traffic_between = "ホスト間のトラフィック",
      traffic_from_to = "あるホストから別ホストへのトラフィック",
      host_http_https = "HTTP/HTTPS ホスト",
      source_ethernet = "送信元MACアドレス",
      note_0 = "トラフィックプロファイル名は英数字とスペースとアンダースコアが使えます",
      note_1 = "トラフィックプロファイルはフローに割当られました 各フローは１つのプロファイルをもつので、複数のプロファイルが適合しても最初の一つが選択されます",
      enter_profile_name = "プロファイル名を入力してください",
      enter_profile_filter = "プロファイルフィルタを入力してください",
      invalid_bpf = "無効なBPFフィルタです",
      duplicate_profile = "プロファイル名が重複しています",
      delete_profile = "プロファイルの削除",
      confirm_delete_profile = "本当にプロファイルを削除しますか",
      max_profiles_num = "このバージョンのntopngでは、 %{maxnum} までのプロファイルを作成できます エンタープライズ版ではこの制限をなくすことができます",
   },

   host_pools = {
      edit_host_pools = "ホストプールを編集",
      pool = "プール名",
      manage_pools = "プールメンバーを管理",
      create_pools = "プールを管理",
      empty_pool = "空のプール",
      delete_pool = "プールの削除",
      ...
      create_pool_hint = "プール管理タブから新規プールを作成できます",
      member_address = "メンバーアドレス",
      specify_pool_name = "プール名を指定してください",
      specify_member_address = "IPv4/IPv6 アドレス か ネットワーク か MAC アドレスを指定してください",
      invalid_member = "無効なメンバーアドレス形式です",
      duplicate_member = "メンバーアドレスを複製する",
      duplicate_pool = "プール名を複製します",
      confirm_delete_pool = "本当にホストプールを削除しますか",
      confirm_remove_member = "本当にメンバーを削除しますか",
      confirm_empty_pool = "本当にホストプールからすべてのメンバーを削除しますか",
      from_pool = "ホストプールから",
      and_associated_members = "RRD データとすべての関連付けられたメンバー",
      search_member = "メンバーを検索",
      network_normalized = "ネットワーク \"%{network}\" には空でないホスト識別子があります \"%{network_normalized}\" を使用します",
      member_exists = "メンバー \"%{member_name}\" は追加されません 既にプール \"%{member_pool}\" が割り当てられています",
      children_safe = "チャイルドセーフ",
      enforce_quotas_per_pool_member = "メンバー毎 クォータ",
      enforce_shapers_per_pool_member = "メンバー毎 シェイパー",
      ...
      select_new_pool = "以下のドロップダウンから新規プールを選択してメンバー \"%{member}\" を割り当てます:",
      max_pools_message = "このバージョンのntopngでは、 %{maxnum} ホストプールを作成できます エンタープライズ版ではこの制限をなくすことができます",
      max_members_message = "このバージョンのntopngでは、ホストプール毎に %{maxnum} メンバーを割り当てできます エンタープライズ版ではこの制限をなくすことができます",
      members_limit_reached = "メンバー制限に到達しました",
   ...
   dashboard = {
      top_local_talkers = "トップ Local Talkers",
      actual_traffic = "Actual Traffic",
      realtime_app_traffic = "Realtime トップ Application Traffic",
      realtime_traffic = "Network Interfaces: Realtime Traffic",
      top_remote_destinations = "トップ Remote Destinations",
      lastday_app_traffic = "トップ Application Traffic Last Day View",
   ...
   prefs = {
	...
	"and the incoming traffic will be diverted to one dynamic interface depending the VLAN Id value. ",
	 ...
	 "Default: 5 seconds.",
      ...
      databases = "Databases",
      minute_top_talkers_retention_title = "トップ Talkers Storage",
      ...
      mysql_retention_description = "Duration in days of data retention for the MySQL database. Default: 7 days.<br>MySQL is used to store exported flows data.<br>"..
            "フロー dump is only possible if the ntopng instance has been launched with option ",
      ...
      toggle_remote_to_remote_alerts_title = "Enable Remote to Remote Flow Alerts",
      toggle_remote_to_remote_alerts_description = "Enable alerts generated when the client and the server of a flow are remote",
      toggle_dropped_flows_alerts_title = "Enable Blocked フロー Alerts",
      ...
      toggle_top_sites_title = "トップ HTTP Sites",
      toggle_top_sites_description = "Toggle the creation of top visited web sites for local hosts. トップ sites are created using an <a href=\"%{url}\">heuristic</a> that maintain no more than 20 sites per local host. The heuristic fully operates in memory and does not require any interaction with the disk. トップ sites are cleared every 5 minutes. An historical archive of top visited web sites can be created, for each local host, by periodically polling the JSON <i class=\"fa fa-download fa-sm\"></i> download link accessible from the host details page.",
      ewma_alpha_percent_title = "EWMA alpha coefficient (percent)",
      ewma_alpha_percent_description = "Exponentially Weighted Moving Average (EWMA) alpha coefficient, expressed as a percentage. Used to estimate Autonomous Systems server network latency.",
      logging = "Logging",
      ...
      tiny_flows = "Tiny フロー Dump",
      toggle_flow_db_dump_export_title = "Tiny フロー Export",
	 ...
	 " will be created an RRD with ingress/egress bytes.",
      ...
      safe_search_dns_description = "The DNS server to be used to perform <a href='%{url}'>Child Safe</a> queries.<br>"..
   ...
   if_stats_overview = {
      ...
      flows_export_statistics = "フロー Export Statistics",
   ...
   peers_page = {
      top_peers_for_host = "トップ %{hostkey} Peers",
      top_peer_protocol = "トップ Peer Protocols",
   ...
   packetdump_page = {
      ...
      dump_unknown_traffic = "Unknown Layer-7 フロー Packets",
   ...
   http_page = {
      top_visited_sites = "トップ Visited Sites",
   ...
   top_hosts = {
      top_hosts_local = "トップ Hosts (Local)",
   },
   ...
   index_page = {
      ...
      asns = "ASNs",
      senders = "Senders",
      top_flow_talkers = "トップ Flow Talkers",
   ...
   processes_stats = {
      ...
      stack = "Stack",
      lines = "Lines",
      top_l7_protocols = "トップ L7 Protocols",
      top_l4_protocols = "トップ L4 Protocols",
      top_hosts = "トップ Hosts",
      top_hosts_traffic = "トップ Hosts Traffic",
   ...
   user_info = {
      top_applications = "トップ Applications",
      top_l7_protocols = "トップ L7 Protocols",
      top_l4_protocols = "トップ L4 Protocols",
  ...
  users = {
   ...
   incomingflows = "Incoming フロー Count",
