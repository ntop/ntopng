local lang = {
  ...
  ["error_rrd_low_resolution"] = "RRDで利用可能なものよりも低解像度なデータのフェッチが指示されました。これはinvalid dataにつながります。<br>もしも同程度のデータ粒度が必要であれば <a href=\"%{prefs}\">プロトコル/Networks Timeseries</a> 設定で設定してください",
  ["flow"] = "Flow",
  ...
  ["about"] = {
    ...
    ["uptime"] = "起動時間",
    ["version"] = "バージョン",
    ["you_have_too_many_flows"] = "%{product} 設定におけるhosts/フローの設定が多すぎます。これはパケットロスとCPUの高負荷を生み出します. -xと-Xを増やして%{product} を再起動してください"
  },
  ["activities_page"] = {
  ...
  ["dashboard"] = {
    ...
    ["lastday_traffic"] = "Network インタフェース: Last Day View",
    ["realtime_app_traffic"] = "Realtime Top Application Traffic",
    ["realtime_traffic"] = "Network インタフェース: Realtime Traffic",
  ...
  ["graphs"] = {
    ...
    ["flows_vs_local_hosts"] = "Active フロー vs Local Hosts",
  ...
  ["host_pools"] = {
    ...
    ["per_member_shapers"] = "When the per-member shapers option is set, each host will its own shapers. When unset, すべての the hosts belonging to the same pool will share the same shapers",
    ["pool"] = "Pool Name",
    ["pool_name"] = "Pool Name",
  ...
  ["local_flow_matrix"] = {
    ...
    ["local_hosts_active_flows_matrix"] = "Local Hosts Active フロー Matrix",
  },
  ["local_hosts_stats"] = {
    ["criteria"] = "Criteria",
  ...
  ["prefs"] = {
    ...
    ["dynamic_network_interfaces"] = "Dynamic Network インタフェース",
    ...
    ["local_host_max_idle_description"] = "local hostがidleと判断されるまでの時間。 Idle local hostsはそのカウンタ値がcacheにダンプされ、再度アクティブになったときに利用されます。カウンターはCountersはLayer-7アプリケーションごとのパケットとbytesトータルを含みます。Default: 5 min.",
    ["local_host_max_idle_title"] = "Local Host Idle Timeout",
    ["local_hosts_cache_settings"] = "Local Hosts Cache 設定",
    ...
    ["max_num_アラート_per_entity_description"] = "alarmable entityごとの最大alerm数。Alarmable entitiesはhosts, networks, インタフェース。 アラートは周期的にチェックされ、エンティティごとの最大数を超えた場合には, もっとも古いアラートは削除され、設定された最大数の80%%を保つようにされます。 Default: 1024.",
    ...
    ["network_interfaces"] = "Network インタフェース",
