local lang = {
  ...
  ["nedge"] = {
    ...
    ["captive_portal_other_methods"] = "Captive Portalは <a href=\"%{url}\">Authentication 設定</a> で指定可能なauthenticationオプション(例 Radius)を利用します",
    ...
    ["you_can_assign_shapers_to_users_protocols"] = "<a href=\"%{url}\">Users</a>に対して特定のプロトコルごとにbandwidth policiesを適用できます。あるいはグローバル設定<a href=\"%{url2}\">Fallback Policy</a>として設定できます",
