local lang = {
  ...
  ["flow_details"] = {
    ...
    ["suspicious_client_device_protocol"] = "Client protocol \"%{proto}\" is not allowed by the configured <a href=\"%{url}\">%{devtype} protocols policy</a>",
    ["suspicious_server_device_protocol"] = "Server protocol \"%{proto}\" is not allowed by the configured <a href=\"%{url}\">%{devtype} protocols policy</a>",
  ...
  ["traffic_recording"] = {
    ...
    ["interface_desc"] = "Enable continuous traffic recording on %{interface}",
    ["license"] = "License",
    ["license_desc"] = "Configure here your n2disk license.",
    ["network_interfaces"] = "Network Interfaces",
    ["storage"] = "Storage",
