local lang = {
   ...
   ["menu.reason.no_vs_utils"] = "Vulnerability scan utilities are not available",
   ["menu.suggestion.no_vs_utils"] = "Not available with the current configuration",
  ...
  ["alerts_dashboard"] = {
    ...
    ["vulnerability_scan_description"] = "Trigger an alert when a Active Scan is executed and the new scan reports different vulnerabilities (meaning that some could be solved and new ones could be there).",
  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["vs_result_total_reports"] = "Active Scan Report",
      ["vulnerabilities"] = "Vulnerabilities",
      ["vulnerabilities_found_list"] = "CVEs List",
      ["vulnerability_scan_reports"] = "Active Scan Reports",
      ["weekly"] = "Weekly",
      ["email"] = {
        ...
        ["vulnerability_scan_report_title"] = "Active Scan Report",
      },
      ["notes"] = {
  ...
  ["vulnerability_scan"] = {
    ...
    ["vulnerability_scan_in_progress"] = "Active Scan in Progress",
