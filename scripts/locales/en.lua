local lang = {
  ...
  ["active_monitoring_stats"] = {
    ...
    ["am_note_icmp"] = "Measurements icmp and icmp6 ping the host using ICMP and ICMP (IPv6). Not available on Windows.",
  ...
  ["if_stats_config"] = {
    ...
    ["gw_macs"] = "Gateways Mac (Address-Based Traffic Directions)",
    ["gw_macs_description"] = "Set traffic direction based on the MAC address of the Gateways (comma-separated list). With mirror or pcap-based systems with no traffic directions, it is not possible to know the traffic direction (ingress or egress) otherwise.",
