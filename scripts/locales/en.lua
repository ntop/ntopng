local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["binary_application_transfer"] = "Detected executable application transfer",
    ["binary_application_transfer_url"] = "%{type_icon} Detected executable application transfer [%{url}]",
    ...
    ["known_proto_on_non_std_port"] = "Known application detected on non-standard port",
  ...
  ["endpoint_notifications"] = {
    ...
    ["name"] = "Endpoint Name",
    ["recipient_list"] = "Recipients Endpoint List",
