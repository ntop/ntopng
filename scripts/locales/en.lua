local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["host_alert_ntp_server_contacts"] = "Too many NTP servers contacted by %{entity}%{host_category} [%{value} &gt; %{threshold} servers]",
    ["host_alert_p2p_traffic"] = "P2P traffic exceeded by %{entity}%{host_category} [%{value} %{op} %{threshold}]",
    ["host_alert_smtp_server_contacts"] = "Too many SMTP servers contacted by %{entity}%{host_category} [%{value} &gt; %{threshold} servers]",
    ...
    ["score_number_anomaly"] = "Detected %{role} score anomaly for host %{host}",
    ...
    ["syn_flood_attacker"] = "%{entity}%{host_category} is a SYN flooder [%{value} &gt; %{threshold} SYN/sec sent for ~3 sec]",
    ["syn_flood_victim"] = "%{entity}%{host_category} is under SYN flood attack [%{value} &gt; %{threshold} SYN/sec received for ~3 sec]",
    ["syn_scan_attacker"] = "%{entity}%{host_category} is a SYN scan attacker [%{value} &gt; %{threshold} SYN sent]",
    ["syn_scan_victim"] = "%{entity}%{host_category} is under a SYN scan [%{value} &gt; %{threshold} SYN received]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["dns_rcvd_sent_ratio"] = "[DNS Rcvd Repls. / Sent Reqs. %{ratio}%% &lt; %{threshold}%%][Repls: %{replies}][Reqs: %{requests}]",
    ["dns_sent_rcvd_ratio"] = "[DNS Sent Repls. / Rcvd Reqs. %{ratio}%% &lt; %{threshold}%%][Repls: %{replies}][Reqs: %{requests}]",
    ["emergency"] = "Emergency",
    ...
    ["known_proto_on_non_std_port"] = "Protocol on Non-Std Port",
    ...
    ["remote_access_alert_descr"] = "Remote Access Ended and lasted for %{sec} sec",
    ["remote_connection_title"] = "Remote Connection",
    ["remote_connection_description"] = "Trigger an alert when an host has 1 or more Remote Connection Sessions open",
    ["remote_connection_alert_descr"] = "The %{host} currently is taking part to %{connections} flows with a remote access protocol",
    ...
    ["suspicious_file_transfer"] = "Susp. File Transfer",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["daily"] = "Daily",
    ["dns_contacts_description"] = "Trigger an alert when the number of different DNS servers contacted exceeds 5",
    ...
    ["notes"] = "NOTES",
    ["ntp_contacts_description"] = "Trigger an alert when the number of different NTP servers contacted exceeds 5",
    ...
    ["smtp_contacts_description"] = "Trigger an alert when the number of different SMTP servers contacted exceeds 5",
  ...
  ["flow_callbacks_config"] = {
    ...
    ["score"] = "Flow Score",
    ["suspicious_countries"] = "Susp. Countries",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_binary_application_transfer"] = "Susp. File Transfer",
