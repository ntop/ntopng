local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["influxdb_queue_too_long"] = "InfluxDB Queue Too Long",
    ["influxdb_queue_too_long_description"] = "InfluxDB export queue is too long [%{length} files queued]. Is InfluxDB able to keep up with the writes?",
    ["info"] = "Info",
  ...
  ["prefs"] = {
    ...
    ["toggle_snmp_alerts_port_duplexstatus_change_description"] = "Toggle alerts generated when the port duplex status on an interface changes",
    ["toggle_snmp_alerts_port_duplexstatus_change_title"] = "Interface Duplex Status Change Alerts",
    ["toggle_snmp_alerts_port_errors_description"] = "Toggle alerts generated when the discards or errors counters increase on an interface",
    ["toggle_snmp_alerts_port_errors_title"] = "Interface Discards/Errors Alerts",
    ["toggle_snmp_alerts_port_status_change_description"] = "Toggle alerts generated when the port status on an interface changes",
  ...
  ["system_stats"] = {
    ...
    ["exported_vs_dropped_points"] = "Exported vs Dropped Data Points",
