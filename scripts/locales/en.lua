local lang = {
  ...
  ["llm"] = {
    ...
    ["tool_list_available_active_monitoring_scripts"] = "List Available Monitors",
    ["tool_list_enabled_active_monitoring_scripts"] = "List Enabled Monitors",
    ["tool_add_active_monitoring_script"] = "Add Active Monitor",
    ["tool_add_domain_alert_exclusion"] = "Add Domain Exclusion",
    ["tool_add_certificate_alert_exclusion"] = "Add Certificate Exclusion",
