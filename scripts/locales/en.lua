local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["host_alert_server_ports_contacts"] = "New Connected Port",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["server_ports_contacts_description"] = "Trigger an alert when a server contacted a new port after a learning period",
  ...
  ["prefs"] = {
    ...
    ["host_port_learning_period_description"] = "Configure the learning period duration for local host's port used by the ... alert",
    ["host_port_learning_period_title"] = "Host's Port Learning Period",
