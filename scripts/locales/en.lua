local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["ngi_trust_event"] = "Abnormal activity detected for device <a href=\"%{mac_url}\">%{mac}</a>",
  ...
  ["alerts_dashboard"] = {
    ...
    ["dns_rcvd_sent_ratio"] = "[DNS Rcvd Reqs. / Sent Repls. %{ratio}%% &lt; %{threshold}%%] ",
    ["dns_sent_rcvd_ratio"] = "[DNS Sent Reqs. / Rcvd Repls. %{ratio}%% &lt; %{threshold}%%] ",
    ["emergency"] = "Emergency",
    ...
    ["http_rcvd_sent_ratio"] = "[HTTP Rcvd Reqs. / Sent Repls. %{ratio}%% &lt; %{threshold}%%] ",
    ["http_sent_rcvd_ratio"] = "[HTTP Sent Reqs. / Rcvd Repls. %{ratio}%% &lt; %{threshold}%%] ",
    ...
    ["reqs_repls_ratio_for"] = "Requests / Replies Ratio Too Low for %{entity}%{host_category} ",
  ...
  ["entity_thresholds"] = {
    ...
    ["request_reply_ratio_title"] = "Reqs. / Repls. Ratio",
