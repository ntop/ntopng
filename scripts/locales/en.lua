local lang = {
  ...
  ["graphs"] = {
    ...
    ["pkt_drops"] = "Pkt Drops",
    ["query_timeout_remove"] = "Query can be retried without timeout.",
    ["query_too_slow"] = "Query was too slow and has been aborted.",
    ["raw_flows"] = "Raw Flows",
  ...
  ["prefs"] = {
    ...
    ["protocols"] = "Protocols",
    ["radius_admin_group_description"] = "Group name to which user has to belong in order to authenticate as an administrator. Users belonging to other groups will be authenticated as normal users.",
    ["radius_admin_group_title"] = "RADIUS Admin Group",
    ...
    ["toggle_elephant_flows_alerts_description"] = "Enable alerts generated when an elephant flow has been detected. This is useful to detect unwanted behaviours (e.g. data exfiltration).",
    ["toggle_elephant_flows_alerts_title"] = "Enable Elephant Flows Alerts",
  ...
  ["user_activity"] = {
    ...
    ["live_capture"] = "User '%{user}' captured live traffic",
    ["live_capture_host"] = "User '%{user}' captured live traffic for host %{host}",
    ["live_capture_host_with_filter"] = "User '%{user}' captured live traffic for host %{host} matching filter '%{filter}'",
    ["live_capture_with_filter"] = "User '%{user}' captured live traffic matching filter '%{filter}'",
