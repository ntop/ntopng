local lang = {
  ...
  ["prefs"] = {
    ...
    ["llm_qwen_url_description"] = "Base URL for the Qwen API endpoint (e.g. https://dashscope.aliyuncs.com/compatible-mode/v1/)",
    ["llm_qwen_token_description"] = "API key for Alibaba Cloud",
    ["llm_qwen_model_description"] = "Qwen model name to use (e.g. qwen3.7-max)",
