local lang = {
  ...
  ["flow_details"] = {
    ...
    ["purge_time"] = "Flow Idle Timeout: %{purge_time} seconds <span title='A Flow is purged when no traffic is seen for the time set; to change it jump to the Flow Idle Timeout preferences. To set in combination with nProbe, set -d configuration option in nProbe' style='cursor: help;'><i class='fas fa-question-circle'></i></span> <a href='%{prefs_url}' target='_blank'><i class='fas fa-cog fa-sm'></i></a>",
    ["r_factor"] = "R-Factor",
