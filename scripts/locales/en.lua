local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["contacted_peers_as_cli"] = "Too many Peers contacted as client by %{host} %{numeric_ip} [%{value} > %{dyn_threshold}].",
    ["contacted_peers_as_srv"] = "Too many Peers contacted as server by %{host} %{numeric_ip} [%{value} > %{dyn_threshold}].",
    ...
    ["remote_to_local_insecure_proto_breed"] = "Remote host contacted a local server using an unsafe protocol; Protocol Safety: %{proto}",
    ["remote_to_local_insecure_proto_category"] = "Remote host contacted a local server using an unsafe protocol; Protocol Id: %{proto_id}; Protocol Category: %{proto}",
  ...
  ["alerts_dashboard"] = {
    ...
    ["contacted_peers_description"] = "Trigger an alert when too many peers are contacted as both client or server",
    ["contacted_peers_title"] = "Too Many Peers Contacted",
    ["critical"] = "Critical",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["daily"] = "Daily",
    ["dns_contacts_description"] = "Triggers an alert when the number of different DNS servers contacted exceeds the threshold",
    ...
    ["notes"] = "NOTES",
    ["ntp_contacts_description"] = "Triggers an alert when the number of different NTP servers contacted exceeds the threshold",
    ["ntp_contacts_title"] = "NTP Server Contacts Alert",
    ["p2p_traffic"] = "P2P Traffic Alert",
    ["smtp_contacts_description"] = "Triggers an alert when the number of different SMTP servers contacted exceeds the threshold",
  ...
  ["flow_callbacks_config"] = {
    ...
    ["remote_to_local_insecure_proto_description"] = "Triggers an alert when a remote Server contacts a local Host using an insecure protocol",
  ...
  ["flow_details"] = {
    ...
    ["flow_low_goodput"] = "Low goodput flow %{ratio}%%",
  ...
  ["prefs"] = {
    ...
    ["iec60870_learning_period_title"] = "Learning Period",
