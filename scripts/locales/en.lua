local lang = {
  ...
  ["remote_assistance"] = {
    ...
    ["connection_script_descr"] = "This script can be used to connect to this machine for remote assistance.",
    ["enable_remote_assistance"] = "Enable Remote Assistance",
    ["enable_remove_assistance"] = "Enable Remote Assistance",
    ["key_descr"] = "The virtual network secret key.",
