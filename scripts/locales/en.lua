local lang = {
  ...
  ["endpoint_notifications"] = {
    ...
    ["enpoint_recipients_list"] = "Recipient Endpoints",
    ["name"] = "Endpoint Name",
    ["recipient_list"] = "Recipient Endpoints",
  ...
  ["host_pools"] = {
    ...
    ["edit_host_pool_member"] = "Edit Host Pool Member",
    ...
    ["select_host_pool"] = "Select an Host Pool",
  ...
  ["pools"] = {
    ...
    ["id"] = "ID",
    ["insert_name"] = "Type a name for the new %{type} pool",
    ["members"] = "Members",
    ["name"] = "Name",
    ["name_requirements"] = "The name must be longer than 1 characters and it can't be empty.",
