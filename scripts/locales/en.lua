local lang = {
  ...
  ["network_stats"] = {
    ...
    ["note_aliases_not_configurable"] = "If the Alias is not editable, it means that an Alias was added at the startup of ntopng as command option. Check './ntopng -h' for more info (option '-m')",
  },
  ["nindex"] = {
