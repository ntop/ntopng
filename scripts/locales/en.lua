local lang = {
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["custom_host_lua_script_description"] = "Trigger an alert based on a custom Lua user script",
    ["custom_host_lua_script_title"] = "Custom User Script",
    ["daily"] = "Daily",
  ...
  ["flow_checks_config"] = {
    ...
    ["custom_lua_script"] = "Custom Script Check",
    ["custom_lua_script_description"] = "Lua script used to trigger custom user alerts",
