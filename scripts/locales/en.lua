local  en = {
   ...
   prefs = {
      ...
      top_talkers_storage = "Top Talkers Storage",
      minute_top_talkers_retention_title = "Data Retention",
      minute_top_talkers_retention_description = "Duration in days of minute top talkers data retention. Default: 365 days.",
      mysql_database = "MySQL Database",
      mysql_retention_title = "Data Retention",
      mysql_retention_description = "Duration in days of data retention in the MySQL database. Default: 7 days.",
      toggle_mysql_check_open_files_limit_title = "Check open_files_limit",
      toggle_mysql_check_open_files_limit_description = "Toggle the periodic check of MySQL open_files_limit.",
      ...
      toggle_flow_alerts_iface_title = "Dump Flow Alerts",
