local lang = {
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_tls_cert_validity_too_long"] = "TLS Certificate Validity",
  ...
  ["prefs"] = {
    ...
    ["toggle_use_mac_in_flow_key_title"] = "MAC address key",
    ["toggle_use_mac_in_flow_key_description"] = "Use the MAC Address to generate the flow key. This is suggested in case the same IP can be seen using different MAC Addresses.",
