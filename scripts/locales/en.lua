local lang = {
  ...
  ["interface_downlink_speed"] = "Downlink Speed",
  ...
  ["interface_uplink_speed"] = "Uplink Speed",
  ...
  ["if_stats_config"] = {
    ...
    ["note_5"] = "Percentage Threshold: is calculcated beetwen the last two frequency checks (e.g. <1% with frequency 5 Min -> if the difference between precedent frequency and the last 5 minutes check is lower than 1% trigger an alert)",
  ...
  ["prefs"] = {
    ...
    ["vlan"] = "VLAN Id",
    ["vs_concurrently_scan_number_descr"] = "Maximum number of scans executed simultaneously (more scans require more resources).",
