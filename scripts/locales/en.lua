local  en = {
   ...
   validation = {
      ...
      field_with_pattern = "Invalid characters in this field",
      required_field_with_pattern = "Please fill out this field with valid characters",
      password_field = "Please enter a valid password",
      user_field = "Please enter a valid username",
      traffic_profile_name = "Please enter a profile name with alphanumeric, space or underscore characters",
      ipv4_field = "Please enter a valid IPv4 address",
      interface_alias = "Please enter a valid custom name with alphanumeric, score, underscore, dot or space characters",
