local lang = {
  ...
  ["level"] = "Level",
  ["light"] = "Light",
  ["little_endian"] = "US (Little Endian)",
  ...
  ["max_rate"] = "Max Rate",
  ["memory"] = "Memory",
  ["middle_endian"] = "Europe (Middle Endian)",
  ...
  ["alert_messages"] = {
    ...
    ["icmp_flood_attacker"] = "%{entity} is an ICMP flooder [%{value} &gt; %{threshold} client ICMP pkts/sec for ~3 sec]",
    ["icmp_flood_victim"] = "%{entity} is under ICMP flood attack [%{value} &gt; %{threshold} server ICMP pkts/sec for ~3 sec]",
  ...
  ["entity_thresholds"] = {
    ...
    ["icmp_flood_description"] = "Trigger an alert when the number of sent/received ICMP pkts/sec exceeds the threshold",
  ...
  ["prefs"] = {
    ...
    ["toggle_date_type_description"] = "Switch between different <A HREF=https://en.wikipedia.org/wiki/Date_format_by_country>format for date representation</A>.",
