local lang = {
  ...
  ["snmp"] = {
    ...
    ["snmp_interface"] = "SNMP Interface",
    ["interface_name_alias_filter"] = "Interface Name/Alias Filter",
    ["interface_name_alias_filter_description"] = "Interfaces whose name or alias match this string will be automatically assigned the selected role.",
    ...
    ["snmp_interfaces_auto_role"] = "SNMP Interfaces Auto Role",
