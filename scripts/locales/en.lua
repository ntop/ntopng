local lang = {
  ...
  ["stacked_unblocked_title"] = "Turn on/off the option to see or not a stacked chart",
  ["start"] = "Start",
  ["status"] = "Status",
  ["stop"] = "Stop",
  ["subjectDN"] = "SubjectDN",
  ...
  ["graphs"] = {
    ...
    ["throughput_bps"] = "Interface Throughput (bps)",
    ["throughput_pps"] = "Interface Throughput (pps)",
