local lang = {
  ...
  ["custom_categories"] = {
    ["add"] = "Add",
    ["add_to_customized_categories"] = "Add to Customized Categories",
    ["add_url_to_categories"] = "Add URL to Customized Categories",
    ["clear"] = "Clear",
    ["clear_category"] = "Clear Category",
    ["clear_confirm_message"] = "Do you really want to clear all the configured hosts for %{category} category?",
    ...
    ["edit_category_hosts"] = "Edit Category Hosts",
    ["host_domain_or_cidr"] = "Hosts can be either domain names or IP addresses or CIDR network addresses",
    ["note_page_usage"] = "This page can be used to add custom hosts to the ntopng categories",
    ["select_url_category"] = "Please select the category to assign the URL to:",
    ...
    ["the_following_url_will_be_added"] = "The following URL will be added:",
  },
  ["dashboard"] = {
  ...
  ["traffic_recording"] = {
    ...
    ["disk_space_desc"] = "Maximum disk space to use for each interface, configure this according to the desired data retention time.",
    ["enable_interface_desc"] = "Enable continuous traffic recording on %{interface}.",
    ["failure"] = "Failure",
    ...
    ["recording"] = "Recording",
    ["running_instances_license"] = "Please restart the recording on all interfaces after configuring a new license in order to apply the change.",
    ["running_instances_storage"] = "Please stop recording on all interfaces before changing the storage settings.",
    ["storage"] = "Storage",
