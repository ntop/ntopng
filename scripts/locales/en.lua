local lang = {
    ...
    ["application_proto_client_server"] = "App. Proto / Client / Server",
    ...
    ["criteria_filter"] = "Flow Aggregation Key",
    ["culprit"] = "Culprit",
    ...
    ["flow_exporter_device"] = "Flow exporter device",
    ...
    ["alert_messages"] = {
        ...
        ["device_has_connected"] = "An unexpected device <a href=\"%{device_url}\">%{device}</a> is connected to the interface <a href=\"%{if_url}\">%{if_name}</a>. Check <a href=\"%{exclusion_url}\">here</a> to check the allowed/denied devices.",
        ["device_has_disconnected"] = "Device <a href=\"%{device_url}\">%{device}</a> is disconnected from the interface <a href=\"%{if_url}\">%{if_name}</a>. Check <a href=\"%{exclusion_url}\">here</a> to check the allowed/denied devices.",
    ...
    ["alerts_dashboard"] = {
        ...
        ["alert_traffic_volume"] = "Host Traffic Volume Exceeded",
        ["alert_type"] = "Type",
    ...
    ["alerts_thresholds_config"] = {
        ...
        ["alert_slow_purge_threshold"] = "Idle Hash Table Entries",
    ...
    ["flow_checks"] = {
        ...
        ["modbus_description"] = "Trigger an alert when an invalid Modbus transition is detected",
        ["modbus_title"] = "Modbus Invalid Transition",
	["modbus_invalid_function_code"] = "Modbus Invalid Function Code",
	["modbus_invalid_transition"] = "Modbus Invalid Transition",
	["modbus_too_many_exceptions"] = "Modbus Too Many Exceptions",
        ...
        ["modbus_unexpected_function_code_ids_description"] = "Comma separated values of Modbus Function Codes. Example: 1,2,3,4",
	...
	["modbus_unexpected_function_code_title"] = "Modbus Unexpected Function Code",
        ["modbus_unexpected_function_code_description"] = "Trigger an alert when an unexpected Modbus Function code is detected",

	["modbus_too_many_exceptions_title"] = "Modbus Too Many Exceptions",
    ...
    ["flow_checks_config"] = {
        ...
        ["tcp_connection_no_answer_title"] = "TCP Connection with No Answer",
        ...
        ["tls_suspicious_extension"] = "TLS Suspicious Extension",
    ...
    ["flow_risk"] = {
        ...
        ["ndpi_anonymous_subscriber_descr"] = "Trigger an alert whenever the (source) ip address has been anonymized and it can’t be used to identify the subscriber",
    ...
    ["flows_page"] = {
        ...
        ["client_as"] = "Client AS",
        ["client_to_server"] = "[ Client: %{client} to Server: %{server} ] ",
    ...
    ["graphs"] = {
        ...
        ["flows_as_client"] = "Flows As Client",
        ["flows_as_server"] = "Flows As Serverx",
    ...
    ["hosts_stats"] = {
        ...
        ["local"] = "Local",
        ["local_hosts_only"] = "Local Unicast Only",
    ...
    ["if_stats_config"] = {
        ...
        ["note_5"] = "Percentage Threshold: is calculcated beetwen the last two frequency checks (e.g. <1% with frequency 5 Min -> if the difference between precedent frequency and the last 5 minutes check is lower than 1% trigger and alert)",
        ["port_placeholder"] = "Multicast Port value",
    ...
    ["manage_users"] = {
        ...
        ["allow_alerts_descr"] = "Allow the user to use the Alerts page.",
        ["allow_historical_flows"] = "Allow Historical Flows",
        ["allow_historical_flows_descr"] = "Allow the user to use the Historical Flows page, filtered based on the Allowed Networks configuration, if not empty.",
    ...
    ["nedge"] = {
        ...
        ["repeaters_config_title"] = "Multicast Forwarding",
    ...
    ["prefs"] = {
        ...
        ["captive_portal_informative_url_title"] = "Informative Page URL",
        ...
        ["devices_status_during_learning_period_description"] = "The default status of a new discovered device when the devices are still being learned.",
        ["devices_status_during_learning_period_title"] = "Devices/MAC Addresses Status During Learning",
        ["devices_status_post_learning_period_description"] = "The default status of a new discovered device after the learning period.",
        ["devices_status_post_learning_period_title"] = "Devices/MAC Addresses Status Post Learning",
        ...
        ["iec60870_learning_period_description"] = "Configure the learning period for IEC60870 and ModbusTCP traffic analysis. Default: 6 hours.",
	...
	["ignored_interfaces_description"] = "When 'Ingress Interface' is selected as disaggregation criterion, do not add to a dynamic interface any flow having its %%INPUT_SNMP in this list. When 'Interface' disaggregation is selected, do not add to the first (second) dynamic interface any flow having its %%INPUT_SNMP (%%OUTPUT_SNMP) in this list. Specify one or more comma-separated SNMP interface ids. Changes require %{product} restart.",
        ...
        ["toggle_flow_aggregated_limit_description"] = "Number of maximum aggregated entries to insert every hourly dump.",
        ["toggle_flow_aggregated_limit_title"] = "Limit Aggregated Flows",
        ["toggle_flow_aggregated_traffic_limit_description"] = "Flows total traffic upperbound to aggregate",
        ["toggle_flow_aggregated_traffic_limit_title"] = "Total Traffic Upperbound",
        ...
        ["toggle_menu_voice_developer_description"] = "Enabled menu entry with developer utility pages.",
        ["toggle_menu_voice_developer_title"] = "Developer Menu Entry",
        ["toggle_menu_voice_help_description"] = "Enabled menu entry with helper pages.",
        ["toggle_menu_voice_help_title"] = "Help Menu Entry",
    ...
    ["show_alerts"] = {
        ...
        ["alerts_info"] = "An alert is engaged when it is currently active (i.e. it notifies a problem that is unresolved). Ack alerts are those that have been acknowledged using the Actions menu. Past alerts are those that have been previously engaged and now solved, or non-stateful alerts triggered in the past.",
        ...
        ["network_interface_rule_threshold_cross"] = "Network Interface Volume Exceeded",
