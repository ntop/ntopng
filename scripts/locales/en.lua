local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["ping_rtt_too_slow"] = "RTT too high for host %{ip_label} %{numeric_ip}. Measured RTT %{rtt_value} ms, maximum expected RTT %{maximum_rtt} ms.",
  ...
  ["flow_callbacks_config"] = {
    ...
    ["mud"] = "MUD",
    ["mud_description"] = "Configure the MUD (Manufacturer Usage Description) generation",
