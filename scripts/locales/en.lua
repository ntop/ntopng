local lang = {
  ...
  ["graphs"] = {
    ...
    ["intranet_traffic"] = "IT: %{net_1} -> %{net_2}",
    ["last_ms"] = "Last ms",
  ...
  ["prefs"] = {
    ...
    ["toggle_intranet_traffic_rrds_description"] = "Toggle the creation of Intra-Networks Traffic (traffic between networks) timeseries.<br><b>Note:</b> These timeseries are going to be available only if the Local Network timeseries are enabled and they can be found under the abbreviation of IT (stands for Intra-Networks Traffic).",
