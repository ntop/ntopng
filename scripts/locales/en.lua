local lang = {
  ...
  ["active_monitoring_stats"] = {
    ...
    ["msec"] = "ms",
    ["note3"] = "The Active Monitoring causes %{product} to generate traffic towards the configured hosts.",
  ...
  ["prefs"] = {
    ...
    ["toggle_enable_runtime_flows_dump_description"] = "Toggle the export of flows towards the configured database.",
    ["toggle_enable_runtime_flows_dump_title"] = "Flows Export",
    ["toggle_tiny_flows_dump_export_description"] = "Toggle the export of tiny flows, that are flows with few packets or bytes. Reduces flow cardinality in databases, speeds-up inserts and searches. Tuning tiny flows can help to limit flow cardinality while not reducing visibility on dumped information.",
