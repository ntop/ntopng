local lang = {
  ...
  ["switch_new_pcap_interface"] = "A new interface has been created",
  ["switch_new_pcap_interface_error"] = "Error while creating a new pcap interface (duplicated interface ?)",
  ["and"] = "and",
