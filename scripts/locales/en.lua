local lang = {
  ...
  ["prefs"] = {
    ...
    ["toggle_dns_history_title"] = "DNS History",
    ["toggle_dns_history_description"] = "Toggle the collection of DNS resolved address and the name resolution in relation to the TTL.",
