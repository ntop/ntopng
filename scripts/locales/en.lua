local lang = {
  ...
  ["flow_alerts_explorer"] = {
    ...
    ["alert_unexpected_server_connection"] = "Unexpected connection from passive server",
    ...
    ["status_unexpected_server_connection_description"] = "Unexpected passive server connection found: %{server}",
  ...
  ["flow_checks"] = {
    ...
    ["unexpected_server_connection_description"] = "Trigger an alert when a unexpected connection is detected. See Settings / Network Configuration for configuring the list of passive servers.",
    ["unexpected_server_connection_title"] = "Unexpected server connection",
