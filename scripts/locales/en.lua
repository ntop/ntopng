local lang = {
  ...
  ["endpoint_notifications"] = {
    ...
    ["associated_to_endpoints"] = "Associated to Endpoints",
    ["associated_to_recipients"] = "Associated to Recipients",
  ...
  ["flow_callbacks_config"] = {
    ...
    ["iec104_descriprion"] = "Detect invalid IEC104 messages",
    ["iec104_title"] = "IEC 104",
