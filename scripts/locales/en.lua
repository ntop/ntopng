local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["periodicity_changed_descr"] = "Periodicity Map change detected %{info}. Click the clock below to jump to it %{href}",
  ...
  ["flow_checks_config"] = {
    ...
    ["periodicity_changed_description"] = "Alert when a periodic service changes (New/End periodic service). Enable traffic behaviour preference in order for this script to operate.",
