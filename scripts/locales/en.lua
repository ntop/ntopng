local lang = {
  ...
  ["active_monitoring_stats"] = {
    ...
    ["msec"] = "ms",
    ["note1"] = "The Active Monitoring can be used to measure the response time of a specific host.",
    ["note2"] = "The response time is calculated as the time it takes to reach the destination host plus the time it takes to receive a response from the host.",
    ["note_alert"] = "An alert is triggered when the calculated measurement exceeds the threshold set",
    ["note_periodiciy_change"] = "Changing Periodicity causes old timeseries data to be deleted.",
  ...
  ["alert_messages"] = {
    ...
    ["measurement_too_high_msg"] = "Measurement too high for %{host} %{numeric_ip} [%{rtt_value} %{unit} > %{maximum_rtt} %{unit}].",
    ["measurement_too_low_msg"] = "Measurement too low for %{host} %{numeric_ip} [%{rtt_value} %{unit} < %{maximum_rtt} %{unit}].",
