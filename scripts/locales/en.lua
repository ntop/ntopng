local lang = {
  ...
  ["about"] = {
    ...
    ["telemetry_data_opt_out_msg"] = "Opt-out is possible at any time from the  <a href=\"%{url}\"><i class=\"fa fa-flask\"></i>Preferences</a>.",
  ...
  ["prefs"] = {
    ...
    ["toggle_send_telemetry_data_description"] = "Contribute to the project by sending encrypted, anonymous telemetry data to <a href=\"%{url}\">ntop.org</a>. Data only involves the status of %{product} (e.g., uptime, status, crash reports). Nothing regarding the monitored traffic will ever be sent.",
