  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["email"] = {
        ...
        ["host_port_discrepancy_description"] = "<li>%{host_id} has these %{port_type} ports open: %{ports}.</li>",
        ...
        ["periodicity_scan_1_day_ended"] = "<br>Daily Vulnerability Scan successfully completed.</br><br>Start/End time %{start_date} - %{end_date} [Duration: %{duration}].</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}%{skipped_hosts_list}%{no_down_hosts_br}%{cves}, %{udp_ports}, %{tcp_ports}.</br>",
        ["periodicity_scan_1_week_ended"] = "<br>Weekly Vulnerability Scan successfully completed.</br><br>Start/End time %{start_date} - %{end_date} [Duration: %{duration}].</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}%{skipped_hosts_list}%{no_down_hosts_br}%{cves}, %{udp_ports}, %{tcp_ports}.</br>",
        ["report_link_line"] = "%{add_br}For further information see <a href='%{url}'>Vulnerability Scan Report</a>.",
        ["scan_all_ended"] = "<br>Vulnerability Scan of all entries successfully completed.</br><br>Start/End time %{start_date} - %{end_date} [Duration: %{duration}].</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}%{skipped_hosts_list}%{no_down_hosts_br}%{cves}, %{udp_ports}, %{tcp_ports}.</br>",
