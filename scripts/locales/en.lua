local lang = {
  ...
  ["flow_fields_description"] = {
    ...
    ["tls_session_resumed"] = "TLS Session Resumed",
  ...
  ["prefs"] = {
    ...
    ["timeseries_resolution_resolution_description"] = "The interval between consecutive timeseries data points for local hosts. Only effective for packet interfaces.<br>NOTE: High resolution can have a strong impact on memory and disk usage for large networks.",
