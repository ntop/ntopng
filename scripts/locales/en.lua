local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["device_has_connected"] = "An unexpected device <a href=\"%{device_url}\">%{device}</a> connected to the interface <a href=\"%{if_url}\">%{if_name}</a>. Click <a href=\"%{exclusion_url}\">here</a> to check the allowed/denied devices.",
    ["device_has_disconnected"] = "Device <a href=\"%{device_url}\">%{device}</a> disconnected from the interface <a href=\"%{if_url}\">%{if_name}</a>. Click <a href=\"%{exclusion_url}\">here</a> to check the allowed/denied devices.",
