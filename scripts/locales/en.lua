local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["measurement_too_high_msg"] = "Measurement too high for %{host} %{numeric_ip} [%{rtt_value} ms > %{maximum_rtt} ms].",
    ["measurement_too_low_msg"] = "Measurement too low for %{host} %{numeric_ip} [%{rtt_value} ms < %{maximum_rtt} ms].",
