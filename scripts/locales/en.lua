local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["known_proto_on_non_std_port"] = "Known protocol %{l7_proto} detected on non-standard port",
    ["last_day"] = "Last Day",
    ["last_hour"] = "Last Hour",
  ...
  ["flow_details"] = {
    ...
    ["k8s_ns"] = "Namespace",
    ["k8s_pod"] = "Pod",
    ["known_proto_on_non_std_port"] = "Found known protocol on a non-standard port",
