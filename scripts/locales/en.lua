local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["flow_flood_attacker"] = "%{entity}%{host_category} is a flow flooder [%{value} &gt; %{threshold} client flows/sec for 3 or more consecutive seconds]",
    ["flow_flood_victim"] = "%{entity}%{host_category} is under flow flood attack [%{value} &gt; %{threshold} server flows/sec for 3 or more consecutive seconds]",
    ...
    ["syn_flood_attacker"] = "%{entity}%{host_category} is a SYN flooder [%{value} &gt; %{threshold} SYN/sec sent for 3 or more consecutive seconds]",
    ["syn_flood_victim"] = "%{entity}%{host_category} is under SYN flood attack [%{value} &gt; %{threshold} SYN/sec received for 3 or more consecutive seconds]",
