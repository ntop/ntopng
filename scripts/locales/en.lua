local lang = {
  ...
  ["prefs"] = {
    ...
    ["toggle_dump_pcap_to_clickhouse_description"] = "Export flows extracted from pcap files to ClickHouse.",
    ["toggle_dump_pcap_to_clickhouse_title"] = "Dump pcap-Flows to Clickhouse",
