local lang = {
  ...
  ["filter"] = "Exclude",
  ["filter_by"] = "Filter by",
  ["filter_per_alerts"] = "By Alerts",
  ["filter_per_properties"] = "By Properties",
  ...
  ["vlan_id"] = "VLAN",
  ["volume"] = "Volume",
  ["vulnerability_scan_alert"] = "Vulnerability scan changed: %{msg}",
  ["vulnerability_scan_alert_new_issues"] = "[ %{num_issues} new vulnerability issues: %{new_cve} ]",
  ["vulnerability_scan_alert_ports_changed"] = "[ Open ports changed: %{new_num_ports} currently, %{old_num_ports} previously ]",
  ["vulnerability_scan_alert_solved_issues"] = "[ %{num_issues} vulnerability issues solved: %{cve_solved} ]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["vulnerability_scan_title"] = "Vulnerability Scan Changes",
    ["warning"] = "Warning",
  ...
  ["checks"] = {
    ...
    ["device_connection_disconnection_title"] = "Unexpected MAC Conn./Disc.",
  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["periodicity"] = "Periodicity",
      ["ports"] = "Ports",
      ["ports_placeholder"] = "Example: 22,8080",
  ...
  ["show_alerts"] = {
    ...
    ["host_pool_rule_threshold_cross"] = "Host Pool Threshold Exceeded",
    ...
    ["network_rule_threshold_crossed"] = "Network Threshold Exceeded",
