local lang = {
  ...
  ["flow_checks"] = {
    ...
    ["vlan_inclusion_list"] = "Included VLAN",
    ["vlan_inclusion_list_description"] = "Comma separated list of VLAN IDs. This alert won't be triggered for flow of VLANs outside this list (0 value represents untagged packets flows).",
  ...
  ["flow_checks_config"] = {
    ...
    ["vlan_bidirectional_traffic"] = "VLAN Bidirectional Traffic",
    ["vlan_bidirectional_traffic_description"] = "Trigger an alert when a bidirectional flow member of one included VLAN, with remote or broadcast or multicast server address, is detected",
    ["web_mining"] = "Web Mining",
  ...
  ["hosts_stats"] = {
    ...
    ["local_no_tcp_tx"] = "Local Hosts with no TCP TX Traffic",
    ["local_no_tx"] = "Local with No TX Traffic",
    ["location"] = "Location",
