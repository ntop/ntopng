local lang = {
  ...
  ["today"] = "Today",
  ["total"] = "Total",
  ["total_incoming_anomalous_flows"] = "Total Anomalous Flows As Server",
  ["total_outgoing_anomalous_flows"] = "Total Anomalous Flows As Client",
  ["traffic"] = "Traffic",
  ...
  ["graphs"] = {
    ...
    ["max"] = "Max",
    ["memory_vs_hosts_flows"] = "Process Memory vs Local Hosts/Flows",
  ...
  ["prefs"] = {
    ...
    ["toggle_host_tskey_description"] = "The key to use to serialize the hosts in the local broadcast domain. In a dynamic environment (DHCP) it's usually desiderable to choose 'Mac Address'.",
