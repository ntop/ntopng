local lang = {
  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["weekly"] = "Weekly",
      ["email"] = {
        ["discrepancy"] = "<br>Found some discrepancy with respect to the previous scan.</br><br> %{new_ports_open} new ports open, %{cves_fixed} CVEs fixed.</br><ul style='list-style-type: none;'>%{hosts_discrepancy_details}</ul>",
        ["host_down_list"] = "<ul style='list-style-type: none;'>%{host_down_items}</ul>",
        ["host_down_item"] = "<li>Host %{host_id}</li>",
        ...
        ["periodicity_scan_1_day_ended"] = "<br>Daily Vulnerability Scan successfully completed.</br><br>Start time: %{start_date}.</br><br>End time: %{end_date}.</br><br>Scan duration: %{duration}.</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}</br>%{skipped_hosts_list}<br>Found %{cves}; %{udp_ports}; %{tcp_ports}.</br><br>See full report here <a href='%{url}'>Vulnerability Scan Report</a>.</br>",
        ["periodicity_scan_1_week_ended"] = "<br>Weekly Vulnerability Scan successfully completed.</br><br>Start time: %{start_date}.</br><br>End time: %{end_date}.</br><br> Scan duration: %{duration}.</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}</br>%{skipped_hosts_list}<br>Found %{cves}; %{udp_ports}; %{tcp_ports}.</br><br>See full report here <a href='%{url}'>Vulnerability Scan Report</a>.</br>",
        ["scan_all_ended"] = "<br>Vulnerability Scan of all entries successfully completed.</br><br>Start time: %{start_date}.</br><br>End time: %{end_date}.</br><br>Scan duration: %{duration}.</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}</br>%{skipped_hosts_list}<br>Found %{cves}; %{udp_ports}; %{tcp_ports}.</br><br>See full report here <a href='%{url}'>Vulnerability Scan Report</a>.</br>",
