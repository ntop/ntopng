local lang = {
  ...
  ["show_alerts"] = {
    ...
    ["presets"] = {
      ["30_min"] = "Last 30 minutes",
      ["5_min"] = "Last 5 minutes",
      ["day"] = "Last day",
      ["hour"] = "Last hour",
      ["month"] = "Last month",
      ["presets"] = "Presets",
