local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["host_alert_host_ban"] = "Missbehaviour limit exceeded by %{entity}. Dangerous host [Score: ${score}][After: %{duration} mins]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["host_ban_description"] = "Trigger when an host is marked as dangerous due to his missbehaviour",
