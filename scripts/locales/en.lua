local lang = {
  ...
  ["prefs"] = {
    ...
    ["ts_and_stats_data_retention"] = "InfluxDB Timeseries Data Retention",
    ["ts_and_stats_data_retention_descr"] = "Retention (days) for InfluxDB timeseries. Default: 30 days.<br><b>Note:</b> If InfluxDB is currently used, to change the retention policy correctly, ntopng restart is needed.<br><b>Note:</b> If InfluxDB v.2 with a compatible v.1 bucket is used, the retention policy does not work.",
