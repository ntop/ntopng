local lang = {
  ...
  ["nedge"] = {
    ...
    ["default_shaper_descr"] = "The Default shaper percentage w.r.t. interface speed.",
    ...
    ["slow_pass_shaper_descr"] = "The Slow Pass shaper percentage w.r.t. interface speed.",
    ["slower_pass_shaper_descr"] = "The Slower Pass shaper percentage w.r.t. interface speed.",
    ...
    ["x_shaper_per_host_descr"] = "The %{shaper} maximum per-host rate. 0 for unlimited.",
