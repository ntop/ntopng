local lang = {
  ...
  ["flow_callbacks_config"] = {
    ...
    ["old_ssl_version"] = "Old TLS Version",
    ["old_ssl_version_description"] = "Trigger an alert when an old (and possibly unsecure) TLS version is detected",
    ["potentially_dangerous_protocol"] = "Potentially dangerous protocol",
    ...
    ["ssl_cert_mismatch"] = "TLS Certificate Issues",
    ["ssl_cert_mismatch_description"] = "Trigger an alert when a mismatched TLS certificate is detected",
    ["ssl_unsafe_ciphers"] = "TLS Unsafe Ciphers",
    ["ssl_unsafe_ciphers_description"] = "Trigger an alert when unsafe TLS ciphers are detected",
  ...
  ["snmp"] = {
    ...
    ["lldpRemChassisId"] = "Remote Device MAC",
