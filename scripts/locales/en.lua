local lang = {
  ...
  ["about"] = {
    ["handle_licenses"] = {
      ...
      ["no_licenses_yet"] = "No licenses loaded yet: use <b>Manage Licenses</b> to retrieve them with your e-mail address",
      ["retrieve_licenses"] = "Manage Licenses",
      ["update_licenses"] = "Refresh",
      ["retrieve_licenses_tooltip"] = "Retrieve the Authentication Token associated with an e-mail address",
      ...
      ["page_notes_retrieve_licenses"] = "Click the button 'Retrieve Licenses' to load the licenses purchased by a specific e-mail address",
      ["modal_notes_retrieve_licenses"] = "Insert the e-mail address used to purchase the licenses and click on the 'Retrieve' button",
      ["resend_auth_token"] = "Resend a new token",
      ["resend_auth_token_wait"] = "You can request a new token in %{seconds}s",
