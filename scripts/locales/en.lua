local lang = {
  ...
  ["category_lists"] = {
    ...
    ["connection_time_out"] = "The server connection timeout out after %{duration} seconds [HTTP Code: %{err_code}]",
    ...
    ["server_returned_error"] = "The server returned an error [HTTP Code: %{err_code}]",
