local lang = {
  ...
  ["about"] = {
    ...
    ["licence_generation"] = "Click on the above URL to generate your professional version license, or purchase a license at <a title=\"%{purchase_url}\">e-shop  <i class=\"fas fa-external-link-alt\"></i></a>.<br>If you are no-profit, research or an education institution please read <a title=\"%{universities_url}\">this  <i class=\"fas fa-external-link-alt\"></i></a>.",
  ...
  ["alerts_dashboard"] = {
    ...
    ["suspicious_file_transfer_url"] = "%{type_icon} Detected suspicious file transfer [%{url} %{info} %{href} ]",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_create_custom_scripts"] = "Documentation to create custom scripts for the execution of callbacks is available at the following <a title=\"%{url}\">link <i class=\"fas fa-external-link-alt\"></i></a>.",
  ...
  ["dns_page"] = {
    ...
    ["doh_dot_servers"] = "Contacted <A title=\"https://en.wikipedia.org/wiki/DNS_over_HTTPS\" target=_blank>DoH <i class='fas fa-external-link-alt'></i></A> / <A title=\"https://en.wikipedia.org/wiki/DNS_over_TLS\" target=_blank>DoT <i class='fas fa-external-link-alt'></i></A> Servers",
  ...
  ["flow_details"] = {
    ...
    ["iec104_mask"] = "<A title=https://infosys.beckhoff.com/english.php?content=../content/1033/tcplclibiec870_5_104/html/tcplclibiec870_5_104_objref_overview.htm&id>TypeIDs <i class='fas fa-external-link-alt'></i></A>",
    ...
    ["tos"] = "<A target='_blank' title='https://en.wikipedia.org/wiki/Differentiated_services'>DSCP <i class='fas fa-external-link-alt'></i></A> / <A target='_blank' title='https://en.wikipedia.org/wiki/Explicit_Congestion_Notification'>ECN <i class='fas fa-external-link-alt'></i></A> [ Client / Server ]",
  ...
  ["flow_devices"] = {
    ...
    ["note_observation_points_fields2"] = "To check the way to configure a new observation point check <a title=\"%{url}\"><i class=\"fas fa-external-link-alt\"></i> Here</a>. Restart is needed.",
  ...
  ["prefs"] = {
    ...
    ["n2n_supernode_description"] = "The address of the <a title=\"%{url}\">n2n</a> <i class=\"fas fa-external-link-alt\"></i> supernode. Set up your own supernode in order to have a fully private remote access.<br><b>NOTE</b>: this change will have affect only after Remote Assistance restart.",
