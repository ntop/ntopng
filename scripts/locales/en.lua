local  en = {
  ...
  users = {
   ...
   nedge = {
      ...
      gateway_type_descr = "You can bind a gateway to an existing interface default gateway or specify a manual IP address.",
      ...
      ping_address_description = "The address to ping to verify gateway status.",
