local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["blackhole_contacts"] = "%{entity} scanner dected [TCP Blackhole Contacts : (as client: %{as_client}) (as server: %{as_server})] [Num Contacted Host Ports: %{num_server_ports}]",
    ...
    ["rx_scan_detected"] = "%{entity} RX-only under scan detected [TCP Blackhole Contacts : (as client: %{as_client}) (as server: %{as_server})] [Num Contacted Host Ports: %{num_server_ports}]",
