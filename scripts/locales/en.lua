local lang = {
  ...
  ["prefs"] = {
    ...
    ["http_auth_server_description"] = "URL of the HTTP server used to authenticate users.",
    ["http_enable_access_log_description"] = "Enable logging of HTTP access requests.",
    ["http_enable_access_log_title"] = "HTTP Authentication Log",
