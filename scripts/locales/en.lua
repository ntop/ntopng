  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["email"] = {
        ...
        ["periodicity_scan_1_day_ended"] = "<br>Daily Vulnerability Scan ended.</br><br> Found %{cves}; %{udp_ports}; %{tcp_ports}.</br> <br>See full report here <a href='%{url}'> Vulnerability Scan Report</a>.</br>",
        ["periodicity_scan_1_week_ended"] = "<br>Weekly Vulnerability Scan ended.</br><br> Found %{cves}; %{udp_ports}; %{tcp_ports}.</br> <br> See full report here <a href='%{url}'> Vulnerability Scan Report</a>.</br>",
        ["scan_all_ended"] = "<br>Vulnerability Scan of all entries ended.</br> <br> Found %{cves}; %{udp_ports}; %{tcp_ports}.</br> <br> See full report here <a href='%{url}'> Vulnerability Scan Report</a>. </br>",
