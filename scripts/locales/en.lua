local lang = {
  ...
  ["manage_configurations"] = {
    ...
    ["everything"] = "Entire %{product} configuration (includes users, preferences, and all configurations below). It is recommended to import the configuration on a clean intallation only (or after a Factory Reset).",
  ...
  ["rest_consts"] = {
    ...
    ["ADD_EXPORTER_SITE_FAILED"] = "Unable to add an exporter site with the submitted params",
    ...
    ["DELETE_EXPORTER_SITE_FAILED"] = "Unable to delete an exporter site with the submitted params",
    ...
    ["EDIT_EXPORTER_SITE_FAILED"] = "Unable to edit an exporter site with the submitted params",
