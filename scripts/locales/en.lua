local lang = {
  ...
  ["graphs"] = {
    ...
    ["note_chart_zoom"] = "Click and drag on the chart to zoom.",
  ...
  ["prefs"] = {
    ...
    ["could_not_contact_influxdb"] = "Could not contact the InfluxDB database",
    ["databases"] = "Databases",
    ...
    ["influxdb_create_error"] = "Could not create \"%{db}\" database",
    ...
    ["influxdb_retention_error"] = "Could not set retention policy on database \"%{db}\"",
    ["influxdb_storage_description"] = "Number of days to keep one timeseries data, 0 for unlimited. Default: 365 days.",
    ...
    ["multiple_timeseries_database_description"] = "The database used for storing and retrieving timeseries data.",
    ["multiple_timeseries_database_title"] = "Timeseries Database",
    ["mysql"] = "MySQL",
