local lang = {
  ...
  ["prefs"] = {
    ...
    ["timeseries_resolution_resolution_description"] = "The interval between consecutive timeseries data points for local hosts.<br><b>NOTE</b>:<ul><li>Timeseries retention time can be set <A HREF=\"prefs.lua?tab=retention\">here</A></li></ul>",
