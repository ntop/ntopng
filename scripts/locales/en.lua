local lang = {
  ...
  ["snmp"] = {
    ...
    ["snmp_no_qos_polled_devices"] = "SNMP Polling Timeliness (No FAT MIBs)",
    ["snmp_qos_polled_devices"] = "SNMP Polling Timeliness (FAT MIBs only)",
    ["num_polled_devices"] = "Polled Devices",
    ["num_devices_down"] = "Devices Down",
    ["num_devices_active"] = "Devices Up",
    ["polled_late"] = "Devices Not Polled In Time (SNMP Overrun)",
    ["polled_ok"] = "Devices Polled On Time (SNMP)",
