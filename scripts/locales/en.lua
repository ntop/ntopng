local lang = {
  ...
  ["total_incoming_unreachable_flows"] = "Port Unreachable Flows As Server",
  ["total_outgoing_anomalous_flows"] = "Total Misbehaving Flows As Client",
  ["total_outgoing_unreachable_flows"] = "Port Unreachable Flows As Client",
  ["traffic"] = "Traffic",
  ...
  ["graphs"] = {
    ...
    ["total_unreachable_flows"] = "Port Unreachable Flows",
