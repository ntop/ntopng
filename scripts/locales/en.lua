local lang = {
  ...
  ["internals"] = {
    ...
    ["queues"] = "Queues",
    ["rrd_drops"] = "RRD Drops",
    ["snmp_fat_mibs"] = "SNMP QoS MIBs",
    ["snmp_other_mibs"] = "SNMP non-QoS MIBs",
  ...
  ["snmp"] = {
    ...
    ["snmp_no_qos_polled_devices"] = "SNMP Devices Polling (Without QoS MIB)",
    ["snmp_qos_polled_devices"] = "SNMP Devices Polling (With QoS MIB)",
