local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["zmq_flow_collection_drops"] = "One or more <a href=\"%{url}\">%{name}</a> remote probes are dropping during collection. Latest check highlighted %{drops} drops.",
  ...
  ["alerts_dashboard"] = {
    ...
    ["zmq_flow_collection_drops"] = "Flow Collection Drops",
  ...
  ["ndpi_page"] = {
    ["application_protocol"] = "Application Protocol",
    ["application_protocol_categories"] = "Application Protocol Categories",
