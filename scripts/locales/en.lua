local lang = {
    ...
    ["local_hosts_report_description"] = "The availability color depends on the amount of traffic, there are three different possible colors, calculated based on the traffic done, in proportion with the maximum traffic seen on that point:<br><div class='d-inline-flex justify-content' style='background-color: rgb(211, 211, 211); height: 8px; width: 8px;'></div>: No traffic<br><div class='d-inline-flex justify-content' style='background-color: rgb(57, 211, 83); height: 8px; width: 8px;'></div>: traffic lesser then 1/3 of the maximum<br><div class='d-inline-flex justify-content' style='background-color: rgb(38, 166, 65); height: 8px; width: 8px;'></div>: traffic lesser then 2/3 of the maximum<br><div class='d-inline-flex justify-content' style='background-color: rgb(0, 109, 50); height: 8px; width: 8px;'></div>: traffic higher then 2/3 of the maximum",
    ...
    ["local_hosts_report"] = "Loc.Hosts Report",
    ...
    ["alert_messages"] = {
        ...
        ["syn_flood_attacker"] = "%{entity} is a SYN flooder [%{value} &gt; %{threshold} SYN/sec on half-opened TCP Connections]",
        ["syn_flood_victim"] = "%{entity} is under SYN flood attack [%{value} &gt; %{threshold} SYN/sec on half-opened TCP Connections]",
