local lang = {
  ...
  ["about"] = {
    ...
    ["create_license_l"] = "Please be aware that you need also to create <i>/etc/ntopng.license</i> file as this file is used by the other companion applications. See <a class='text-white' href='https://www.ntop.org/support/faq/what-is-included-in-ntopng-enterprise-l/'>https://www.ntop.org/support/faq/what-is-included-in-ntopng-enterprise-l/</a> for details",
    ["data_directory"] = "Data",
  ...
  ["endpoint_notifications"] = {
    ["actions"] = "Actions",
    ["add_new_endpoint"] = "Add New Alert Endpoint",
    ["add_new_recipient"] = "Add New Alert Recipient",
    ["associated_to"] = "Bound To",
    ["associated_to_endpoints"] = "Bound to Alert Endpoint",
    ["associated_to_recipients"] = "Bound to Alert Recipient",
    ["create_endpoint_first"] = "Please create a notification endpoint first!",
    ["edit_endpoint"] = "Edit Alert Endpoint",
    ["edit_endpoints"] = "Edit Alert Endpoints",
    ["edit_recipient"] = "Edit Alert Recipient",
    ["empty_endpoints"] = "No Alert Endpoint defined.",
    ...
    ["recipient_name"] = "Name",
    ["recipient_select"] = "Alert Endpoint",
    ["recipient_severity"] = "Minimum Severity",
    ["recipient_type"] = "Alert Recipient List",
    ["recipient_users"] = "Pools using Alert Recipient %{recipient}",
    ["remove_endpoint"] = "Delete Alert Endpoint",
  ...
  ["flow_devices"] = {
    ...
    ["snmp_flow_to_enable"] = "SNMP and Flow Device Timeseries",
    ["duplex"] = "Duplex",
    ...
    ["in_errors"] = "In Errors", 
    ["remember_ratio"] = "Remember, you can enable the Flow/SNMP Ratio Column following this steps:",
    ["remember_counter_ratio"] = "Remember, you can enable the Counters/SNMP Ratio Column following this steps:",
    ["note_condition_1"] = "1) Device %{device} must support SNMP and must be configured in the <a href=\"%{url}\">SNMP</a> devices page",
    ["note_condition_2"] = "2) SNMP and flow devices timeseries must be enabled from the from the <A HREF=\"%{url}\"><i class=\"fas fa-flask\"></i> Preferences</A> (Expert View)",
  ...
  ["manage_configurations"] = {
    ...
    ["notifications"] = "Alert Endpoints and recipients",
  ...
  ["user_activity"] = {
    ...
    ["delete_pool"] = "User '%{user}' deleted pool %{pool_id}.",
    ...
    ["edit_pool"] = "User '%{user}' modified pool %{pool_id} with name %{pool_name} and members '%{members}'.",
