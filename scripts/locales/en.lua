local lang = {
  ...
  ["flow_alerts_explorer"] = {
    ...
    ["alert_unexpected_gateway_title"] = "Unexpected Gateway",
    ...
    ["status_unexpected_gateway_description"] = "Unexpected Gateway found: %{server}",
  ...
  ["prefs"] = {
    ...
    ["toggle_dns_cache_description"] = "Creates a DNS cache in Redis under ntopng.dns_cache. Entries expire according to the DNS TTL.",
