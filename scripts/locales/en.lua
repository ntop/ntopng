local lang = {
  ...
  ["copied"] = "Copied",
  ["copy_button"] = "<button onclick='const textArea = document.createElement(`textarea`);textArea.value=`%{full_name}`;textArea.style.position=`absolute`;textArea.style.left=`-999999px`;document.body.prepend(textArea);textArea.select();document.execCommand(`copy`);' class='btn btn-light btn-sm border ms-1' style='cursor: pointer;'><i class='fas fa-copy'></i></button> <span title='%{full_name}'>%{name}</span>",
  ["count"] = "Count",
  ["countries"] = "Countries",
  ["country"] = "Country",
  ["create"] = "Create",
  ...
  ["import_snmp_devices_error"] = "Some lines in the file are malformed, or the maximum number of configurable SNMP devices has been reached.",
  ["in_usage"] = "In Usage",
  ["inactive"] = "Inactive",
  ...
  ["ipv4"] = "IPv4",
  ["ipv6"] = "IPv6",
  ["issues_score"] = "Score / Issues (with Description)",
  ...
  ["flow_details"] = {
    ...
    ["blacklisted_flow_detailed"] = "Blacklisted %{who} [ Blacklist \"%{blacklist}\" ] [ UID: %{uid} ]",
