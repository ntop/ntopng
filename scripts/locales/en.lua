local lang = {
  ...
  ["internals"] = {
    ...
    ["sleeping"] = "Sleeping",
    ["slow_rrd_writes"] = "Slow TS Writes",
    ["slow_rrd_writes_descr"] = "TS writes too slow, some writes have been skipped",
  ...
  ["prefs"] = {
    ...
    ["toggle_local_hosts_stats_rrd_creation_description"] = "Toggle the creation of additional timeseries, e.g. active flows, contacts, alerts.",
    ["toggle_local_hosts_stats_rrd_creation_title"] = "Statistics",
