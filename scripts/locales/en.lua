local lang = {
  ...
  ["prefs"] = {
    ...
    ["snmp_interface_port_type_title"] = "Port Type",
    ["snmp_interface_port_type_description"] = "SNMP interface port type",
    ["snmp_interface_port_type_list"] = {
        ["transit"] = "Transit",
        ["ix"] = "IX (Internet Exchange)",
        ["peering"] = "Peering",
        ["customer_interface"] = "Customer Interface",
        ["internet_connectivity"] = "Internet Connectivity (Uplink)",
        ["internal_interface"]="Internal Interface (LAN)",
        ["other"] = "Other",
    },
