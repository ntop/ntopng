local lang = {
  ...
  ["ai_audit"] = "Usage Audit",
  ["ai_policy"] = "AI Policy",
  ["ai_usage_stats"] = "Usage Stats",
  ...
  ["always"] = "Always",
  ["analysis"] = "Analysis",
  ["analyst_pipeline"] = "Analyst Pipeline",
  ...
  ["begin"] = "Begin",
  ["bgp_looking_glass"] = "BGP Looking Glass",
  ...
  ["countries"] = "Countries",
  ["country"] = "Country",
  ["country_historical_disabled"] = "Historical countries charts disabled by preferences, please enable it <a href='/lua/admin/prefs.lua?tab=on_disk_ts'><i class='fas fa-cog fa-sm'></i></a>",
  ...
  ["flow"] = "Flow",
  ["flow_alerts_filter"] = "Flow Alerts",
  ...
  ["local_hosts_traffic"] = "Historical",
  ["local_hosts_traffic_description"] = "This page contains the traffic breakdown (local vs remote) for all known local hosts.",
  ...
  ["menu.reason.is_db_view_interface"] = "Interface is a database view",
  ["menu.reason.is_enterprise"] = "Requires an Enterprise license",
  ["menu.reason.is_enterprise_l"] = "Requires Enterprise L license",
  ["menu.reason.is_enterprise_m"] = "Requires Enterprise M license",
  ["menu.reason.is_loopback_interface"] = "Interface is a loopback interface",
  ["menu.reason.is_nedge"] = "Only available on nEdge",
  ["menu.reason.is_nedge_enterprise"] = "Requires nEdge Enterprise",
  ["menu.reason.is_oem"] = "Not available in OEM builds",
  ["menu.reason.is_pcap_dump"] = "Interface is a PCAP dump interface",
  ["menu.reason.is_routing_mode"] = "Requires routing mode",
  ["menu.reason.is_system_ifid"] = "Only available on the system interface",
  ["menu.reason.is_system_interface"] = "Not available on the system interface",
  ["menu.reason.is_viewed"] = "Not available on a view interface",
  ["menu.reason.is_viewed_interface"] = "Not available on a view interface",
  ["menu.reason.is_windows"] = "Not available on Windows",
  ["menu.reason.is_zmq_interface"] = "Not available on ZMQ interfaces",
  ["menu.reason.limit_resource_usage"] = "Disabled to limit resource usage",
  ["menu.reason.no_active_scan"] = "Active Scan is not available",
  ["menu.reason.no_admin"] = "Requires administrator privileges",
  ["menu.reason.no_alerts_cap"] = "Requires the alerts capability",
  ["menu.reason.no_asn_mode"] = "ASN mode is not enabled",
  ["menu.reason.no_asset_inventory"] = "Asset inventory is not enabled",
  ["menu.reason.no_bgp_server"] = "No BGP server configured",
  ["menu.reason.no_ch_support"] = "ClickHouse support is not enabled",
  ["menu.reason.no_checks_cap"] = "Requires the checks capability",
  ["menu.reason.no_containers"] = "No containers observed on this interface",
  ["menu.reason.no_developer_cap"] = "Requires the developer capability",
  ["menu.reason.no_developer_menu"] = "Developer menu is disabled",
  ["menu.reason.no_devices_exclusion"] = "Device exclusion is not available",
  ["menu.reason.no_discoverable_interface"] = "Interface is not discoverable",
  ["menu.reason.no_dump_cache"] = "Configuration dump cache is not available",
  ["menu.reason.no_enterprise"] = "Requires an Enterprise license",
  ["menu.reason.no_enterprise_l"] = "Requires Enterprise L license",
  ["menu.reason.no_enterprise_l_or_nedge"] = "Requires Enterprise L or nEdge",
  ["menu.reason.no_enterprise_m"] = "Requires Enterprise M license",
  ["menu.reason.no_enterprise_m_or_nedge"] = "Requires Enterprise M or nEdge",
  ["menu.reason.no_enterprise_or_nedge_with_ch_hist"] = "Requires Enterprise (or nEdge Enterprise) with ClickHouse historical data",
  ["menu.reason.no_enterprise_with_ch"] = "Requires Enterprise with ClickHouse support",
  ["menu.reason.no_enterprise_xl"] = "Requires Enterprise XL license",
  ["menu.reason.no_exporters"] = "No flow exporters configured",
  ["menu.reason.no_geoip"] = "GeoIP database is not available",
  ["menu.reason.no_help_menu"] = "Help menu is disabled",
  ["menu.reason.no_hr_flows"] = "High-resolution flows are not available",
  ["menu.reason.no_influxdb"] = "InfluxDB is not configured as the timeseries driver",
  ["menu.reason.no_local_auth_or_local_user"] = "Local authentication is disabled",
  ["menu.reason.no_macs"] = "No MAC addresses observed on this interface",
  ["menu.reason.no_nanalyst"] = "nAnalyst is not available",
  ["menu.reason.no_obs_points"] = "No observation points configured",
  ["menu.reason.no_pods"] = "No pods observed on this interface",
  ["menu.reason.no_pro"] = "Requires a Pro license",
  ["menu.reason.no_service_map"] = "Service map is not available",
  ["menu.reason.no_sflow_devices"] = "No sFlow devices configured",
  ["menu.reason.no_system_interface"] = "Only available on the system interface",
  ["menu.reason.no_vlans"] = "No VLANs observed on this interface",
  ["menu.reason.no_wazuh"] = "Wazuh integration is not enabled",
  ...
  ["menu.suggestion.is_db_view_interface"] = "Select a non-view interface to access this",
  ["menu.suggestion.is_enterprise"] = "Upgrade to Enterprise to unlock this",
  ["menu.suggestion.is_enterprise_l"] = "Upgrade to Enterprise L to unlock this",
  ["menu.suggestion.is_enterprise_m"] = "Upgrade to Enterprise M to unlock this",
  ["menu.suggestion.is_loopback_interface"] = "Select a non-loopback interface to access this",
  ["menu.suggestion.is_nedge"] = "Switch to nEdge to access this",
  ["menu.suggestion.is_nedge_enterprise"] = "Upgrade to nEdge Enterprise to unlock this",
  ["menu.suggestion.is_oem"] = "Not available on this build",
  ["menu.suggestion.is_pcap_dump"] = "Select a live interface to access this",
  ["menu.suggestion.is_routing_mode"] = "Switch nEdge to routing mode to access this",
  ["menu.suggestion.is_system_ifid"] = "Select the system interface to access this",
  ["menu.suggestion.is_system_interface"] = "Select a non-system interface to access this",
  ["menu.suggestion.is_viewed"] = "Select the parent (non-view) interface to access this",
  ["menu.suggestion.is_viewed_interface"] = "Select the parent (non-view) interface to access this",
  ["menu.suggestion.is_windows"] = "Not available on this platform",
  ["menu.suggestion.is_zmq_interface"] = "Select a non-ZMQ interface to access this",
  ["menu.suggestion.limit_resource_usage"] = "Increase resource usage limits in preferences to access this",
  ["menu.suggestion.no_active_scan"] = "Not available with the current configuration",
  ["menu.suggestion.no_admin"] = "Log in as an administrator to access this",
  ["menu.suggestion.no_alerts_cap"] = "Ask an administrator to grant the alerts capability",
  ["menu.suggestion.no_asn_mode"] = "Enable ASN mode in preferences to access this",
  ["menu.suggestion.no_asset_inventory"] = "Enable asset inventory in preferences to access this",
  ["menu.suggestion.no_bgp_server"] = "Configure a BGP server to access this",
  ["menu.suggestion.no_ch_support"] = "Enable ClickHouse to access this",
  ["menu.suggestion.no_checks_cap"] = "Ask an administrator to grant the checks capability",
  ["menu.suggestion.no_containers"] = "Available once containers are seen on this interface",
  ["menu.suggestion.no_developer_cap"] = "Ask an administrator to grant the developer capability",
  ["menu.suggestion.no_developer_menu"] = "Enable the developer menu in preferences to access this",
  ["menu.suggestion.no_devices_exclusion"] = "Not available with the current configuration",
  ["menu.suggestion.no_discoverable_interface"] = "Select a discoverable interface to access this",
  ["menu.suggestion.no_dump_cache"] = "Not available with the current configuration",
  ["menu.suggestion.no_enterprise"] = "Upgrade to Enterprise to unlock this",
  ["menu.suggestion.no_enterprise_l"] = "Upgrade to Enterprise L to unlock this",
  ["menu.suggestion.no_enterprise_l_or_nedge"] = "Upgrade to Enterprise L, or use nEdge, to unlock this",
  ["menu.suggestion.no_enterprise_m"] = "Upgrade to Enterprise M to unlock this",
  ["menu.suggestion.no_enterprise_m_or_nedge"] = "Upgrade to Enterprise M, or use nEdge, to unlock this",
  ["menu.suggestion.no_enterprise_or_nedge_with_ch_hist"] = "Upgrade license and enable ClickHouse to unlock this",
  ["menu.suggestion.no_enterprise_with_ch"] = "Upgrade to Enterprise and enable ClickHouse to unlock this",
  ["menu.suggestion.no_enterprise_xl"] = "Upgrade to Enterprise XL to unlock this",
  ["menu.suggestion.no_exporters"] = "Configure a flow exporter to access this",
  ["menu.suggestion.no_geoip"] = "Install a GeoIP database to access this",
  ["menu.suggestion.no_help_menu"] = "Enable the help menu in preferences to access this",
  ["menu.suggestion.no_hr_flows"] = "Not available with the current configuration",
  ["menu.suggestion.no_influxdb"] = "Select InfluxDB as the timeseries driver to access this",
  ["menu.suggestion.no_local_auth_or_local_user"] = "Enable local authentication to access this",
  ["menu.suggestion.no_macs"] = "Available once devices are seen on this interface",
  ["menu.suggestion.no_nanalyst"] = "Upgrade/activate your license to unlock nAnalyst",
  ["menu.suggestion.no_obs_points"] = "Configure an observation point to access this",
  ["menu.suggestion.no_pods"] = "Available once pods are seen on this interface",
  ["menu.suggestion.no_pro"] = "Upgrade to Pro to unlock this",
  ["menu.suggestion.no_service_map"] = "Not available with the current configuration",
  ["menu.suggestion.no_sflow_devices"] = "Configure an sFlow device to access this",
  ["menu.suggestion.no_system_interface"] = "Select the system interface to access this",
  ["menu.suggestion.no_vlans"] = "Available once VLANs are seen on this interface",
  ["menu.suggestion.no_wazuh"] = "Enable Wazuh in Preferences > External Integrations",
  ["menu.suggestion.pro_forced_community"] = "Not available in forced community mode",
  ...
  ["years"] = "Years",
  ["yes"] = "Yes",
  ["zmq_default_encryption_title"] = "Insecure ZMQ Encryption Key",
  ["zmq_default_encryption_warning"] = "This ZMQ interface is using a default encryption key which is public. Please configure a dedicated encryption key with --zmq-encryption-key-priv (or let ntopng generate one automatically with --zmq-encryption).",
  ["about"] = {
    ["about"] = "About",
    ...
    ["handle_licenses"] = {
      ...
      ["email"] = "E-Mail",
      ["email_placeholder"] = "Insert here the e-mail used to purchase the licenses...",
      ["info"] = "Info",
      ["last_update"] = "Last update: %{date}",
      ["license_info"] = "License Information",
      ["licenses_expired"] = "%{count} license(s) expired",
      ["licenses_expiring_soon"] = "%{count} license(s) expiring within 30 days",
      ["maintenance"] = "Maintenance",
  ...
  ["acl_page"] = {
    ...
    ["scope_filters_note"] = "The list of filters is applied on all the Access Control List rules, meaning that the rules will be applied ONLY on the list of IPs/Networks configured here. If left empty then the rules will be applied on all flows.",
    ["scope_filters_note_interfaces"] = "The list of filters will be Global, so each Interface will have the same list",
    ...
    ["errors"] = {
      ...
      ["incorrect_ip_network_list"] = "Incorrect IP/Network CIDR provided, please provide a valid list",
  ...
  ["active_scan"] = {
    ["active_scan_in_progress"] = "Active Scan in Progress",
  ...
  ["ai_dashboard"] = {
    ["accept_widget"] = "Looks good, mark as reviewed",
    ["add_to_dashboard"] = "Add to Dashboard",
    ["add_widget"] = "Add Widget",
    ["apply"] = "Apply",
    ["ask_ai_edit_query_placeholder"] = "e.g. only count TCP flows, or group by hour instead",
    ["back"] = "Back",
    ["choose_component"] = "Choose a component",
    ["configure_query"] = "Provide the SQL query, then test it",
    ["configure_widget"] = "Configure the widget",
    ["copy_query"] = "Copy ClickHouse query",
    ["create_dashboard"] = "Create Dashboard",
    ["current_widgets"] = "Current widgets",
    ["dashboard_deleted"] = "Dashboard deleted",
    ["dashboard_description"] = "Description",
    ["dashboard_name"] = "Dashboard name",
    ["dashboard_name_hint"] = "Any text is fine, except a single quote (').",
    ["dashboard_name_invalid"] = "Single quotes (') aren't allowed in the dashboard name.",
    ["dashboard_saved"] = "Dashboard saved",
    ["delete_dashboard"] = "Delete Dashboard",
    ["delete_dashboard_confirm"] = "Are you sure you want to delete <b>%{name}</b>? This action cannot be undone.",
    ["describe_visualization"] = "Describe what you'd like to visualize",
    ["discard_changes"] = "Discard changes",
    ["discard_draft"] = "Discard",
    ["done_editing"] = "Done Editing",
    ["edit_layout"] = "Edit Layout",
    ["editing_query_for"] = "Editing query for %{title}",
    ["editing_query_intro"] = "Describe how you'd like this widget's query changed. nAnalyst will revise only the SQL — title, chart type and layout stay as they are.",
    ["exit_edit_mode"] = "Stop editing this query",
    ["explain_intro"] = "Describe the visualization you'd like to build in plain language. nAnalyst can use ClickHouse flow/alert tables (and Wazuh alert data, if available) to build it — for example \"top 10 talkers by bytes in the last hour\" or \"pie chart of alert severity distribution\".",
    ["filters"] = "Filters",
    ["generate"] = "Generate",
    ["generating"] = "Generating...",
    ["height_rows"] = "Height (rows)",
    ["my_dashboards"] = "My Dashboards",
    ["name_required_hint"] = "Name the dashboard to save it",
    ["needs_review"] = "Needs review",
    ["new_dashboard"] = "New Dashboard",
    ["new_widgets"] = "New widgets (not yet saved)",
    ["no_dashboards"] = "No dashboards yet. Create one from the \"Create Dashboard\" tab.",
    ["preview"] = "Preview",
    ["preview_and_size"] = "Preview and choose its size",
    ["query_copied"] = "Copied!",
    ["query_ok"] = "Query executed successfully",
    ["query_updated"] = "Query updated — review it in the Query step",
    ["restore_draft"] = "Restore",
    ["restore_draft_body"] = "We found widgets from a previous session that weren't saved. Restore them, or discard and start fresh.",
    ["restore_draft_title"] = "Restore unsaved widgets?",
    ["retrying"] = "Retrying...",
    ["review_required_hint"] = "Review or accept every new widget before saving",
    ["reviewed"] = "Reviewed",
    ["reviewed_count"] = "%{done}/%{total} reviewed",
    ["revise_with_ai"] = "Revise with nAnalyst",
    ["save_dashboard"] = "Save Dashboard",
    ["save_failed"] = "Save failed",
    ["select_dashboard"] = "Select a dashboard",
    ["select_dashboard_first_hint"] = "Pick a dashboard above (or start a new one) to begin generating widgets.",
    ...
    ["testing_query"] = "Testing query...",
    ["time_range"] = "Time Range",
    ["title"] = "AI Dashboard",
    ["title_field"] = "Title",
    ["unit"] = "Unit",
    ["unknown_widget_type"] = "Unknown widget type",
    ["unsaved_changes_body"] = "You have unreviewed widget changes that haven't been saved. Switching now will discard them.",
    ["unsaved_changes_title"] = "Unsaved changes",
    ["unsaved_suffix"] = "not saved yet",
    ["widget_added"] = "Widget added",
    ["widget_no_data_hint"] = "No data in the selected time range and filters. Try widening the time range.",
    ["widget_plural"] = "widgets",
    ["widget_singular"] = "widget",
    ["width_cols"] = "Width (columns)",
  ...
  ["alert_messages"] = {
    ...
    ["bgp_prefix_update"] = "BGP update [%{reason}] from peer %{bgp_id} (ASN %{asn}) | next hop: %{next_hop} | origin: %{origin} | AS path: %{as_path} | communities: %{communities} | time: %{time}",
    ["bgp_prefix_update_reason_add_new_prefix"] = "Add New Prefix",
    ["bgp_prefix_update_reason_replace_existing_prefix"] = "Replace Existing Prefix",
    ["bgp_prefix_update_reason_withdraw_prefix"] = "Withdraw Prefix",
    ...
    ["vpn_detection"] = "VPN connection detected",
  ...
  ["alerts_dashboard"] = {
    ...
    ["access_control_list_arp_description"] = "Trigger an alert whenever a flow with ARP protocol not following the configured rules in the Access Control List page is detected <a href='/lua/pro/admin/access_control_list.lua'><i class='fas fa-cog fa-sm'></i></a>. <b>This does not block the traffic, only triggers the alert</b>",
    ["access_control_list_check_description"] = "Trigger an alert whenever a flow with ICMP/TCP/UDP protocol not following the configured rules in the Access Control List page is detected <a href='/lua/pro/admin/access_control_list.lua'><i class='fas fa-cog fa-sm'></i></a>. <b>This does not block the traffic, only triggers the alert</b>",
    ...
    ["active_scan_description"] = "Trigger an alert when a Active Scan is executed and the new scan reports different vulnerabilities (meaning that some could be solved and new ones could be there).",
    ["active_scan_title"] = "Active Scan",
    ...
    ["disk_space_low_descr"] = "The maximum disk space usage percentage. When the used space on the ntopng data volume (or on the separate traffic-recording volume, when configured) exceeds this threshold, an alert is triggered",
    ...
    ["host_policy_description"] = "Trigger an alert when a flow does not respect the policies configured in the Network Policy page <a href='/lua/admin/network_configuration.lua?page=policy'><i class='fas fa-cog fa-sm'></i></a>",
  ...
  ["asn_configuration"] = {
    ["all_asn"] = "All ASNs",
    ["costumer_asn_message"] = "My ASNs don't set local ASNs. These can be configured with the -m parameter.",
  ...
  ["asset_details"] = {
    ...
    ["wazuh_cpu"] = "CPU",
    ["wazuh_cpu_cores"] = "CPU Cores",
    ["wazuh_iface_mac"] = "MAC",
    ["wazuh_iface_name"] = "Name",
    ["wazuh_iface_rx"] = "Bytes Received",
    ["wazuh_iface_state"] = "State",
    ["wazuh_iface_tx"] = "Bytes Sent",
    ...
    ["wazuh_network_interfaces"] = "Wazuh Network Interfaces",
    ["wazuh_open_ports"] = "Open Ports",
    ["wazuh_os_arch_platform"] = "Architecture / Platform",
    ["wazuh_os_name_version"] = "OS Name",
    ["wazuh_ram"] = "RAM",
    ["wazuh_ram_free"] = "RAM Free",
    ["wazuh_ram_total"] = "Total RAM",
    ["wazuh_ram_usage"] = "RAM Usage",
  ...
  ["checks"] = {
    ...
    ["category_ids_ips_descr"] = "Checks that evaluate the behavior of hosts and add them to the jailed hosts pool when deemed to be suspicious.",
  ...
  ["db_explorer"] = {
    ...
    ["traffic_presence"] = "Flows Available",
  ...
  ["db_search"] = {
    ...
    ["flowfilters"] = {
      ...
      ["exporter_ip"] = "Flow Exporter",
      ["first_flow_dump"] = "First Flow Dump",
      ["first_flow_dump_excluded"] = "Exclude First Dumps",
      ["first_flow_dump_only"] = "Only First Dumps",
      ["first_seen"] = "First Seen",
      ["flow_risk"] = "Flow Risk",
  ...
  ["delete_data"] = {
    ...
    ["purge_all_failed"] = "Unable to mark the selected data for deletion.",
    ["purge_all_ok"] = "The selected data has been successfully marked for deletion. Restart %{product} to make the deletion effective.",
    ["restart_product_toast"] = "Restart %{product} to make the deletion of active interface effective.",
  },
  ["demo_tour_messages"] = {
    ["ai_policy_examples_text"] = "Click an example to see how to phrase a policy, or write your own below describing what traffic to monitor and what counts as a violation.",
    ["ai_policy_examples_title"] = "Example Policies",
    ["ai_policy_provider_text"] = "Pick which configured LLM turns your description into a working detection rule.",
    ["ai_policy_provider_title"] = "Model for Policy Generation",
    ["ai_policy_reach_text"] = "AI Policy lives under the same nAnalyst icon in the sidebar as the chat.",
    ["ai_policy_reach_title"] = "nAnalyst",
    ["ai_policy_table_text"] = "Every policy you generate appears here with its periodicity, score and status — edit, enable or disable them like any other check.",
    ["ai_policy_table_title"] = "Generated Policies",
    ["dashboard_badges_text"] = "Alerted flows, local hosts and active flows at a glance — click any badge to jump straight to the filtered list.",
    ["dashboard_badges_title"] = "Quick Status",
    ["dashboard_iface_selector_text"] = "Pick which monitored interface to look at. Everything else on the page reacts to this choice.",
    ...
    ["dashboard_widgets_text"] = "Live traffic, top applications, quality and top talkers. Live ports used with pro/enterprise versions and much more. Explore!",
    ["dashboard_widgets_title"] = "Traffic Dashboard",
    ...
    ["flows_filters_text"] = "Narrow the flow table by host, protocol, application, status, quality, traffic type and more using the filter dropdowns above the table.",
    ["flows_filters_title"] = "Filter Live Flows",
    ["flows_table_text"] = "Every live network connection, updated in real time: protocol, endpoints, throughput and score. Click a row for full flow details.",
    ["flows_table_title"] = "Active Flows Table",
    ["historical_filters_text"] = "Add filters on any indexed field to narrow down the historical search before running the query.",
    ["historical_filters_title"] = "Advanced Filters",
    ["historical_flows_reach_text"] = "Historical Flows lives under the same Flows icon in the sidebar as Live Flows.",
    ["historical_flows_reach_title"] = "Flows",
    ["historical_quick_filter_text"] = "Type to add quick filter tags — host, protocol, application and more — before running the query.",
    ["historical_quick_filter_title"] = "Quick Filter",
    ["historical_results_text"] = "Matching historical flows appear here, aggregated or raw, with the same columns as Live Flows.",
    ["historical_results_title"] = "Flow Records",
    ["historical_time_range_text"] = "Query historical flow data from your archive over any past window — presets or a custom start/end.",
    ["historical_time_range_title"] = "Pick a Time Range",
    ["interface_charts_text"] = "Local vs remote traffic and IPv4/IPv6 distribution for the selected interface, plus totals, drops and storage usage below.",
    ["interface_charts_title"] = "Traffic Breakdown",
    ["interface_details_reach_text"] = "You can always get back here from the sidebar's Interface icon.",
    ["interface_details_reach_title"] = "Interface",
    ["interface_tabs_text"] = "Networks, Packets, DSCP, Applications, Categories, ICMP, ARP and more — each tab breaks down this interface's traffic differently.",
    ["interface_tabs_title"] = "Interface Sections",
    ["live_flows_reach_text"] = "Live and historical flows both live under the Flows icon in the sidebar. For historical flows, be sure to have Enterprise M and above with clickhouse enabled.",
    ["live_flows_reach_title"] = "Flows",
    ["nanalyst_chat_reach_text"] = "You can always get back here from the sidebar's nAnalyst icon.",
    ["nanalyst_chat_reach_title"] = "nAnalyst",
    ["nanalyst_input_text"] = "Ask about hosts, protocols, flows or anomalies in plain English — nAnalyst queries your traffic data and answers directly.",
    ["nanalyst_input_title"] = "Ask Anything",
    ["nanalyst_new_chat_text"] = "Start a fresh conversation any time. Past conversations stay in the history panel on the left, filterable by Live Flows or Historical.",
    ["nanalyst_new_chat_title"] = "New Conversation",
    ["nanalyst_overview_title"] = "Get Started with nAnalyst",
    ["nanalyst_prefs_llm_local_text"] = "Each provider — Local/self-hosted (any OpenAI-compatible endpoint like Ollama, LM Studio, vLLM), Qwen, OpenAI, and Anthropic — has the same three fields: API URL, model name, and an API token if required. Fill in whichever ones you plan to use.",
    ["nanalyst_prefs_llm_local_title"] = "Configure a Provider",
    ["nanalyst_prefs_llm_text"] = "Click here to configure a local LLM or a cloud provider (Anthropic, Qwen and more) — API URL, token and model name. This is required before nAnalyst can answer questions.",
    ["nanalyst_prefs_llm_title"] = "Set Up an LLM Provider",
    ["nanalyst_prefs_reach_text"] = "You can always get back here from the sidebar's Settings icon.",
    ["nanalyst_prefs_reach_title"] = "Settings",
    ["nanalyst_presets_text"] = "Not sure what to ask? Pick one of these suggested questions to see nAnalyst investigate your traffic instantly.",
    ["nanalyst_presets_title"] = "Quick Start Questions",
    ["nanalyst_provider_text"] = "Switch between configured LLM providers and models here. No provider set up yet? Configure one from Preferences.",
    ["nanalyst_provider_title"] = "Choose Your Model",
    ["nanalyst_rail_invite_text"] = "Ask questions about your network traffic in plain English. Click here to start chatting.",
    ["nanalyst_rail_invite_title"] = "Try nAnalyst",
    ["nanalyst_usage_stats_filters_text"] = "Narrow usage stats by time range, provider, model, or user — useful for spotting which provider is driving cost.",
    ["nanalyst_usage_stats_filters_title"] = "Filter Your Usage",
    ["nanalyst_usage_stats_reach_text"] = "Track token usage and cost per provider, model, and user from here.",
    ["nanalyst_usage_stats_reach_title"] = "Usage Stats",
    ["ntopng_overview_title"] = "Welcome to ntopng",
    ["preferences_main_text"] = "Each setting is toggled or edited here. Changes take effect immediately or after a restart, noted per-setting.",
    ["preferences_main_title"] = "Configure ntopng",
    ["preferences_reach_text"] = "You can always get back here from the sidebar's Settings icon.",
    ["preferences_reach_title"] = "Settings",
    ["preferences_sidebar_text"] = "Preferences are grouped by topic: Alerts, Applications, Notifications, Traffic Recording, User Interface and more. Search to jump directly to a setting.",
    ["preferences_sidebar_title"] = "Settings Categories",
  ...
  ["details"] = {
    ...
    ["local"] = "Traffic Exchanged with Local Hosts",
    ["local_vs_nonlocal_traffic_breakdown"] = "Local vs Non-Local Traffic",
    ["lost"] = "Lost",
    ["mac_address"] = "MAC Address",
    ...
    ["non_local"] = "Traffic Exchanged with Non Local Hosts",
    ["note"] = "NOTE",
    ...
    ["sent_vs_received_traffic_breakdown"] = "Sent vs Received Traffic",
  ...
  ["endpoint_notifications"] = {
    ...
    ["message_labels"] = "Filter alerts matching at least one of the selected labels.",
  ...
  ["entity_thresholds"] = {
    ...
    ["vpn_detection_description"] = "Trigger an alert when a host is detected as connected through a VPN tunnel.",
    ["vpn_detection_title"] = "VPN Detection",
  },
  ["error_messages"] = {
    ["incorrect_exporter"] = "One or more of the inserted Exporters is not correct, please check the spelling",
    ["incorrect_network"] = "One or more of the inserted Networks is not correct, please check the spelling",
  ...
  ["flow_details"] = {
    ...
    ["bgp_looking_glass_descr"] = "Enter an IP address to view its BGP routes",
    ...
    ["configure_check_tooltip"] = "Configure this check",
    ["connect"] = "Connect",
    ...
    ["disable_check_tooltip"] = "Disable this check for this alert",
    ...
    ["hr_charts"] = "High-Resolution Charts",
    ...
    ["user_agent"] = "User Agent",
    ["user_name"] = "User Name",
    ["view_historical_alerts_tooltip"] = "View historical alerts for this flow",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_minor_issues"] = "Minor Issues",
    ["ndpi_minor_issues_descr"] = "Trigger an alert whenever minor packet issues (e.g. TCP problems) are detected",
    ["ndpi_mismatching_protocol_with_ip"] = "Mismatching Protocol with IP",
    ["ndpi_mismatching_protocol_with_ip_descr"] = "Trigger an alert whenever the detected nDPI protocol does not match the server IP address",
    ["ndpi_obfuscated_traffic"] = "Obfuscated Traffic",
    ["ndpi_obfuscated_traffic_descr"] = "Trigger an alert whenever obfuscated traffic (e.g. traffic tunneled to evade detection) is detected",
    ["ndpi_probing_attempt"] = "Probing Attempt",
    ["ndpi_probing_attempt_descr"] = "Trigger an alert whenever a probing/scanning attempt is detected",
    ["ndpi_tcp_issues"] = "TCP Issues",
    ["ndpi_tcp_issues_descr"] = "Trigger an alert whenever TCP-level issues (e.g. retransmissions, out-of-order, zero window) are detected",
    ["ndpi_tls_alpn_sni_mismatch"] = "TLS ALPN/SNI Mismatch",
    ["ndpi_tls_alpn_sni_mismatch_descr"] = "Trigger an alert whenever the TLS ALPN does not match the SNI",
  ...
  ["flows_page"] = {
    ...
    ["interface_role"] = "Interface Role",
    ["interface_role_customer_interface"] = "Customer",
    ["interface_role_internal_interface"] = "Internal LAN",
  ...
  ["graphs"] = {
    ...
    ["hr_traffic_rxtx"] = "High-Resolution Traffic (RX + TX)",
    ...
    ["threads_cpu_load"] = "ntopng Threads CPU Load (%%)",
    ...
    ["trend"] = "Trend",
    ["ts_queue_drops"] = "Timeseries Queue Drops",
    ["ts_queue_length"] = "Timeseries Queue Length",
    ...
    ["metric_descr"] = {
      ...
      ["asn_traffic_ip"] = "IPv4 vs IPv6 ASN Traffic",
      ...
      ["local_host_traffic"] = "Bytes exchanged with local/remote hosts",
    ...
    ["metric_labels"] = {
      ...
      ["keys"] = "Keys",
      ["load"] = "Load",
      ["local_traffic"] = "Local Traffic Bytes",
      ["lost_packets"] = "Lost Pkts",
      ["max"] = "Max",
      ["memory"] = "Memory",
      ["ms"] = "Milliseconds",
      ["non_local_traffic"] = "Non-Local Traffic Bytes",
      ...
      ["num_servers"] = "Num. Servers",
      ["num_ts"] = "Queued Timeseries",
      ["num_ts_drops"] = "Drops (No Space in Queue)",
      ["ok_pkts"] = "Ok Pkts.",
  ...
  ["host_config"] = {
    ["active_monitor_enable"] = "Active Monitoring is currently disabled, please enable it to access this feature. It can be enabled from the <a href=\"/lua/admin/prefs.lua?tab=active_monitoring\">Preferences</a> (Restart required)",
    ...
    ["host_tags_description"] = "Tags assigned by the user for filtering and classification, in addition to those automatically assigned by ntopng.",
  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["add_to_scan_list"] = "Add Host to Active Scan List",
      ["ascan_result"] = "Scan Report for %{host} at %{date}",
      ["ascan_result_ipv4_netscan"] = "IPv4 Netscan Report",
      ["ascan_result_no_longer_down"] = "Hosts No Longer Down Report",
      ["ascan_result_total_reports"] = "Active Scan Report",
      ["automatic_scan"] = "Scan Frequency",
      ["cidr_placeholder"] = "24",
      ["daily"] = "Nightly",
      ["delete_failed_entries"] = "Delete Failed",
      ["delete_failed_entries_title"] = "Delete Failed Hosts to Scan",
      ["delete_failed_vs_hosts"] = "Are you sure you want to delete all Hosts to Scan whose last scan failed (host down or unreachable)? This action cannot be undone.",
      ...
      ["enable_clickhouse"] = "Please use ClickHouse to enable the archive page for Active Scan Reports.",
      ["enable_clickhouse_toast_label"] = "Use ClickHouse to store Active Scan Reports and enable the <a target='_blank' href='%{link}'>archive page</a>.",
      ["error"] = "Error",
      ["every_night"] = "Nightly",
      ["every_week"] = "Weekly",
      ["failed"] = "Failed",
      ...
      ["periodicity"] = "Periodicity",
      ["periodicity_scan_1_day_started"] = "Daily Active Scan started.",
      ["periodicity_scan_1_week_started"] = "Weekly Active Scan started.",
      ["ports"] = "Ports",
      ...
      ["notes"] = {
        ["generic_notes_1"] = "If a <a href=\"${http_prefix}/lua/admin/endpoint_notifications_list.lua\">notification endpoint</a> and the related recipient with the ‘Notification Type’ set to ‘Active Scan Reports’ are enabled, a notification is sent when the periodic scan begins and ends.",
        ...
        ["note_3"] = "Scan Type: select a scan type.",
  ...
  ["infrastructure_dashboard"] = {
    ...
    ["local_interfaces"] = "Local Instance Interfaces",
    ["name"] = "Name",
    ["news_from_blog"] = "News from the ntop Blog",
  ...
  ["internals"] = {
    ...
    ["availability"] = "Availability",
    ["bgp_prefix_update"] = "BGP Prefix Update",
    ["bgp_prefix_update_descr"] = "Handles BGP prefix update notifications received from the BGP updates queue",
    ["bgp_prefix_update_title"] = "BGP Prefix Update",
    ...
    ["periodic_activities_ts_drops_descr"] = "TS Drops counts the number items discarded due to the internal export queue full (append stage).",
    ["periodic_activities_ts_writes_descr"] = "TS Writes counts the number of items successfully delivered to the timeseries engine (export stage).",
    ...
    ["sleeping"] = "Sleeping",
    ["snmp_fat_mibs"] = "SNMP Polls (Full MIBs)",
    ["snmp_other_mibs"] = "SNMP Polls (Couters Only)",
  ...
  ["license_page"] = {
    ...
    ["activation_title"] = "Offline Activation",
    ["agreement"] = "License Agreement",
    ["license"] = "License",
    ["needs_activation_warning"] = "This license has not been activated yet. Please complete the activation from the Activation tab.",
  ...
  ["llm"] = {
    ...
    ["ask_assistant"] = "Explain",
    ["avg_ms"] = "Avg Response",
    ["back_to_chat"] = "Back To Chat",
    ["bad_response"] = "Bad response",
    ["baselining_coming_soon_sub"] = "Host behavior will be charted against its learned baseline directly here.",
    ["baselining_coming_soon_title"] = "Baselining — coming soon",
    ["call_type_breakdown"] = "Call Type Breakdown",
    ["calls"] = "Calls",
    ["cancelled_message"] = "Request stopped.",
    ["chat_id_short"] = "Chat ID",
    ["chatbot"] = "Chatbot",
    ["chatid_copied_to_clipboard"] = "Chat URL copied to clipboard",
    ...
    ["daily"] = "Daily",
    ["debug_dump_body"] = "Download a JSON dump of this conversation for troubleshooting purposes.",
    ["debug_dump_download"] = "Download JSON",
    ["debug_dump_email"] = "Please send this dump to {email} so our support team can investigate the issue.",
    ["debug_dump_title"] = "Chat Debug Dump Exported",
    ["delete_model_price"] = "Delete Model Price",
    ["describe_policy"] = "Describe your policy",
    ["direct_user"] = "Direct User Action",
    ["edit_model_price"] = "Edit Model Price",
    ["edit_policy"] = "Edit Policy",
    ["editing_hint"] = "Everything after this message will be replaced",
    ["editing_status"] = "Editing",
    ["error_connection_failed"] = "Couldn't reach the LLM server. Please check that the provider is configured correctly and reachable.",
    ["error_invalid_response"] = "The LLM provider returned an unexpected response. Please check the provider configuration.",
    ["error_label"] = "Error",
    ["evidence_click_hint"] = "Click to view tool calls and results",
    ...
    ["no_evidence_sub"] = "This reply didn't require any tool calls.",
    ["no_evidence_title"] = "No evidence for this message",
    ["no_provider_configured"] = "No LLM provider configured, LLM required to create policies",
    ...
    ["page_ai_audit"] = "AI Audit Log",
    ["policy_explanation"] = "Tell the AI what traffic to monitor and what constitutes a violation. Be specific about hosts, ports, protocols, time windows, or traffic volumes.",
    ...
    ["provider"] = "Provider",
    ["query_not_persisted_hint"] = "Live data — not stored. Run to fetch current results.",
    ["regenerate"] = "Regenerate",
    ["register_model"] = "Add Model Cost",
    ["register_model_price"] = "Add Model Price",
    ["rename_chat"] = "Rename Chat",
    ["requires_enterprise"] = "This tool requires an Enterprise license or higher",
    ["requires_enterprise_l"] = "This tool requires an Enterprise L license or higher",
    ["requires_enterprise_m"] = "This tool requires an Enterprise M license or higher",
    ["requires_enterprise_xl"] = "This tool requires an Enterprise XL license or higher",
    ["requires_nanalyst"] = "This tool requires the nAnalyst add-on",
    ["requires_pro"] = "This tool requires a Pro license or higher",
    ["result"] = "Result",
    ["result_explanation"] = "Non Empty Result is a violation",
    ["result_truncated_hint"] = "Result truncated for storage — rerun for the full output where applicable.",
    ["retry"] = "Retry",
    ["review_query"] = "Review the generated SQL query and check frequency",
    ["rows"] = "rows",
    ["run_count"] = "Times Run",
    ["run_every"] = "Run Every",
    ["run_query"] = "Run query",
    ...
    ["timeout_warning"] = "This is taking longer than expected — the model may still be working on it.",
    ["token_breakdown"] = "Token Breakdown",
    ["token_share"] = "Token Share",
    ["tool_add_active_monitoring_script"] = "Add Active Monitoring Script",
    ...
    ["tool_get_asn_config"] = "Get ASN Config",
    ["tool_get_asset_info"] = "Get Asset Info",
    ["tool_get_country_stats"] = "Get Country Stats",
    ["tool_get_domain_category"] = "Get Domain Category",
    ["tool_get_exporter_sites_map"] = "Get Exporter Sites Map",
    ...
    ["tool_get_mac_info"] = "Get MAC Address Info",
    ["tool_get_modbus_stats"] = "Get Modbus Stats",
    ["tool_get_nedge_firewall_policy"] = "Get nEdge Firewall Policy",
    ["tool_get_network_policy"] = "Get Network Policy",
    ["tool_get_network_services_config"] = "Get Network Services Config",
    ["tool_get_observation_point_exporters"] = "Get Observation Point Exporters",
    ["tool_get_profinet_stats"] = "Get PROFINET Stats",
    ["tool_get_resolved_IP_address"] = "Resolve IP Address",
    ["tool_get_s7comm_stats"] = "Get S7comm Stats",
    ["tool_get_site_sankey"] = "Get Site Sankey",
    ["tool_get_site_traffic"] = "Get Site Traffic",
    ["tool_get_snmp_device_config"] = "Get SNMP Device Config",
    ["tool_get_snmp_device_info"] = "Get SNMP Device Info",
    ["tool_get_snmp_interface_details"] = "Get SNMP INterface Details",
    ["tool_get_snmp_interface_roles"] = "Get SNMP Interface Roles",
    ...
    ["tool_list_enabled_active_monitoring_scripts"] = "List Enabled Active Monitoring Scripts",
    ["tool_list_expected_servers"] = "List Expected Servers",
    ["tool_list_flow_exporters"] = "List Flow Exporters",
    ["tool_list_networks"] = "List Networks",
    ["tool_list_protos"] = "List Protocols",
    ["tool_list_sites"] = "List Sites",
    ...
    ["tools_catalog_subtitle"] = "All agent tools available on this instance, with their license requirement and MCP annotations.",
    ...
    ["analyst_pipeline"] = {
      ...
      ["generate"] = "Generate",
      ["generate_playbook"] = "Generate Playbook from Natural Language",
      ["generating"] = "Generating...",
      ["new_playbook"] = "New Playbook",
      ["pipeline_generated"] = "Playbook Generated",
      ["playbooks_tab"] = "Playbooks",
      ["provider"] = "Provider",
      ["results"] = "Results",
      ["review_before_save"] = "Review the stages and params before saving",
      ["run_playbook"] = "Run Playbook",
      ["run_to_see_results"] = "Run the playbook to see results here",
      ["running"] = "Running...",
      ["select_or_create"] = "Select a playbook from the dropdown or create a new one",
  ...
  ["manage_configurations"] = {
    ["active_monitoring"] = "Active Monitoring",
    ["active_monitoring_vs"] = "Active Monitoring and Active Scan",
    ...
    ["export_policy"] = "Export IPS Policy",
  ...
  ["manage_data"] = {
    ...
    ["purge_all_button"] = "Purge Selected Data",
    ["purge_all_clickhouse_data_pending"] = "The ClickHouse database is scheduled to be purged upon the next restart.",
    ["purge_all_datadir_data_pending"] = "The data directory is scheduled to be purged upon the next restart.",
    ...
    ["purge_clickhouse"] = "ClickHouse Database",
    ["purge_clickhouse_descr"] = "Delete all the historical flows, alerts and reports stored in the ClickHouse database.",
    ["purge_datadir"] = "Data Directory",
    ["purge_datadir_descr"] = "Delete all the data stored on disk for every interface, including RRD timeseries.",
    ["purge_tab"] = "Purge All Data",
    ["remote_hosts"] = "Remote",
  ...
  ["network_configuration"] = {
    ["alert_note"] = "The Unexpected DNS/NTP/DHCP/SMTP/Gateway Server Checks are disabled. Please enable at least one of them using the toggles below.",
    ...
    ["dhcp_servers_description"] = "A comma-separated list of DHCP Servers (IP or IP@VLAN)",
    ["dhcp_servers_title"] = "DHCP Servers",
    ["dns_servers_description"] = "A comma-separated list of DNS Servers (IP or IP@VLAN)",
    ["dns_servers_title"] = "DNS Servers",
    ["empty_policy"] = "Empty file, no Network Policies found",
    ["export_policies"] = "Export Policies",
    ["gateway_servers_description"] = "A comma-separated list of Gateways (IP or IP@VLAN)",
    ...
    ["ntp_servers_description"] = "A comma-separated list of NTP Servers (IP or IP@VLAN)",
    ["ntp_servers_title"] = "NTP Servers",
    ["policy_note"] = "The check 'Host Policy' is disabled. Please enable it using the toggles below.",
    ["smtp_servers_description"] = "A comma-separated list of SMTP Servers (IP or IP@VLAN)",
  ...
  ["notification_endpoint"] = {
    ...
    ["email"] = {
      ...
      ["use_startssl"] = "Use STARTSSL",
      ["use_tls_descr"] = "Add an 's' at the end of smpt (smtps) in order to force the mail delivery with TLS encryption (e.g. smtps://mail.server.org)",
      ["use_startssl_descr"] = "If enabled, when sending a mail use STARTSSL. In case the mail server uses SMTPS, this preference is ignored (e.g. smtps://mail.server.org)",
      ["validation"] = {
  ...
  ["prefs"] = {
    ...
    ["bgp_prefix_changes_endpoint_description"] = "ZMQ bgp_server TCP endpoint to receive monitore BGP prefix updates (e.g. tcp://127.0.0.1:11060) that will generate informative alerts under the ntopng system interface.",
    ["bgp_prefix_changes_endpoint_title"] = "IP Prefix Changes Endpoint",
    ...
    ["bgp_server_connection_failed"] = "Unable to connect to the BGP server. Please check the address and port",
    ["bgp_server_connection_ok"] = "BGP server connection successful",
    ["bgp_server_port_description"] = "Redis listening port of the bgp_server (e.g. 63799).",
    ...
    ["clickhouse_ts_batch_size_title"] = "ClickHouse Timeseries Batch Size",
    ...
    ["clickhouse_ts_queue_size_title"] = "ClickHouse Timeseries Queue Size",
    ...
    ["demo_tour_loading"] = "Loading tours...",
    ["demo_tour_none"] = "No guided tours are registered.",
    ...
    ["demo_tour_status_done"] = "Completed / dismissed",
    ["demo_tour_status_pending"] = "Not completed yet",
    ["demo_tours"] = "Demo Tours",
    ["demo_tours_description"] = "Replay or reset any guided tour. Resetting clears its progress so it shows again from the start next time you visit its pages.",
    ["demo_tours_title"] = "Guided Tours",
    ...
    ["exporter_ip_address"] = "Exporter IP",
    ["exporter_ip_and_ingress_iface_idx"] = "Exporter IP + Ingress Interface",
    ...
    ["llm_anthropic_model_description"] = "Anthropic model name to use (e.g. claude-opus-4-5)",
    ["llm_anthropic_token_description"] = "API key for the Anthropic API",
    ["llm_anthropic_url_description"] = "Full chat completions endpoint URL (e.g. https://api.anthropic.com/v1/messages)",
    ["llm_custom"] = "Custom Providers",
    ["llm_custom_add"] = "Add Provider",
    ["llm_custom_missing_fields"] = "Name, URL and model are required.",
    ["llm_custom_name"] = "Name",
    ["llm_custom_none"] = "No custom providers configured yet.",
    ["llm_custom_providers_description"] = "Add any OpenAI/Anthropic-compatible endpoint not covered by the built-in providers above.",
    ["llm_custom_providers_title"] = "Custom LLM Providers",
    ["llm_custom_token_unchanged"] = "Leave blank to keep the current token",
    ["llm_default_provider_auto"] = "Auto (first configured provider)",
    ["llm_default_provider_description"] = "Provider used automatically when starting a new nAnalyst chat.",
    ["llm_default_provider_title"] = "Default Provider",
    ["llm_general"] = "General",
    ["llm_loading_providers"] = "Loading providers...",
    ["llm_local"] = "Local LLM",
    ...
    ["llm_local_url_description"] = "Full chat completions endpoint URL (e.g. http://localhost:11434/v1/chat/completions)",
    ...
    ["llm_openai_url_description"] = "Full chat completions endpoint URL (e.g. https://api.openai.com/v1/chat/completions)",
    ["llm_providers"] = "LLM Providers",
    ["llm_qwen"] = "Qwen (Alibaba)",
    ["llm_qwen_model_description"] = "Qwen model name to use (e.g. qwen-plus)",
    ["llm_qwen_token_description"] = "API key for Alibaba Cloud",
    ["llm_qwen_url_description"] = "Full chat completions endpoint URL (e.g. https://dashscope-intl.aliyuncs.com/compatible-mode/v1/chat/completions)",
    ["llm_timeout_description"] = "How long to wait for a response before giving up. Small/local models on limited hardware may need 2-3 minutes or more.",
    ...
    ["no_top_timeseries_available"] = "The Top Timeseries for this resource are not available. Please enable the Layer 7 Applications timeseries from the Local Hosts Timeseries preferences <a href='/lua/admin/prefs.lua?tab=on_disk_ts'><i class='fas fa-cog fa-sm'></i></a>",
    ...
    ["snmp_interface_format_description"] = "The SNMP interface label format can be displayed as alias (ifAlias) or the interface name (ifName).",
    ["snmp_interface_format_title"] = "SNMP Interface Label Format",
    ...
    ["toggle_active_monitoring_log_description"] = "Toggle the creation of logs related to Active Monitoring activities. Logs include polling results (like Download Speed) and timeseries values.",
    ["toggle_active_monitoring_log_title"] = "Enable Active Monitoring Log",
    ...
    ["toggle_asn_mode_title"] = "Enable AS Mode",
    ...
    ["toggle_dump_duplicated_flows_to_clickhouse_description"] = "Dump duplicated flows into ClickHouse. By default duplicated flows are discarded and only accounted as duplicated (to avoid breaking counters).",
    ["toggle_dump_duplicated_flows_to_clickhouse_title"] = "Dump Duplicated Flows",
    ...
    ["toggle_local_hosts_ts_creation_description"] = "Enable full host timeseries creation (full with Layer 7), limit it to bytes and score (light), or turn it off.",
    ...
    ["toggle_ndpi_timeseries_creation_title"] = "Layer 7 Applications (nDPI)",
    ...
    ["toggle_wazuh_automerge_description"] = "Automatically merge Wazuh asset information during nighttime hours.",
    ["toggle_wazuh_automerge_title"] = "Auto-merge Wazuh Assets",
    ["toggle_wazuh_enabled_description"] = "Enable the Wazuh integration to configure connection settings and correlate Wazuh alerts with ntopng.",
    ["toggle_wazuh_enabled_title"] = "Enable Wazuh",
    ...
    ["vs_concurrently_scan_number_title"] = "Maximum Concurrent Active Scans",
    ["vs_reports_data_retention_descr"] = "Number of days to keep the scans report. Default: 30 days.",
    ["vs_reports_data_retention_title"] = "Active Scan Report Data Retention",
    ["vs_slow_mode_description"] = "To enable slow mode for the execution of scans.",
    ["vs_slow_mode_title"] = "Slow Mode",
    ["wazuh"] = "Wazuh",
    ["wazuh_alerts_data_retention_descr"] = "Number of days to keep Wazuh alerts. Default: 365 days.",
    ["wazuh_alerts_data_retention_title"] = "Wazuh Alerts Data Retention",
    ["wazuh_auth_failed"] = "Wazuh authentication failed. Please check username and password",
    ["wazuh_connection_failed"] = "Wazuh server returned an empty token. Please verify the server configuration",
    ["wazuh_connection_ok"] = "Wazuh connection successful",
    ["wazuh_missing_url"] = "Wazuh URL is missing",
    ["wazuh_password_description"] = "Wazuh API password",
    ["wazuh_password_title"] = "Wazuh Password",
    ["wazuh_unreachable"] = "Unable to reach the Wazuh server. Please check the URL and network connectivity or start ntopng with --insecure if ty use unsafe TLS certificates on Wazuh.",
    ...
    ["vue_prefs"] = {
      ...
      ["discard"] = "Discard",
      ["expert_badge"] = "Expert",
      ["fix_validation"] = "Fix validation errors before saving",
      ["hide_advanced_sections"] = "Hide expert settings",
      ["hint_max"] = "Maximum %{max}",
      ["hint_maxlength"] = "Max %{max} characters",
      ["hint_min"] = "Minimum %{min}",
      ["hint_min_max"] = "Allowed range: %{min} - %{max}",
      ...
      ["select_section"] = "Select a section on the left.",
      ["settings_nav_label"] = "Settings sections",
      ["show_advanced_sections"] = "Show expert settings",
      ["test_btn"] = "Test",
      ["test_btn_loading"] = "…",
      ["time_days"] = "Days",
      ["time_hours"] = "Hours",
      ["time_mins"] = "Mins",
      ["time_secs"] = "Secs",
      ["unsaved_banner"] = "You have unsaved changes in this section",
      ["unsaved_dot_title"] = "Unsaved changes",
      ["validation_invalid_format"] = "Invalid format",
      ["validation_invalid_ip"] = "Invalid IP address",
      ["validation_invalid_ipv4"] = "Invalid IPv4 address",
      ["validation_invalid_mac"] = "Invalid MAC address",
      ["validation_invalid_network"] = "Invalid network (CIDR)",
      ["validation_max"] = "Maximum %{max}",
      ["validation_maxlength"] = "Max %{max} characters",
      ["validation_min"] = "Minimum %{min}",
      ["validation_must_be_number"] = "Must be a number",
      ["validation_must_be_positive"] = "Must be a positive number",
  ...
  ["sites_dashboard"] = {
    ...
    ["description"] = "Description",
    ["device_information_snmp"] = "Device Information (SNMP)",
    ["disabled"] = "Disabled",
    ...
    ["historical_flows"] = "Historical Flows",
    ["historical_flows_disabled_live"] = "Select a historical time range (not Live) to view historical flows",
    ["host"] = "Host",
    ["hosts"] = "Hosts",
    ["if_index_short"] = "ifIndex",
    ["in_bytes"] = "Bytes Received",
    ["interface"] = "Interface",
    ["interface_information"] = "Interface Information",
    ["interface_information_snmp"] = "Interface Information (SNMP)",
    ["interface_name"] = "Interface Name",
    ...
    ["map"] = "Map",
    ["matrix"] = "Matrix",
    ["matrix_destination"] = "Destination Site",
    ["matrix_source"] = "Source Site",
    ["metric"] = "Metric",
    ["network"] = "Network",
    ["networks"] = "Networks",
    ["no_networks"] = "No networks",
    ["no_timeseries_data"] = "No timeseries data available yet",
    ["not_polling"] = "Not Polling",
    ...
    ["snmp_interfaces"] = "SNMP Interfaces",
    ...
    ["top_hosts"] = "Top Hosts",
    ["top_l4_proto"] = "Top L4 Protocols",
    ["top_l7_proto"] = "Top Applications (by Traffic)",
    ["top_local_talkers"] = "Top Local Hosts (by Traffic)",
    ["top_remote_destinations"] = "Top Remote Hosts (by Traffic)",
    ["traffic"] = "Traffic",
    ["traffic_analysis"] = "Traffic Analysis",
    ["traffic_time_series"] = "Traffic Time Series",
    ["traffic_volume"] = "Traffic Volume",
  ...
  ["sites_page"] = {
    ...
    ["since_startup"] = "Since Startup",
    ["since_startup_hint"] = "Cumulative Data Shown Since Startup",
    ["delete_all_sites_confirm"] = "Are you sure to delete all the configured Sites? Networks currently associated to them will fall back to the Default Site. This action cannot be undone",
    ["delete_all_sites_title"] = "Delete All Sites",
    ["delete_site"] = "Are you sure to delete the selected Site? This action cannot be undone",
    ["delete_site_title"] = "Delete Site",
    ["edit_site"] = "Edit Site",
    ["export_sites"] = "Export Sites to CSV",
    ["exporters_map"] = "Exporters Map",
    ...
    ["networks_format"] = "List the networks that are part of this site (comma or newline separated, e.g. 192.168.2.0/24, 192.168.160.0/24)",
    ["no_parent_site"] = "No Parent",
    ["parent_site"] = "Parent Site",
    ["parent_site_description"] = "Select an already existing Site; this will create a hierarchy of Site, adding the possibility to create Regions of Sites.",
  ...
  ["snmp"] = {
    ...
    ["auto_assign_role_confirm"] = "This operation will automatically assign a role to all interfaces matching the specified filter. Do you want to proceed?",
    ["auto_assign_role_success"] = "Interfaces successfully updated:",
    ...
    ["interface_auto_assign_role_description"] = "Role to assign to all matching interfaces",
    ...
    ["interface_name_alias_filter_description"] = "Interfaces whose name or alias includethis string will be automatically assigned the selected role.",
    ["interface_name_alias_filter_placeholder"] = "e.g. transit, peering...",
    ["interface_role"] = "Role",
    ...
    ["none"] = "None",
    ["note"] = "NOTE",
    ["num_devices_active"] = "Devices Up",
    ["num_devices_down"] = "Devices Down",
    ["num_polled_devices"] = "SNMP Polled Devices",
    ["object_id"] = "ObjectID",
    ...
    ["polled_late"] = "Devices With Late Poll (Overrun)",
    ["polled_ok"] = "Devices Polled On Time",
    ...
    ["snmp_interfaces_auto_role"] = "Batch SNMP Interface Role Set",
    ...
    ["snmp_no_qos_polled_devices"] = "SNMP Flow Exporters Polled (Counters Only)",
    ...
    ["snmp_qos_polled_devices"] = "SNMP Devices Polled (All MIBs)",
  ...
  ["traffic_recording"] = {
    ...
    ["max_file_size"] = "Max PCAP File Size",
    ["max_file_size_auto"] = "Auto",
    ["max_file_size_note"] = "Maximum size of each recorded PCAP file. Leave empty to automatically compute a value based on the interface link speed (%{auto_value} MB for this interface).",
  ...
  ["wazuh_alert_config"] = {
    ["add_exception"] = "Add Wazuh Alert Exception",
    ["add_rule"] = "Add Wazuh Alert Rule",
    ["agent_id"] = "Agent ID",
    ["agent_ip"] = "Agent IP",
    ["agent_name"] = "Agent Name",
    ["ai_preset_distribution"] = "Show alert type and severity distribution for this host",
    ["ai_preset_explain"] = "Explain this alert and why it may matter",
    ["ai_preset_related_1h"] = "How many alerts were generated for this host in the last 1h?",
    ["ai_preset_related_6h"] = "How many alerts were generated for this host in the last 6h?",
    ["alert_action"] = "Action",
    ["alert_details_tab"] = "Alert Details",
    ["alert_exceptions"] = "Rules Exceptions",
    ["alert_id"] = "Alert ID",
    ["alert_info"] = "Alert Info",
    ["alert_info_title"] = "Wazuh Alert Details",
    ...
    ["delete_exception"] = "Delete Wazuh Alert Exception",
    ["delete_rule"] = "Delete Wazuh Alert Rule",
    ["domain"] = "Domain",
    ["dst_hostname"] = "Destination Hostname",
    ["dst_ip"] = "Destination IP",
    ["dst_port"] = "Destination Port",
    ["edit_exception"] = "Edit Wazuh Alert Exception",
    ["edit_rule"] = "Edit Wazuh Alert Rule",
    ...
    ["geo_country_src"] = "Geo Country",
    ["glob_placeholder"] = "Glob pattern (empty = any)",
    ["groups"] = "Groups",
    ["groups_docs_link"] = "What are Wazuh rule groups?",
    ["groups_hint"] = "Comma-separated Wazuh rule groups (empty = any).",
    ["groups_placeholder"] = "e.g. syslog,sshd,authentication_success",
    ["id"] = "ID",
    ["id_already_exists"] = "A rule with this ID already exists",
    ["id_hint"] = "Unique rule identifier (no spaces). Changing it renames the rule.",
    ["id_placeholder"] = "e.g. ssh-brute-force",
    ["id_required"] = "A unique rule ID (without spaces) is required",
    ["immediate"] = "Immediate",
    ...
    ["url_path"] = "URL Path",
    ["username"] = "Username",
    ["username_dst"] = "Destination Username",
    ["vuln_cve"] = "CVE",
    ["vuln_package"] = "Vulnerable Package",
