local lang = {
  ...
  ["flow_exporter_device"] = "NetFlow/IPFIX Exporter",
  ...
  ["scan_host_updated"] = "The host %{host} has been correctly updated!",
  ...
  ["flow_devices"] = {
    ...
    ["flow_exporters"] = "NetFlow/IPFIX Exporters",
  ...
  ["hosts_stats"] = {
    ...
    ["page_scan_hosts"] = {
      ...
      ["email"] = {
        ...
        ["no_udp"] = "no UDP open ports",
        ["num_cves"] = "%{num} CVEs",
        ["num_failed_scanned_hosts"] = "Hosts down or unreachable: %{num}",
        ["num_scanned_hosts"] = "Correctly Scanned Hosts: %{num}",
        ["num_tcp"] = "%{num} TCP open ports",
        ["num_udp"] = "%{num} UDP open ports",
        ["periodicity_scan_1_day_ended"] = "<br>Daily Vulnerability Scan successfully completed.</br><br>Start time: %{start_date}.</br><br>End time: %{end_date}.</br><br>Scan duration: %{duration}.</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}</br><br>Found %{cves}; %{udp_ports}; %{tcp_ports}.</br><br>See full report here <a href='%{url}'>Vulnerability Scan Report</a>.</br>",
        ["periodicity_scan_1_week_ended"] = "<br>Weekly Vulnerability Scan successfully completed.</br><br>Start time: %{start_date}.</br><br>End time: %{end_date}.</br><br> Scan duration: %{duration}.</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}</br><br>Found %{cves}; %{udp_ports}; %{tcp_ports}.</br><br>See full report here <a href='%{url}'>Vulnerability Scan Report</a>.</br>",
        ["scan_all_ended"] = "<br>Vulnerability Scan of all entries successfully completed.</br><br>Start time: %{start_date}.</br><br>End time: %{end_date}.</br><br>Scan duration: %{duration}.</br><br>%{scanned_hosts}</br><br>%{not_scanned_hosts}</br><br>Found %{cves}; %{udp_ports}; %{tcp_ports}.</br><br>See full report here <a href='%{url}'>Vulnerability Scan Report</a>.</br>",
  ...
  ["prefs"] = {
    ...
    ["ntopng_host_address_title"] = "ntopng Host Address",
    ["observation_points"] = "Observation Points",
  ...
  ["vulnerability_scan"] = {
    ...
    ["host_down_case"] = "The Host %{host} is not reachable",
