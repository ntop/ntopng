local lang = {
  ...
  ["ipv4"] = "IPv4",
  ["ipv6"] = "IPv6",
  ["is_attacker_to_victim"] = "Attacker -> Victim",
  ["is_victim_to_attacker"] = "Victim -> Attacker",
  ...
  ["alert_messages"] = {
    ...
    ["score_number_anomaly"] = "Detected score anomaly for host %{host} as %{role} [Score: %{score}][Lower Bound: %{lower_bound}][Upper Bound: %{upper_bound}]",
