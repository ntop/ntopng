local lang = {
  ...
  ["nedge"] = {
    ...
    ["default_shaper"] = "Pass",
    ["default_shaper_descr"] = "The Default shaper percentage of the interface speed.",
    ...
    ["global_shapers_rates"] = "Global Shapers Rates",
    ...
    ["maximum_enforced_descr"] = "If set to maximum enforced, shapers will enforce maximum bandwidth allocation regardless of the available bandwidth.",
    ["min_perc"] = "Min %{perc}%%",
    ["minimum_guaranteed"] = "Minimum Guaranteed",
    ["minimum_guaranteed_descr"] = "If set to minimum guaranteed, shapers will only guarantee minimum bandwidth allocation.",
    ["mode"] = "Mode",
    ["nedge"] = "nEdge",
    ...
    ["per_ip_rates"] = "Per Host Shapers Rates",
    ...
    ["slow_pass_shaper_descr"] = "The Slow Pass shaper percentage of the interface speed.",
    ["slower_pass_shaper_descr"] = "The Slower Pass shaper percentage of the interface speed.",
