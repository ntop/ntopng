local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["too_low_dns_replies_received"] = "%{entity} has sent %{requests} DNS requests but received %{replies} DNS replies [%{granularity} ratio: %{ratio}%%]",
    ["too_low_dns_replies_sent"] = "%{entity} has received %{requests} DNS requests but sent %{replies} DNS replies [%{granularity} ratio: %{ratio}%%]",
