local lang = {
  ...
  ["prefs"] = {
    ...
    ["radius_server_description"] = "IP address and port of the RADIUS server (e.g. %{example}).",
  ...
  ["remote_assistance"] = {
    ...
    ["note_sensitive"] = "The information above is sensitive. Only provide it to the %{product} support team.",
