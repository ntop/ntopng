local lang = {
  ...
  ["lua_c_api"] = "Lua/C API",
  ["l7_proto"] = "L7 Proto",
  ["highest_avg_flow_count_per_l7"] = "Highest Average Flow Count (Applications)",
  ["highest_avg_flow_size_per_l7"] = "Highest Average Flow Size (Applications)",
  ["highest_avg_src_score"] = "Highest Average Flow Score (Clients)",
  ["highest_avg_dst_score"] = "Highest Average Flow Score (Servers)",
  ["highest_avg_l7_score"] = "Highest Average Flow Score (Applications)",
  ["highest_avg_protocol_score"] = "Highest Average Flow Score (Protocols)",
  ...
  ["top_dst_score"] = "Highest Total Score (Servers)",
  ["top_src_score"] = "Highest Total Score (Clients)",
  ["total"] = "Total",
