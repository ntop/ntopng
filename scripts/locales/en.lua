local lang = {
  ...
  ["scan_in_progress"] = "Vulnerability total scans to complete, it may take a while...",
  ["score"] = "Score",
  ...
  ["alerts_dashboard"] = {
    ...
    ["debug"] = "Debug",
    ["device_connection_disconnection"] = "Unexpected MAC (Disc)Connnection",
  ...
  ["report"] = {
    ...
    ["new_report_available_description"] = "There is a new %{periodicity} report %{name} available in ntopng under the Reports section. Please note that a retention time of %{retention_days} days is configured in the ntopng Preferences, it is recommended to downlaod and backup the report.",
