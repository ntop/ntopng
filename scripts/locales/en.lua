local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["flow_number_anomaly"] = "Detected %{role} flow number anomaly for host %{host} [Flows: %{value}][Lower Bound: %{lower_bound}][Upper Bound: %{upper_bound}]",
  ...
  ["hosts_map_page"] = {
    ...
    ["labels"] = {
      ...
      ["blacklisted_as_client"] = "Num Client Flows with Blacklisted Host",
      ["blacklisted_as_sevrer"] = "Num Server Flows with Blacklisted Host",
