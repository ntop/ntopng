local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["unexpected_host_behavior_description"] = "Unexpected behaviour from %{host}. [%{type_of_behaviour}: %{value}][Expected Value: %{prediction}][Lower Bound: %{lower_bound}][Upper Bound: %{upper_bound}]",
