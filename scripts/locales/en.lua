local lang = {
  ...
  ["entity_thresholds"] = {
    ["flow_attacker_description"] = "Max number of sent Flows/Second above which a host is considered a flooder",
    ["flow_attacker_title"] = "Flow Flood Attacker",
    ["flow_victim_description"] = "Max number of received Flows/Second above which a host is considered under flood attack",
    ["flow_victim_title"] = "Flow Flood Victim",
    ["syn_attacker_description"] = "Max number of sent SYNs/Second above which a host is considered a SYN flooder",
    ["syn_attacker_title"] = "SYN Flood Attacker",
    ["syn_victim_description"] = "Max number of received SYNs/Second above which a host is considered under SYN flood attack",
