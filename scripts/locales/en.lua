local lang = {
  ...
  ["summary"] = "Summary",
  ["system"] = "System",
  ["system_alerts_status"] = "Alerts Status",
  ...
  ["active_monitoring_stats"] = {
    ...
    ["am_note_icmp"] = "Measurements icmp and icmp6 ping the host using ICMP and ICMPv6",
  ...
  ["prefs"] = {
    ...
    ["discord_notification_severity_preference_description"] = "Errors (errors only), Errors and Warnings (errors and warnings, no info), All (every kind of alerts will be notified).",
    ...
    ["discord_username_description"] = "The username to be used in case of HTTP authentication (optional).",
    ["dns"] = "DNS",
    ["dns_service"] = "Service",
    ...
    ["toggle_discord_notification_description"] = "Toggle alerts notifications via discord.",
    ["toggle_discord_notification_title"] = "Toggle Discord Notification",
