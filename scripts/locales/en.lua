local lang = {
  ...
  ["prefs"] = {
    ...
    ["toggle_host_pools_log_description"] = "Toggle the creation of logs related to host pools in the data dump directory. Logs include associations and disassociations of hosts to their host pools.",
