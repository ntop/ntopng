local lang = {
  ...
  ["llm"] = {
    ...
    ["timeout_error_message"] = "This is taking longer than expected — the model may still be working on it. You can keep waiting, retry, or try a smaller/faster model.",
