local lang = {
  ...
  ["delete_inactive_host"] = "Are you sure to delete the selected host from Inactive Hosts? This action is irreversible.",
  ["delete_all_inactive_hosts"] = "Are you sure to delete all Inactive Hosts? This action is irreversible.",
