local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["periodic_activity_not_executed"] = "Periodic activity \"%{script}\" was queued by not executed [Pending since %{pending_since}]",
  ...
  ["internals"] = {
    ...
    ["sleeping"] = "Sleeping",
    ["slow_rrd_writes"] = "RRD writes too slow, some writes have been skipped",
    ["state_active"] = "Entries in Active State",
    ["state_idle"] = "Entries in Idle State",
    ["state_idle_vs_active"] = "Idle vs Active Entries",
    ["status_description"] = "A Periodic Activity can be in one of the following status:",
