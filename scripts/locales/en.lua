local lang = {
  ...
  ["if_stats_config"] = {
    ...
    ["gw_macs"] = "Gateway MAC (Address-Based Traffic Directions)",
    ["gw_macs_description"] = "Compute traffic direction based on the MAC address of the Gateway(s) (comma-separated list). When processing traffic from a traffic mirror it is otherwise not possible to know the traffic direction (ingress or egress).",
