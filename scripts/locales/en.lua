local lang = {
  ...
  ["snmp"] = {
    ...
    ["snmp_no_qos_polled_devices"] = "Polled Devices (no QoS)",
    ["snmp_qos_polled_devices"] = "Polled Devices (QoS only)",
    ["polled_late"] = "Delayed Polling (Devices)",
    ["polled_ok"] = "Polled on Time (Devices)",
