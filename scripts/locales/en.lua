local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["binary_application_transfer_url"] = "%{type_icon} Detected binary application transfer [%{href}]",
  ...
  ["db_explorer"] = {
    ...
    ["cli_latency"] = "Client Net. Latency",
    ...
    ["server_name"] = "Server Name",
    ["srv_latency"] = "Server Net. Latency",
    ["summary"] = "Summary",
  ...
  ["flow_checks"] = {
    ...
    ["iec104_coomand_description"] = "Trigger an alert when a command to/from command or measure to/from command IEC transition is detected",
  ...
  ["flow_checks_config"] = {
    ...
    ["connection_failed_description"] = "Trigger an alert when a Client Host tries to connect to a Server Host but it does not receive an answer",
