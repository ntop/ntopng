local lang = {
  ...
  ["details"] = {
    ...
    ["server_contacts_tcp_unresponsive"] = "TCP Unresponsive Flows (Peer IP and Server Port)",
    ...
    ["unidirectional_tcp_flows"] = "Total Unidirectional TCP Flows",
    ["vlan_id"] = "VLAN ID",
  ...
  ["entity_thresholds"] = {
    ...
    ["dns_flood_title"] = "DNS Flood Alert",
    ...
    ["snmp_flood_title"] = "SNMP Flood Alert",
  ...
  ["flow_checks_config"] = {
    ...
    ["malicious_ja3"] = "Malicious JA3 Fingerprint",
    ...
    ["ndpi_periodic_flow"] = "nDPI Periodic Flow",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_http_suspicious_content"] = "HTTP Suspicious Content",
    ...
    ["ndpi_tls_cert_validity_too_long"] = "TLS Certificate Validity > 13 months",
    ["ndpi_tls_certificate_about_to_expire"] = "TLS Certificate About To Expire",
  ...
  ["hosts_stats"] = {
    ...
    ["local"] = "Local",
    ["local_hosts_only"] = "Local Unicast Hosts Only",
    ["local_no_tcp_tx"] = "Local Unicast Hosts TCP Blackhole",
    ["local_no_tx"] = "Local Unicast Blackhole",
    ["location"] = "Location",
    ...
    ["remote_no_tcp_tx"] = "Remote TCP Blackhole",
    ["remote_no_tx"] = "Remote Blackhole",
    ["source_id"] = "Source Id",
  ...
  ["if_stats_config"] = {
    ...
    ["metric"] = "Metric",
    ["note_1"] = "Host Timeseries: insert the IP of a Local Host to be analyzed or a * (meaning that all Local Hosts has to be analyzed)",
  ...
  ["prefs"] = {
    ...
    ["radius_admin_group_description"] = "The user is authenticated as Administrator when the value for the <i>Filter-Id</i> RADIUS attribute matches the one specified in this field, or Unprivileged otherwise.",
    ...
    ["radius_unpriv_capabilties_group_description"] = "Non-Administrator users can have additional capabilities (e.g. pcap download and historical flow access) when the value for the <i>Filter-Id</i> RADIUS attribute matches the one specified in this field. In case of no match, limited capabilites are set for unprivileged users.",
  ...
  ["show_alerts"] = {
    ...
    ["host_rules_percentage"] = "Symbol '>' means a positive percentage treshold, otherwise '<' means a negative percentage threshold.",
    ["hourly"] = "Hourly",
