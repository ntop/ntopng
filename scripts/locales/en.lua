local lang = {
  ...
  ["prefs"] = {
    ...
    ["snmp"] = "SNMP",
    ["snmp_port_load_threshold_description"] = "Set a threshold (based on port speed) to trigger alerts when the port load exceeds the specified limit (5-min average).",
    ["snmp_port_load_threshold_title"] = "Port Load Threshold (%%) Alerts",
