local lang = {
  ...
  ["checks"] = {
    ...
    ["device_connection_disconnection_description"] = "Trigger an alert when a denied MAC connects or when an allowed MAC disconnects from the network.",
    ["device_connection_disconnection_title"] = "Unexpected MAC Connected/Disconnected",
