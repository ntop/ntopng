local lang = {
  ...
  ["prefs"] = {
    ...
    ["toggle_intranet_traffic_rrds_description"] = "Toggle the creation of Intranet Network Traffic (traffic between networks) timeseries.<br><b>Note:</b> These timeseries are going to be available only if the Local Network timeseries are enabled.",
