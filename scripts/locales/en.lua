local lang = {
  ...
  ["prefs"] = {
    ...
    ["https_auth"] = "HTTPS Client Authentication",
    ["https_auth_description"] = "Settings will have effect at the next ntopng startup.",
    ["https_auth_title"] = "Toggle HTTPS Client Certificate Authentication",
