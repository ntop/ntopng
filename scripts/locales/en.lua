local lang = {
  ...
  ["internals"] = {
    ...
    ["sleeping"] = "Sleeping",
    ["slow_timeseries_writes"] = "Slow TS Writes",
    ["slow_timeseries_writes_descr"] = "TS writes too slow, some writes have been skipped",
  ...
  ["prefs"] = {
    ...
    ["toggle_local_hosts_stats_rrd_creation_description"] = "Enable full host timeseries creations or limits it to bytes and score when off.",
    ["toggle_local_hosts_stats_rrd_creation_title"] = "Full Host Timeseries",
