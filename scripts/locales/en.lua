local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["snmp_port_change_opstatus_changed"] = "Interface %{port} on SNMP device <a href=\"%{url}\">%{device}</a> changed %{time_ago} ago, now it's still %{op_status}",
    ["snmp_port_change_opstatus_from_to"] = "Interface %{port} on SNMP device <a href=\"%{url}\">%{device}</a> changed from %{old_op} to %{new_op} status",
    ["snmp_port_change_opstatus_from_to_ago"] = "Interface %{port} on SNMP device <a href=\"%{url}\">%{device}</a> changed from %{old_op} to %{new_op} status %{time_ago} ago",
  ...
  ["mac_stats"] = {
    ...
    ["layer_2_source_devices"] = "Layer 2 %{device_type} Source Devices",
  ...
  ["prefs"] = {
    ...
    ["email_notification_address_description"] = "The sender/recipient email address to use.",
    ["email_notification_address_title"] = "Email Address",
    ["email_notification_server_description"] = "The SMTP server to deliver the email. E.g. smtp://example.com:25 .",
    ...
    ["toggle_alert_nagios_description"] = "Enable sending %{product} alerts to Nagios NSCA (Nagios Service Check Acceptor).",
    ...
    ["toggle_device_first_seen_alert_title"] = "Enable Alerts on New Devices Connection",
    ...
    ["toggle_email_notification_description"] = "Enable sending alerts via email.",
    ["toggle_email_notification_title"] = "Enable Email Notification",
    ["toggle_external_alerts_description"] = "Toggle external programs alerts reporting, e.g. slack, nagios or email.",
    ["toggle_external_alerts_title"] = "Toggle External Alerts Report",
    ...
    ["toggle_ip_reassignment_description"] = "Enable alerts generated when an IP address, previously seen with a MAC address, is now seen with another MAC address. This alert might indicate an ARP spoof attempt.",
    ["toggle_ip_reassignment_title"] = "Enable IP reassignment alerts",
    ...
    ["toggle_malware_probing_description"] = "Enable alerts generated by traffic sent/received by <a href=\"%{url}\">malware-marked hosts</a>. Overnight new blacklist rules are refreshed.",
    ...
    ["toggle_pool_activation_alert_description"] = "Enable the generation of alerts when the first host connects or the last host disconnect from some pool.",
    ["toggle_pool_activation_alert_title"] = "Enable Host Pools Connection/Disconnection Alerts",
  ...
  ["snmp"] = {
    ...
    ["disable_polling"] = "Disable Polling",
    ...
    ["snmp_polling_disable_confirm"] = "Do you really want to disable periodic SNMP polling of device %{device}?",
    ["snmp_polling_enable_confirm"] = "Do you really want to enable periodic SNMP polling of device %{device}?",
