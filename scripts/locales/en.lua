local lang = {
  ...
  ["if_stats_config"] = {
    ...
    ["note_5"] = "Percentage: is calculated beetwen the last two frequency checks (e.g. <1% with frequency 5 Min -> if the difference between precedent frequency and the last 5 minutes check is lower than 1% trigger an alert)",
