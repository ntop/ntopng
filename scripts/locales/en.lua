local lang = {
  ...
  ["errors"] = "Errors",
  ["expired_csrf"] = "Could not perform the requested action because the page expired. Please perform the action again.",
  ["filter"] = "Filter",
  ...
  ["alert_messages"] = {
    ...
    ["slow_purge"] = "Hash table idle entries purging on %{iface} is too slow. This could lead to high memory utilization, data accuracy loss and missing alerts. [&gt %{max_idle}%%]",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_create_custom_scripts"] = "Documentation to create custom scripts for the execution of callbacks is available at the following <a href=\"%{url}\">link</a> <i class=\"fa fa-external-link-alt\"></i>.",
  ...
  ["flow_details"] = {
    ...
    ["tls_server_certificate"] = "Server Certificate",
  ...
  ["icmp_v4_msgs"] = {
    ...
    ["type_3_10_communication_host_prohibited"] = "Communication with Destination Host is Administratively Prohibited",
    ["type_3_11_destination_network_unreachable"] = "Destination Network Unreachable for Type of Service",
    ["type_3_12_destination_host_unreachable"] = "Destination Host Unreachable for Type of Service",
    ["type_3_13_communication_prohibited"] = "Communication Administratively Prohibited",
    ["type_3_14_host_precedence_violation"] = "Host Precedence Violation",
    ["type_3_15_precedence_cutoff"] = "Precedence cutoff in effect",
    ...
    ["type_3_5_source_route_failed"] = "Source Route Failed",
    ...
    ["type_3_8_source_isolated"] = "Source Host Isolated",
    ["type_3_9_communication_network_prohibited"] = "Communication with Destination Network is Administratively Prohibited",
  ...
  ["icmp_v4_types"] = {
    ...
    ["type_3_3_port_unreachable"] = "%{protocol} Port %{dst_port} Unreachable",
  ...
  ["icmp_v6_msgs"] = {
    ...
    ["type_1_1_communication_prohibited"] = "Communication with destination administratively prohibited",
    ["type_1_2_beyond_scope"] = "Beyond scope of source address",
    ["type_1_3_destination_host_unreachable"] = "Address unreachable",
    ["type_1_4_destination_port_unreachable"] = "Port Unreachable",
    ["type_1_5_source_address_failed_policy"] = "Source address failed ingress/egress policy",
    ["type_1_6_reject_route_to_destination"] = "Reject route to destination",
    ["type_1_7_error_in_source_routing_header"] = "Error in Source Routing Header",
    ...
    ["type_4_1_unrecognized_next_header_type_encountered"] = "Unrecognized Next Header type encountered",
    ["type_4_2_unrecognized_option_encountered"] = "Unrecognized IPv6 option encountered",
    ["type_4_3_first_fragment_has_incomplete_chain"] = "IPv6 First Fragment has incomplete IPv6 Header Chain",
    ["type_4_4_sr_upper_layer_header_error"] = "SR Upper-layer Header Error",
    ["type_128_0_echo_request"] = "Echo Request",
    ["type_129_0_echo_reply"] = "Echo Reply",
    ["type_130_0_multicast_listener_query"] = "Multicast Listener Query",
    ["type_131_0_multicast_listener_report"] = "Multicast Listener Report",
    ["type_132_0_multicast_listener_done"] = "Multicast Listener Done",
    ...
    ["type_137_0_redirect_message"] = "Redirect Message",
    ["type_138_0_router_renumbering"] = "Router Renumbering",
    ["type_139_0_icmp_node_information_query_ipv6_subject"] = "The Data field contains an IPv6 address which is the Subject of this Query",
    ["type_139_1_icmp_node_information_query_name_subject"] = "The Data field contains a name which is the Subject of this Query, or is empty, as in the case of a NOOP",
    ["type_139_2_icmp_node_information_query_ipv4_subject"] = "The Data field contains an IPv4 address which is the Subject of this Query",
    ["type_140_0_icmp_node_information_response_ok"] = "A successful reply",
    ["type_140_1_icmp_node_information_response_refused"] = "The Responder refuses to supply the answer",
    ["type_140_2_icmp_node_information_response_unknown"] = "The Qtype of the Query is unknown to the Responder",
    ["type_141_0_inverse_neighbor_discovery"] = "Inverse Neighbor Discovery",
    ["type_142_0_inverse_neighbor_discovery"] = "Inverse Neighbor Discovery",
    ["type_144_0_home_agent_address_discovery"] = "Home Agent Address Discovery",
    ["type_145_0_home_agent_address_discovery"] = "Home Agent Address Discovery",
    ["type_146_0_mobile_prefix_solicitation"] = "Mobile Prefix Solicitation",
    ["type_147_0_mobile_prefix_advertisement"] = "Mobile Prefix Advertisement",
    ["type_157_0_duplicate_address_request_code_suffix_dar_msg"] = "DAR message",
    ["type_157_1_duplicate_address_request_code_suffix_edar64_msg"] = "EDAR message with 64-bit ROVR field",
    ["type_157_2_duplicate_address_request_code_suffix_edar128_msg"] = "EDAR message with 128-bit ROVR field",
    ["type_157_3_duplicate_address_request_code_suffix_edar192_msg"] = "EDAR message with 192-bit ROVR field",
    ["type_157_4_duplicate_address_request_code_suffix_edar256_msg"] = "EDAR message with 256-bit ROVR field",
    ["type_157_5_duplicate_address_request_code_suffix_unassigned"] = "Unassigned",
    ["type_158_0_duplicate_address_request_code_suffix_dac_msg"] = "DAC message",
    ["type_158_1_duplicate_address_request_code_suffix_edac64_msg"] = "EDAC message with 64-bit ROVR field",
    ["type_158_2_duplicate_address_request_code_suffix_edac128_msg"] = "EDAC message with 128-bit ROVR field",
    ["type_158_3_duplicate_address_request_code_suffix_edac192_msg"] = "EDAC message with 192-bit ROVR field",
    ["type_158_4_duplicate_address_request_code_suffix_edac256_msg"] = "EDAC message with 256-bit ROVR field",
    ["type_158_5_duplicate_address_request_code_suffix_unassigned"] = "Unassigned",
    ["type_160_0_extended_echo_request_no_error"] = "Extended echo request: No Error",
    ["type_160_1_extended_echo_request_unassigned"] = "Extended echo request: Unassigned",
    ["type_161_0_extended_echo_reply_no_error"] = "Extended echo reply: No Error",
    ["type_161_1_extended_echo_reply_malformed"] = "Extended echo reply: Malformed Query",
    ["type_161_2_extended_echo_reply_no_such_interface"] = "Extended echo reply: No Such Interface",
    ["type_161_3_extended_echo_reply_no_such_table_entry"] = "Extended echo reply: No Such Table Entry",
    ["type_161_4_extended_echo_reply_multiple_interfaces_satisfy"] = "Extended echo reply: Multiple Interfaces Satisfy Query",
    ["type_161_5_extended_echo_reply_unassigned"] = "Extended echo reply: Unassigned",
  },
  ["icmp_v6_types"] = {
  ...
  ["prefs"] = {
    ...
    ["n2n_supernode_description"] = "The address of the <a href=\"%{url}\">n2n</a> <i class=\"fa fa-external-link-alt\"></i> supernode. Set up your own supernode in order to have a fully private remote access.<br><b>NOTE</b>: this change will have affect only after Remote Assistance restart.",
