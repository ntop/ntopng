local lang = {
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["daily"] = "Daily",
    ["dns_contacts_description"] = "Triggers an alert when an host contacts too many different DNS Server",
    ...
    ["notes"] = "NOTES",
    ["ntp_contacts_description"] = "Triggers an alert when an host contacts too many different NTP Server",
    ["ntp_contacts_title"] = "Too Many NTP Contacts",
    ["p2p_traffic"] = "P2P Traffic Alert",
    ["smtp_contacts_description"] = "Triggers an alert when an host contacts too many different SMTP Server",
