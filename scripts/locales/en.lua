local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["device_has_connected"] = "An unexpected device <a href=\"%{device_url}\">%{device}</a> connected to the interface <a href=\"%{if_url}\">%{if_name}</a>. Check <a href=\"%{exclusion_url}\">here</a> the allowed devices.",
  ...
  ["checks"] = {
    ...
    ["device_connection_disconnection_title"] = "Device Connected/Disconnected",
