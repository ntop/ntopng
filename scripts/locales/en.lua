local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["ip_outsite_dhcp_range"] = "Device <a href=\"%{client_url}\">%{client_mac}</a> got the IP address <a href=\"%{client_ip_url}\">%{client_ip}</a> which is outside the <a href=\"%{dhcp_url}\">configured DHCP range</a>. [Sender: <a href=\"%{sender_url}\">%{sender_mac}</a>] [Router: <a href=\"%{router_url}\">%{router_ip}</a>]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["many_replies"] = "%{count} replies",
    ["many_requests"] = "%{count} requests",
    ...
    ["one_hour"] = "Last Hour",
    ["one_min"] = "Last Minute",
    ["one_reply"] = "%{count} reply",
    ["one_request"] = "%{count} request",
    ["ping_issues"] = "Ping",
    ...
    ["too_low_replies_received"] = "%{entity} has sent %{requests} %{what} requests but received %{replies} %{what} replies [%{granularity} ratio: %{ratio}%%]",
    ["too_low_replies_sent"] = "%{entity} has received %{requests} %{what} requests but sent %{replies} %{what} replies [%{granularity} ratio: %{ratio}%%]",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["alert_active_description"] = "Activity time delta",
    ...
    ["alert_idle_description"] = "Idle time since last packet seen",
    ...
    ["alert_throughput_description"] = "Average throughput (sent + received)",
    ["common_thresholds_local_sources"] = "%{source} Common Thresholds",
    ["daily"] = "Daily",
  ...
  ["delete_data"] = {
    ["delete_active_interface_confirmation"] = "Are you sure you want to delete all the persistent data associated to %{ifname}?<br><br><b>NOTE:</b> Data deletion will be performed upon %{product} restart. Restart %{product} to make the deletion effective.",
  ...
  ["entity_thresholds"] = {
    ["flow_attacker_description"] = "Number of new client flows per second for three consecutive seconds",
    ["flow_attacker_title"] = "Flow Flood Attacker",
    ["flow_victim_description"] = "Number of new server flows per second for three consecutive seconds",
    ["flow_victim_title"] = "Flow Flood Victim",
    ["request_reply_ratio_description"] = "Number of replies vs requests ratio on different applications",
    ["request_reply_ratio_title"] = "Replies / Requests Ratio",
    ["syn_attacker_description"] = "Number of SYNs per second sent for three consecutive seconds",
    ["syn_attacker_title"] = "SYN Flood Attacker",
    ["syn_victim_description"] = "Number of SYNs per second received for three consecutive seconds",
  ...
  ["flow_details"] = {
    ...
    ["ssl_old_protocol_version"] = "Obsolete SSL Protocol Version",
  ...
  ["host_details"] = {
    ...
    ["reset_host_stats_note"] = "NOTE: historical charts for this host may have a gap after the reset.",
  ...
  ["icmp_v6_msgs"] = {
    ...
    ["type_143_0_multicast_listener_report_v2"] = "Version 2 Multicast Listener Report",
  ...
  ["mac_details"] = {
    ...
    ["reset_mac_stats_note"] = "NOTE: historical charts for this mac address may have a gap after the reset.",
  ...
  ["prefs"] = {
    ...
    ["nindex_retention_description"] = "Number of days to keep indexed flows for historical exploration.",
    ...
    ["toggle_data_exfiltration_description"] = "Toggle heuristics to detect data exfiltration and generate alerts.",
    ["toggle_data_exfiltration_title"] = "Data Exfiltration Alerts",
    ...
    ["toggle_device_protocols_description"] = "Toggle alerts generated when an anomalous application is detected according to the configured <a href=\"%{url}\">device applications policies</a>.",
    ...
    ["toggle_device_protocols_title"] = "Device Applications Alerts",
    ...
    ["toggle_malware_probing_description"] = "Toggle alerts generated by traffic sent/received by malware-marked hosts. Malware blacklists can be configured from the <a href=\"%{url}\">Category Lists page</a>.",
    ...
    ["toggle_potentially_dangerous_protocols_description"] = "Toggle alerts generated when a potentially dangerous protocol is detected on a flow.",
    ["toggle_potentially_dangerous_protocols_title"] = "Potentially Dangerous Protocols",
  ...
  ["snmp"] = {
    ...
    ["absolute_errors"] = "Errors Since Boot",
