local  en = {
   ...
   nprobe_mapping = {
      id_1 = "Incoming flow bytes (src->dst) [Aliased to %%SRC_TO_DST_BYTES]",
      id_2 = "Incoming flow packets (src->dst) [Aliased to %%SRC_TO_DST_PKTS]",
      id_4 = "IP protocol byte",
      id_58500 = "IP protocol name",
      id_5 = "TOS/DSCP (src->dst)",
      id_6 = "Cumulative of all flow TCP flags",
      id_7 = "IPv4 source port",
      id_58503 = "Layer 4 source port symbolic name",
      id_8 = "IPv4 source address",
      id_9 = "IPv4 source subnet mask (/<bits>)",
      id_10 = "Input interface SNMP idx",
      id_11 = "IPv4 destination port",
      id_58507 = "Layer 4 destination port symbolic name",
      id_58508 = "Layer 4 server port",
      id_58509 = "Layer 4 server port symbolic name",
      id_12 = "IPv4 destination address",
      id_13 = "IPv4 dest subnet mask (/<bits>)",
      id_14 = "Output interface SNMP idx",
      id_15 = "IPv4 next hop address",
      id_16 = "Source BGP AS",
      id_17 = "Destination BGP AS",
      id_21 = "SysUptime (msec) of the last flow pkt",
      id_22 = "SysUptime (msec) of the first flow pkt",
      id_23 = "Outgoing flow bytes (dst->src) [Aliased to %%DST_TO_SRC_BYTES]",
      id_24 = "Outgoing flow packets (dst->src) [Aliased to %%DST_TO_SRC_PKTS]",
      id_27 = "IPv6 source address",
      id_28 = "IPv6 destination address",
      id_29 = "IPv6 source mask",
      id_30 = "IPv6 destination mask",
      id_32 = "ICMP Type * 256 + ICMP code",
      id_34 = "Sampling rate",
      id_35 = "Sampling type (deterministic/random)",
      id_36 = "Activity timeout of flow cache entries",
      id_37 = "Inactivity timeout of flow cache entries",
      id_38 = "Flow switching engine",
      id_39 = "Id of the flow switching engine",
      id_40 = "Total bytes exported",
      id_41 = "Total flow packets exported",
      id_42 = "Total number of exported flows",
      id_52 = "Min flow TTL",
      id_53 = "Max flow TTL",
      id_55 = "TOS/DSCP (dst->src)",
      id_56 = "Source MAC Address",
      id_58 = "Source VLAN (inner VLAN in QinQ)",
      id_59 = "Destination VLAN (inner VLAN in QinQ)",
      id_243 = "Source VLAN (outer VLAN in QinQ)",
      id_254 = "Destination VLAN (outer VLAN in QinQ)",
      id_60 = "[4=IPv4][6=IPv6]",
      id_61 = "Flow direction [0=src->dst, 1=dst->src]",
      id_62 = "IPv6 next hop address",
      id_70 = "MPLS label at position 1",
      id_71 = "MPLS label at position 2",
      id_72 = "MPLS label at position 3",
      id_73 = "MPLS label at position 4",
      id_74 = "MPLS label at position 5",
      id_75 = "MPLS label at position 6",
      id_76 = "MPLS label at position 7",
      id_77 = "MPLS label at position 8",
      id_78 = "MPLS label at position 9",
      id_79 = "MPLS label at position 10",
      id_80 = "Destination MAC Address",
      id_95 = "Collected Application Id (Cisco or IXIA)",
      id_102 = "Packet section offset",
      id_103 = "Sampled packet size",
      id_104 = "Sampled packet id",
      id_130 = "Flow exporter IPv4 Address",
      id_131 = "Flow exporter IPv6 Address",
      id_148 = "Serial Flow Identifier",
      id_150 = "Seconds (epoch) of the first flow packet",
      id_151 = "Seconds (epoch) of the last flow packet",
      id_152 = "Msec (epoch) of the first flow packet",
      id_154 = "uSec (epoch) of the first flow packet",
      id_153 = "Msec (epoch) of the last flow packet",
      id_155 = "uSec (epoch) of the last flow packet",
      id_239 = "1=initiator, 2=reverseInitiator",
      id_234 = "Ingress VRF ID",
      id_161 = "Flow duration (msec)",
      id_162 = "Flow duration (usec)",
      id_176 = "ICMP Type",
      id_177 = "ICMP Code",
      id_277 = "Observation point type",
      id_300 = "Observation point id",
      id_302 = "Selector id",
      id_304 = "Sampling algorithm",
      id_309 = "Number of packets to sample",
      id_310 = "Sampling population",
      id_312 = "Original L2 frame length",
      id_318 = "Tot number of packets seen",
      id_319 = "Number of pkts selected for sampling",
      id_335 = "Sampler name",
      id_57899 = "Palo Alto App-Id",
      id_57900 = "Palo Alto User-Id",
      id_57552 = "Num fragmented packets src->dst",
      id_57553 = "Num fragmented packets dst->src",
      id_57595 = "Network RTT/2 client <-> nprobe (msec)",
      id_57596 = "Network RTT/2 nprobe <-> server (msec)",
      id_57597 = "Application latency (msec), a.k.a. server response time",
      id_57943 = "IPv4 address of the host were nProbe runs",
      id_57554 = "Src to dst max thpt (bps)",
      id_57555 = "Src to dst min thpt (bps)",
      id_57556 = "Src to dst average thpt (bps)",
      id_57557 = "Dst to src max thpt (bps)",
      id_57558 = "Dst to src min thpt (bps)",
      id_57559 = "Dst to src average thpt (bps)",
      id_57560 = "# packets whose IP size <= 128",
      id_57561 = "# packets whose IP size > 128 and <= 256",
      id_57562 = "# packets whose IP size > 256 and < 512",
      id_57563 = "# packets whose IP size > 512 and < 1024",
      id_57564 = "# packets whose IP size > 1024 and <= 1514",
      id_57565 = "# packets whose IP size > 1514",
      id_57570 = "Cumulative OR of ICMP type packets",
      id_57573 = "Country where the src IP is located",
      id_57574 = "City where the src IP is located",
      id_57575 = "Country where the dst IP is located",
      id_57576 = "City where the dst IP is located",
      id_57920 = "Longitude where the src IP is located",
      id_57921 = "Latitude where the src IP is located",
      id_57922 = "Longitude where the dst IP is located",
      id_57923 = "Latitude where the dst IP is located",
      id_57577 = "L7 port that identifies the flow protocol or 0 if unknown",
      id_57578 = "Upstream tunnel identifier (e.g. GTP TEID, VXLAN VNI) or 0 if unknown",
      id_57918 = "Upstream session identifier (e.g. L2TP) or 0 if unknown",
      id_57579 = "Longest packet (bytes) of the flow",
      id_57580 = "Shortest packet (bytes) of the flow",
      id_57599 = "Number of retransmitted TCP flow bytes (src->dst)",
      id_57581 = "Number of retransmitted TCP flow packets (src->dst)",
      id_57600 = "Number of retransmitted TCP flow bytes (dst->src)",
      id_57582 = "Number of retransmitted TCP flow packets (dst->src)",
      id_57583 = "Number of out of order TCP flow packets (dst->src)",
      id_57584 = "Number of out of order TCP flow packets (src->dst)",
      id_57585 = "Untunneled IP protocol byte",
      id_57586 = "Untunneled IPv4 source address",
      id_57587 = "Untunneled IPv4 source port",
      id_57588 = "Untunneled IPv4 destination address",
      id_57589 = "Untunneled IPv4 destination port",
      id_57590 = "Layer 7 protocol (numeric)",
      id_57591 = "Layer 7 protocol name",
      id_57592 = "Downstream tunnel identifier (e.g. GTP TEID, VXLAN VNI) or 0 if unknown",
      id_57919 = "Downstream session identifier (e.g. L2TP) or 0 if unknown",
      id_57660 = "SSL server name",
      id_57661 = "BITTORRENT hash",
      id_57593 = "Flow username of the tunnel (if known)",
      id_57594 = "Flow server name (if known)",
      id_57598 = "Plugin name used by this flow (if any)",
      id_57868 = "Untunneled IPv6 source address",
      id_57869 = "Untunneled IPv6 destination address",
      id_57819 = "# packets with TTL = 1",
      id_57818 = "# packets with TTL > 1 and TTL <= 5",
      id_57806 = "# packets with TTL > 5 and TTL <= 32",
      id_57807 = "# packets with TTL > 32 and <= 64",
      id_57808 = "# packets with TTL > 64 and <= 96",
      id_57809 = "# packets with TTL > 96 and <= 128",
      id_57810 = "# packets with TTL > 128 and <= 160",
      id_57811 = "# packets with TTL > 160 and <= 192",
      id_57812 = "# packets with TTL > 192 and <= 224",
      id_57813 = "# packets with TTL > 224 and <= 255",
      id_57821 = "OSI Source SAP (OSI Traffic Only)",
      id_57822 = "OSI Destination SAP (OSI Traffic Only)",
      id_57863 = "Client to Server stream duration (msec)",
      id_57864 = "Client to Server stream duration (msec)",
      id_57887 = "Min TCP Window (src->dst)",
      id_57888 = "Max TCP Window (src->dst)",
      id_57889 = "TCP Max Segment Size (src->dst)",
      id_57890 = "TCP Window Scale (src->dst)",
      id_57891 = "Min TCP Window (dst->src)",
      id_57892 = "Max TCP Window (dst->src)",
      id_57893 = "TCP Max Segment Size (dst->src)",
      id_57894 = "TCP Window Scale (dst->src)",
      id_57910 = "Initial flow payload hash",
      id_57915 = "Organization name for SRC_AS",
      id_57916 = "Organization name for DST_AS",
      id_57762 = "Src AS path position 1",
      id_57763 = "Src AS path position 2",
      id_57764 = "Src AS path position 3",
      id_57765 = "Src AS path position 4",
      id_57766 = "Src AS path position 5",
      id_57767 = "Src AS path position 6",
      id_57768 = "Src AS path position 7",
      id_57769 = "Src AS path position 8",
      id_57770 = "Src AS path position 9",
      id_57771 = "Src AS path position 10",
      id_57772 = "Dest AS path position 1",
      id_57773 = "Dest AS path position 2",
      id_57774 = "Dest AS path position 3",
      id_57775 = "Dest AS path position 4",
      id_57776 = "Dest AS path position 5",
      id_57777 = "Dest AS path position 6",
      id_57778 = "Dest AS path position 7",
      id_57779 = "Dest AS path position 8",
      id_57780 = "Dest AS path position 9",
      id_57781 = "Dest AS path position 10",
      id_57825 = "MAC of the DHCP client",
      id_57826 = "DHCP assigned client IPv4 address",
      id_57827 = "DHCP client name",
      id_57895 = "DHCP agent remote Id",
      id_57896 = "DHCP subscribed Id",
      id_57901 = "DHCP message type",
      id_57871 = "DIAMETER Request Msg Type",
      id_57872 = "DIAMETER Response Msg Type",
      id_57873 = "DIAMETER Origin Host Request",
      id_57874 = "DIAMETER Origin Host Response",
      id_57875 = "DIAMETER Request User Name",
      id_57876 = "DIAMETER Response Result Code",
      id_57877 = "DIAMETER Response Experimental Result Vendor Id",
      id_57878 = "DIAMETER Response Experimental Result Code",
      id_57917 = "DIAMETER Hop by Hop Identifier",
      id_57924 = "DIAMETER Cancellation Type",
      id_57925 = "DIAMETER CLR Flags",
      id_57677 = "DNS query",
      id_57678 = "DNS query transaction Id",
      id_57679 = "DNS query type (e.g. 1=A, 2=NS..)",
      id_57680 = "DNS return code (e.g. 0=no error)",
      id_57681 = "DNS # of returned answers",
      id_57824 = "TTL of the first A record (if any)",
      id_57870 = "DNS response(s)",
      id_57828 = "FTP client login",
      id_57829 = "FTP client password",
      id_57830 = "FTP client command",
      id_57831 = "FTP client command return code",
      id_57793 = "GTPv0 Request Msg Type",
      id_57794 = "GTPv0 Response Msg Type",
      id_57795 = "GTPv0 Tunnel Identifier",
      id_57798 = "GTPv0 APN Name",
      id_57796 = "GTPv0 End User IP Address",
      id_57797 = "GTPv0 End User MSISDN",
      id_57799 = "GTPv0 Mobile Country Code",
      id_57800 = "GTPv0 Mobile Network Code",
      id_57801 = "GTPv0 Cell Location Area Code",
      id_57802 = "GTPv0 Cell Routing Area Code",
      id_57803 = "GTPv0 Cause of Operation",
      id_57692 = "GTPv1 Request Msg Type",
      id_57693 = "GTPv1 Response Msg Type",
      id_57694 = "GTPv1 Client->Server TunnelId Data",
      id_57695 = "GTPv1 Client->Server TunnelId Control",
      id_57696 = "GTPv1 Server->Client TunnelId Data",
      id_57697 = "GTPv1 Server->Client TunnelId Control",
      id_57698 = "GTPv1 End User IP Address",
      id_57699 = "GTPv1 End User IMSI",
      id_57700 = "GTPv1 End User MSISDN",
      id_57701 = "GTPv1 End User IMEI",
      id_57702 = "GTPv1 APN Name",
      id_57708 = "GTPv1 RAT Type",
      id_57703 = "GTPv1 RAI Mobile Country Code",
      id_57704 = "GTPv1 RAI Mobile Network Code",
      id_57814 = "GTPv1 RAI Location Area Code",
      id_57815 = "GTPv1 RAI Routing Area Code",
      id_57816 = "GTPv1 ULI Mobile Country Code",
      id_57817 = "GTPv1 ULI Mobile Network Code",
      id_57705 = "GTPv1 ULI Cell Location Area Code",
      id_57706 = "GTPv1 ULI Cell CI",
      id_57707 = "GTPv1 ULI SAC",
      id_57804 = "GTPv1 Cause of Operation",
      id_57742 = "GTPv2 Request Msg Type",
      id_57743 = "GTPv2 Response Msg Type",
      id_57744 = "GTPv2 Client->Svr S1U GTPU TEID",
      id_57745 = "GTPv2 Client->Svr S1U GTPU IP",
      id_57746 = "GTPv2 Srv->Client S1U GTPU TEID",
      id_57907 = "GTPv2 S5/S8 SGW GTPC TEIDs",
      id_57747 = "GTPv2 Srv->Client S1U GTPU IP",
      id_57911 = "GTPv2 Client->Srv S5/S8 PGW GTPU TEID",
      id_57912 = "GTPv2 Srv->Client S5/S8 PGW GTPU TEID",
      id_57913 = "GTPv2 Client->Srv S5/S8 PGW GTPU IP",
      id_57914 = "GTPv2 Srv->Client S5/S8 PGW GTPU IP",
      id_57748 = "GTPv2 End User IMSI",
      id_57749 = "GTPv2 End User MSISDN",
      id_57750 = "GTPv2 APN Name",
      id_57751 = "GTPv2 Mobile Country Code",
      id_57752 = "GTPv2 Mobile Network Code",
      id_57753 = "GTPv2 Tracking Area Code",
      id_57754 = "GTPv2 Cell Identifier",
      id_57805 = "GTPv2 Cause of Operation",
      id_57755 = "GTPv2 RAT Type",
      id_57756 = "GTPV2 PDN IP Address",
      id_57757 = "GTPv2 End User IMEI",
      id_57926 = "GTPv2 Client->Svr S5/S8 GTPC IP",
      id_57927 = "GTPv2 Svr->Client S5/S8 GTPC IP",
      id_57928 = "GTPv2 Client->Srv S5/S8 SGW GTPU TEID",
      id_57929 = "GTPv2 Srv->Client S5/S8 SGW GTPU TEID",
      id_57930 = "GTPv2 Client->Srv S5/S8 SGW GTPU IP",
      id_57931 = "GTPv2 Srv->Client S5/S8 SGW GTPU IP",
      id_57652 = "HTTP URL (IXIA URI)",
      id_57832 = "HTTP METHOD",
      id_57653 = "HTTP return code (e.g. 200, 304...)",
      id_57654 = "HTTP Referer",
      id_57655 = "HTTP User Agent",
      id_57656 = "HTTP Mime Type",
      id_57659 = "HTTP Host Name (IXIA Host Name)",
      id_57833 = "HTTP server without host name",
      id_57932 = "HTTP X-Forwarded-For",
      id_57933 = "HTTP Via",
      id_57732 = "Mail sender",
      id_57667 = "MySQL server version",
      id_57668 = "MySQL username",
      id_57669 = "MySQL database in use",
      id_57670 = "MySQL Query",
      id_57671 = "MySQL server response",
      id_57792 = "MySQL request->response latecy (usec)",
      id_57936 = "NETBIOS Query Name",
      id_57937 = "NETBIOS Query Type",
      id_57938 = "NETBIOS Query Response",
      id_57939 = "NETBIOS Query OS",
      id_57672 = "Oracle Username",
      id_57673 = "Oracle Query",
      id_57674 = "Oracle Response Code",
      id_57675 = "Oracle Response String",
      id_57676 = "Oracle Query Duration (msec)",
      id_57682 = "POP3 user login",
      id_57640 = "Src process PID",
      id_57641 = "Src process name",
      id_57897 = "Src process UID",
      id_57844 = "Src process user name",
      id_57845 = "Src father process PID",
      id_57846 = "Src father process name",
      id_57855 = "Src process actual memory (bytes)",
      id_57856 = "Src process peak memory (bytes)",
      id_57857 = "Src process avg load (%% * 100)",
      id_57858 = "Src process num pagefaults",
      id_57865 = "Src process iowait time %% (%% * 100)",
      id_57847 = "Dst process PID",
      id_57848 = "Dst process name",
      id_57898 = "Dst process UID",
      id_57849 = "Dst process user name",
      id_57850 = "Dst father process PID",
      id_57851 = "Dst father process name",
      id_57859 = "Dst process actual memory (bytes)",
      id_57860 = "Dst process peak memory (bytes)",
      id_57861 = "Dst process avg load (%% * 100)",
      id_57862 = "Dst process num pagefaults",
      id_57866 = "Src process iowait time %% (%% * 100)",
      id_57712 = "RADIUS Request Msg Type",
      id_57713 = "RADIUS Response Msg Type",
      id_57714 = "RADIUS User Name (Access Only)",
      id_57715 = "RADIUS Calling Station Id",
      id_57716 = "RADIUS Called Station Id",
      id_57717 = "RADIUS NAS IP Address",
      id_57718 = "RADIUS NAS Identifier",
      id_57719 = "RADIUS User IMSI (Extension)",
      id_57720 = "RADIUS User MSISDN (Extension)",
      id_57721 = "RADIUS Framed IP",
      id_57722 = "RADIUS Accounting Session Name",
      id_57723 = "RADIUS Accounting Status Type",
      id_57724 = "RADIUS Accounting Input Octets",
      id_57725 = "RADIUS Accounting Output Octets",
      id_57726 = "RADIUS Accounting Input Packets",
      id_57727 = "RADIUS Accounting Output Packets",
      id_57909 = "RTP Sync Source ID",
      id_57622 = "First flow RTP Seq Number",
      id_57623 = "First flow RTP timestamp",
      id_57624 = "Last flow RTP Seq Number",
      id_57625 = "Last flow RTP timestamp",
      id_57626 = "RTP jitter (ms * 1000)",
      id_57627 = "RTP jitter (ms * 1000)",
      id_57628 = "Packet lost in stream (src->dst)",
      id_57629 = "Packet lost in stream (dst->src)",
      id_57902 = "Packet discarded by Jitter Buffer (src->dst)",
      id_57903 = "Packet discarded by Jitter Buffer (dst->src)",
      id_57633 = "RTP payload type",
      id_57630 = "RTP payload type",
      id_57631 = "Max delta (ms*100) between consecutive pkts (src->dst)",
      id_57632 = "Max delta (ms*100) between consecutive pkts (dst->src)",
      id_57820 = "SIP call-id corresponding to this RTP stream",
      id_57906 = "RTP pseudo-MOS (value * 100) (average both directions)",
      id_57842 = "RTP pseudo-MOS (value * 100) (src->dst)",
      id_57904 = "RTP pseudo-MOS (value * 100) (dst->src)",
      id_57908 = "RTP pseudo-R_FACTOR (value * 100) (average both directions)",
      id_57843 = "RTP pseudo-R_FACTOR (value * 100) (src->dst)",
      id_57905 = "RTP pseudo-R_FACTOR (value * 100) (dst->src)",
      id_57853 = "RTP Transit (value * 100) (src->dst)",
      id_57854 = "RTP Transit (value * 100) (dst->src)",
      id_57852 = "RTP Round Trip Time (ms)",
      id_57867 = "DTMF tones sent (if any) during the call",
      id_57879 = "S1AP ENB Identifier",
      id_57880 = "S1AP MME Identifier",
      id_57881 = "S1AP EMM Message Type from MME to ENB",
      id_57882 = "S1AP ESM Message Type from MME to ENB",
      id_57883 = "S1AP EMM Message Type from ENB to MME",
      id_57884 = "S1AP ESM Message Type from ENB to MME",
      id_57885 = "S1AP Cause from ENB to MME",
      id_57886 = "S1AP Detailed Cause from ENB to MME",
      id_57602 = "SIP call-id",
      id_57603 = "SIP Call initiator",
      id_57604 = "SIP Called party",
      id_57605 = "SIP RTP codecs",
      id_57606 = "SIP time (epoch) of INVITE",
      id_57607 = "SIP time (epoch) of Trying",
      id_57608 = "SIP time (epoch) of RINGING",
      id_57609 = "SIP time (epoch) of INVITE OK",
      id_57610 = "SIP time (epoch) of INVITE FAILURE",
      id_57611 = "SIP time (epoch) of BYE",
      id_57612 = "SIP time (epoch) of BYE OK",
      id_57613 = "SIP time (epoch) of CANCEL",
      id_57614 = "SIP time (epoch) of CANCEL OK",
      id_57615 = "SIP RTP stream source IP",
      id_57616 = "SIP RTP stream source port",
      id_57617 = "SIP RTP stream dest IP",
      id_57618 = "SIP RTP stream dest port",
      id_57619 = "SIP failure response code",
      id_57620 = "SIP Cancel/Bye/Failure reason cause",
      id_57834 = "SIP C IP adresses",
      id_57835 = "SIP Call State",
      id_57657 = "Mail sender",
      id_57658 = "Mail recipient",
      id_57934 = "SSDP Host",
      id_57935 = "SSDP USN",
      id_57940 = "SSDP Server",
      id_57941 = "SSDP Type",
      id_57942 = "SSDP Method",
   },
