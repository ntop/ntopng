local lang = {
  ...
  ["prefs"] = {
    ...
    ["toggle_external_auth_captive_portal_description"] = "Authenticate and authorize the user using an external service running at Informative Page URL. The external service must add the device to the proper nEdge user to authorize it.",
