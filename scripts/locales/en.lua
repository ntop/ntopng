local lang = {
  ...
  ["graphs"] = {
    ...
    ["cli_active_flows_behaviour"] = "Client Active Flows Behaviour",
  ...
  ["prefs"] = {
    ...
    ["toggle_emit_flow_alerts_description"] = "You can disable the generation of flow alerts in order to save CPU cycles. In this case the score will be updated but not alert will be triggered",
