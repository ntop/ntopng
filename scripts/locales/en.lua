local lang = {
    ...
    ["prefs"] = {
        ...
        ["toggle_hide_probing_attempt_alerts_description"] = "Disable the generation of alerts for TCP probe attempts if the connection is unidirectional or not fully established.",
        ["toggle_hide_probing_attempt_alerts_title"] = "Hide TCP Probing Attempts",
