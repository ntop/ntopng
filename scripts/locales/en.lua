local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["_traffic_volume_alert"] = "Traffic Volume Exceeded",
  ...
  ["if_stats_config"] = {
    ...
    ["frequency"] = "Frequency",
    ["generic_notes_1"] = "In this page it's possible to add rules regarding hosts and the traffic they do. Whenever a configured host exceeds the configured traffic, ntopng is going to trigger an alert",
