local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["remote_connection_description"] = "Trigger an alert wheneve a host has at least one active flow using a remote access protocol",
  ...
  ["edit_user_script"] = {
    ...
    ["delete_all_alert_exclusions"] = "Delete All Alert Exclusions",
