local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["nbox_service"] = "%{service} on %{host} (%{ip})",
    ["nbox_service_instance"] = "%{service} %{instance} on %{host} (%{ip})",
  ...
  ["if_stats_config"] = {
    ...
    ["note_4"] = "Threshold: select the type of threshold (Volume or Throughput) and the threshold that, if exceeded, is going to trigger an alert",
