local lang = {
  ...
  ["flow_details"] = {
    ...
    ["additional_alert_type"] = "Other Alerts",
  ...
  ["policy"] = {
    ...
    ["country_rules_descr"] = "Configure here exceptions based on Country.",
    ["default"] = "Default",
    ["default_policy"] = "Default Policy",
    ["default_policy_descr"] = "The default policy defines the default action for traffic matching the pool. Exceptions to the default policy can be configured by adding rules below.",
    ["drop"] = "Drop",
    ["edit_rule"] = "Edit Rule",
    ["host"] = "Host",
    ["host_rules"] = "Host Rules",
    ["host_rules_descr"] = "Configure here exceptions by specifying the hostname.",
    ["l7_category"] = "L7 Category",
    ["l7_category_rules"] = "L7 Category Rules",
    ["l7_category_rules_descr"] = "Configure here exceptions by specifying the traffic category.",
    ["l7_proto"] = "L7 Protocol",
    ["l7_proto_rules"] = "L7 Protocol Rules",
    ["l7_proto_rules_descr"] = "Configure here exceptions by specifying the L7/application protocol.",
    ["pass"] = "Pass",
    ["remove_rules"] = "Remove Rules",
    ["rule"] = "Rule",
    ["rules"] = "Rules",
    ["traffic_policy_for"] = "Traffic Policies For %{pool}",
  },
  ["policy_presets"] = {
    ["business"] = "Business",
