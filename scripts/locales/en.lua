local lang = {
  ...
  ["flow_callbacks_config"] = {
    ...
    ["old_ssl_version"] = "Old SSL Version",
    ["old_ssl_version_description"] = "Trigger an alert when an old (and possibly unsecure) SSL version is detected",
    ["potentially_dangerous_protocol"] = "Potentially dangerous protocol",
    ...
    ["ssl_cert_mismatch"] = "SSL Certificate Issues",
    ["ssl_cert_mismatch_description"] = "Trigger an alert when a mismatched SSL certificate is detected",
    ["ssl_unsafe_ciphers"] = "SSL Unsafe Ciphers",
    ["ssl_unsafe_ciphers_description"] = "Trigger an alert when unsafe SSL ciphers are detected",
  ...
  ["prefs"] = {
    ...
    ["n2n_supernode_description"] = "The address of the <a href=\"%{url}\">n2n</a> <i class=\"fa fa-external-link\"></i> supernode. Set up your own supernode in order to have a fully private remote access.<br><b>NOTE</b>: this change will have affect only after Remote Assistance restart.",
    ...
    ["toggle_external_alert_description"] = "Toggle alerts generated by external systems (e.g. Suricata).",
    ["toggle_external_alert_title"] = "External Alerts",
