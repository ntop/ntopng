local lang = {
  ...
  ["prefs"] = {
    ...
    ["devices_status_during_learning_description"] = "The default status of a new discovered device when the devices are still being learned.",
    ["devices_status_during_learning_title"] = "Devices/MAC Addresses Status During Learning",
    ["devices_status_post_learning_description"] = "The default status of a new discovered device after the learning period.",
    ["devices_status_post_learning_title"] = "Devices/MAC Addresses Status Post Learning",
