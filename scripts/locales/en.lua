local lang = {
  ...
  ["flow_callbacks_config"] = {
    ...
    ["suspicious_tcp_probing"] = "Susp. TCP Probing",
    ["suspicious_tcp_probing_description"] = "Trigger an alert when a possible probing attempt is detected",
    ["suspicious_tcp_syn_probing"] = "Susp. TCP SYN probing",
    ["suspicious_tcp_syn_probing_description"] = "Trigger an alert when a possible TCP SYN probing attempt is detected",
    ["tcp_connection_refused"] = "TCP connection refused",
    ["tcp_connection_refused_description"] = "Trigger an alert when a TCP connection is refused",
