local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["suspicious_file_transfer_url"] = "%{type_icon} Detected suspicious file transfer [%{url}%{info}]",
  ...
  ["prefs"] = {
    ...
    ["email_notification_server_description"] = "<b>NOTES</b>:<ul><li>GMail users need to specify smtps://smtp.gmail.com:465</li><li>GMail also requires the <a href=\"https://myaccount.google.com/lesssecureapps\">Access for less secure apps</a> to be enabled</li></ul>",
    ...
    ["toggle_asn_behavior_analysis_description"] = "Enable ASN traffic and score behavior traffic analysis. Restart is required in order this preference to have effect. (Alert available click here to configure it <a href='/lua/admin/edit_configset.lua?subdir=interface&amp;check=asn_behavior#all'><i class='fas fa-cog' title='Edit Configuration'></i></a>)",
    ["toggle_asn_behavior_analysis_title"] = "Enable ASN Behavior Analysis",
    ["toggle_network_behavior_analysis_description"] = "Enable Network traffic and score behavior traffic analysis. Restart is required in order this preference to have effect.  (Alert available click here to configure it <a href='/lua/admin/edit_configset.lua?subdir=network&amp;check=network_behavior#all'><i class='fas fa-cog' title='Edit Configuration'></i></a>)",
    ["toggle_network_behavior_analysis_title"] = "Enable Network Behavior Analysis",
    ["toggle_iface_l7_behavior_analysis_description"] = "Enable Application (per Interface) traffic behavior traffic analysis. Restart is required in order this preference to have effect. (Alert available click here to configure it <a href='/lua/admin/edit_configset.lua?subdir=interface&amp;check=l7_behavior#all'><i class='fas fa-cog' title='Edit Configuration'></i></a>)",
    ["toggle_iface_l7_behavior_analysis_title"] = "Enable Application Behavior Analysis",
