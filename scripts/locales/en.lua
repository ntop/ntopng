local lang = {
  ...
  ["system_stats"] = {
    ...
    ["clickhouse"] = {
      ...
      ["clickhouse_alerts_number"] = "Total Alerts",
      ["clickhouse_flows_number"] = "Total Flows",
      ["clickhouse_other_info"] = "Other Info:",
      ...
      ["tables_size_descr"] = "Total size of ClickHouse tables size, both flows and alert tables",
