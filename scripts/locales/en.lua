local lang = {
  ...
  ["prefs"] = {
    ...
    ["email_notification_server_description"] = "The SMTP server to deliver the email (as an example, if you are using GMail you need to specify smtps://smtp.gmail.com:465).",
