local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["lateral_movement_descr"] = "Unexpected service detected %{info} %{href}",
    ...
    ["periodicity_changed_descr"] = "Service periodicity changed %{info} %{href}",
    ["ping_issues"] = "Ping",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_tls_cert_validity_too_long"] = "LS certificate validity longer than 13 months",
