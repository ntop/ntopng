local lang = {
  ...
  ["conf_backup"] = {
    ["conf_backup"] = "Configuration Backup",
    ["backup_tab"] = "Backup",
    ["restore_tab"] = "Restore",
    ...
    ["restore_failed"] = "Unable to restore the configuration}.",
    ["restore_ok"] = "Configuration has been successfully restored.",
    ["msg_err_unknown"] = "An unknown error occurred restoring the configuration.",
    ["not_granted"] = "Configuration download not allowed.",
    ["tar_not_found"] = "Unable to find the tar binary",
  },
  ["manage_users"] = {
