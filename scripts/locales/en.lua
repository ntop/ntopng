local lang = {
  ...
  ["scan_in_progress"] = "Vulnerability scans in progress: total, it may take a while...",
  ["score"] = "Score",
  ...
  ["endpoint_notifications"] = {
    ...
    ["notifications_type_abbr"] = "Not. Type",
  ...
  ["if_stats_config"] = {
    ...
    ["automatic_reports_creation"] = "Create Reports Daily",
  ...
  ["report"] = {
    ...
    ["new_report_available_title"] = "A new report is available",
    ["new_report_available_description"] = "A new %{periodicity} report %{name} is available in ntopng in the Reports page.",
    ["period"] = "Interval",
