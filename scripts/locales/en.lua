local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["host_alert_host_ban"] = "Missbehaviour limit exceeded by %{entity}. Host has been banned from the Network [Score: ${score}][After: %{duration} mins]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["host_ban_title"] = "Ban Host",
    ["host_ban_description"] = "Trigger when an host is going to be banned soon due to his missbehaviour",
    ["host_log"] = "Host Log",
  ...
  ["policy"] = {
    ...
    ["host_rules_descr"] = "Configure here the hostname (e.g. used in TLS, DNS... proocols) exception rules.",
