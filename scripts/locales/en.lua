local lang = {
  ...
  ["about"] = {
    ...
    ["flows_limit_reached"] = "The maximum number of active flows has been reached thus not all records have been processed. This can be tuned with -X, or by clicking on the button below to increase the current number. A %{product} restart is required to apply the changes.",
  ...
  ["alert_messages"] = {
    ...
    ["host_alert_port_scan"] = "Host %{attacker} performed a port scan against the host (top 3) %{victim} [total victims: %{num_victims}]",
  ...
  ["flow_checks"] = {
    ...
    ["port_scan_title"] = "Port Scan",
    ["port_scan_description"] = "Trigger an alert when a host is running a port scan. Requires Historical Flows (ClickHouse).",
    ...
    ["unexpected_dhcp_description"] = "Trigger an alert when not allowed DHCP server is detected. See Settings / Network Configuration for configuring the list of allowed servers.",
    ["unexpected_dhcp_title"] = "Unexpected DHCP Server",
    ["unexpected_dns_description"] = "Trigger an alert when not allowed DNS server is detected. See Settings / Network Configuration for configuring the list of allowed servers.",
    ["unexpected_dns_title"] = "Unexpected DNS server",
    ["unexpected_gateway_description"] = "Trigger an alert when not allowed Gateway is detected. See Settings / Network Configuration for configuring the list of allowed servers.",
    ["unexpected_gateway_title"] = "Unexpected Gateway",
    ["unexpected_ntp_description"] = "Trigger an alert when not allowed NTP server is detected. See Settings / Network Configuration for configuring the list of allowed servers.",
    ["unexpected_ntp_title"] = "Unexpected NTP server",
    ["unexpected_smtp_description"] = "Trigger an alert when not allowed SMTP server is detected. See Settings / Network Configuration for configuring the list of allowed servers.",
  ...
  ["policy"] = {
    ...
    ["autoconfigure_sites_note"] = "In order to populate Traffic Rules, the Auto Configure feature requires the Top Visited Sites euristic to be enabled under Settings > Preferences > Applications. For best results it should be enabled at least one day before to collect enough data.",
    ["continent"] = "Continent",
  ...
  ["prefs"] = {
    ...
    ["toggle_asset_inventory_log_description"] = "Enable the log of Asset Inventory, when a change in the assets of the network is detected, it is going to be logged.",
    ["toggle_asset_inventory_log_title"] = "Enable Asset Inventory Log",
    ["toggle_assets_collection"] = "Assets Collection",
    ["toggle_assets_collection_description"] = "Enable the Assets Collection. When a Local Host appear or disappear from the network, this data is registered on the configured DB. Also a periodic update in case of changes to the host is dumped.",
    ...
    ["toggle_sites_collection_description"] = "Toggle the collection of visited domains for classification purposes under redis key ntopng.domains",
