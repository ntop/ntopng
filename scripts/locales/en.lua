local  en = {
   ...
   prefs = {
	...
	"and the incoming traffic will be diverted to one dynamic interface depending the VLAN Id value. ",
	 ...
	 "Default: 5 seconds.",
      ...
      toggle_dropped_flows_alerts_title = "Enable Dropped Flows Alerts",
      toggle_dropped_flows_alerts_description = "Enable informative alerts generated upon bridge flows drops",
   ...
   flow_details = {
      ...
      flow_blocked_by_bridge = "Flow dropped by bridge",
