local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["dangerous_host_description"] = "Triggers and alert and adds the host to the jailed hosts pool for 30 minutes, when the configured score threshold is crossed for more than 5 consecutive minutes. Hosts in the jailed hosts pool are prevented from generating traffic when using nProbe in IPS mode.",
    ...
    ["suspicious_file_transfer_url"] = "%{type_icon} Detected suspicious file transfer %{href} [%{url} %{info}]",
  ...
  ["checks"] = {
    ...
    ["factory_reset_all_message"] = "Factory reset all checks for the current configuration.",
  ...
  ["prefs"] = {
    ...
    ["toggle_date_type_description"] = "Switch between different format for date represantion",
