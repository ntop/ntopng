local lang = {
  ...
  ["scan_all_hosts"] = "Are you sure to scan all hosts?",
  ["scan_all_hosts_title"] = "Scan All Hosts",
  ["scan_host"] = "Are you sure to scan the selected host?",
  ...
  ["alert_messages"] = {
    ...
    ["device_has_connected"] = "An unexpected MAC <a href=\"%{device_url}\">%{device}</a> connected to the interface <a href=\"%{if_url}\">%{if_name}</a> <a href=\"%{exclusion_url}\"><i class=\"fas fa-external-link-alt\"></i></a>",
    ["device_has_disconnected"] = "Device <a href=\"%{device_url}\">%{device}</a> disconnected from the interface <a href=\"%{if_url}\">%{if_name}</a> <a href=\"%{exclusion_url}\"><i class=\"fas fa-external-link-alt\"></i></a>",
