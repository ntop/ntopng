local lang = {
  ...
  ["scan_host_already_inserted"] = "The host %{host} with Scan Type: %{scan_type} has already been inserted!",
  ["scan_host_inserted"] = "The host %{host} has been correctly inserted!",
