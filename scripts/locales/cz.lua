local lang = {
  ...
  ["prefs"] = {
    ...
    ["toggle_tiny_flows_dump_export_description"] = "Přepněte export malých toků, které jsou toky s několika pakety nebo bajty. Snižuje kardinálnost toku v databázích, urychluje vkládání a vyhledávání. Vyladění malých toků může pomoci omezit kardinálnost toku, aniž by se snížila viditelnost dumpingových informací.",
    ["toggle_tiny_flows_dump_export_title"] = "Export malých toků",
