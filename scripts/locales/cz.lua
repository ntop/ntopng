local lang = {
  ...
  ["protocols"] = "Protokoly",
  ["purged_error_message"] = "Je velmi pravděpodobné, že platnost vypršela a % {product} ji vymazal z paměti. Nastavení časového limitu vyprázdnění můžete nastavit z <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> Preference</a>.",
  ["quotas"] = "Kvóty",
  ["reason"] = "Důvod",
  ["received"] = "Přijato",
  ["refresh"] = "Obnovit",
  ...
  ["today"] = "Dnes",
  ["total"] = "Celkem",
  ["total_incoming_anomalous_flows"] = "Celkový počet chybných toků jako Server",
  ["total_incoming_unreachable_flows"] = "Celkový počet nedosažitelných toků jako Server",
  ["total_outgoing_anomalous_flows"] = "Celkem chybné toky jako klient",
  ...
  ["about"] = {
    ...
    ["telemetry_data_opt_out_msg"] = "Přispějte do projektu zasláním šifrovaného, <a href=\"%{tel_url}\">anonymních telemetrických dat</a> do <a href=\"%{ntop_org}\">ntop.org</a>: navštivte <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> předvolby</a> stránky a vyjádřete své preference.",
  ...
  ["alert_messages"] = {
    ...
    ["slow_stats_update"] = "Aktualizování statistik na% {iface} jsou příliš pomalé. To by mohlo vést ke ztrátě přesnosti dat a chybějícím upozorněním. Frekvence aktualizace lze naladit pomocí <a href=\"%{url}\">%{pref_name}</a> preference.",
  ...
  ["alerts_dashboard"] = {
    ...
    ["host_pool_connection"] = "Hostitelský fond Připojení,
    ...
    ["slow_stats_update"] = "Pomalá aktualizace statistik",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_add_custom_scripts"] = "%{product} hledá v nich vlastní skripty <a href=\"%{url}\"> <i class=\"fa fa-folder\"></i> adresáře</a>.",
    ...
    ["note_create_custom_scripts"] = "Dokumentace k vytvoření vlastních skriptů pro provádění zpětných volání je k dispozici zde <a href=\"%{url}\">link</a> <i class=\"fa fa-external-link\"></i>.",
  ...
  ["details"] = {
    ...
    ["ago"] = "před",
    ["alerts"] = "Upozornění",
    ["anomalous_flows_reasons"] = "Důvody neobvyklých toků",
  ...
  ["device_protocols"] = {
    ...
    ["alerts_disabled_msg"] = "Konfigurované aplikace zařízení se používají pouze ke generování výstrah aplikací zařízení, když zařízení provozuje určité aplikace, které nemá používat. Nezapomeňte povolit tato upozornění z <A HREF=\"%{url}\"><i class=\"fa fa-flask\"></i> Preferencí</A>.",
  ...
  ["flow_details"] = {
    ...
    ["additional_flow_status"] = "Další stav toku",
    ...
    ["normal"] = "Normalní",
    ["not_purged"] = "Tento tok již není aktivní a měl by být vyčištěn z paměti.",
    ...
    ["ssl_certificate_mismatch"] = "Neshoda certifikátu SSL",
    ["ssl_client_certificate"] = "Klientský certifikát",
    ["ssl_old_protocol_version"] = "Zastaralá verze protokolu SSL",
    ["ssl_server_certificate"] = "Certifikát serveru",
    ["ssl_unsafe_ciphers"] = "Nebezpečné šifrovače SSL",
  ...
  ["flow_devices"] = {
    ...
    ["note_condition_2"] = "Časové časy SNMP a tokových zařízení musí být povoleny od <A HREF=\"%{url}\"><i class=\"fa fa-flask\"></i> Preferences</A> (Expert View)",
    ...
    ["timeseries_descr"] = "Časové toky zařízení toku lze aktivovat z <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> Preference</a>.K zobrazení prvních datových bodů je třeba jen pár minut “,
  },
  ["flow_fields_description"] = {
    ...
    ["out_src_mac"] = "Zdrojová adresa MAC, potenciálně upravená funkcí middlebox za bodem pozorování,
    ...
    ["ssdp_type"] = "SSDP Typ",
    ["ssdp_usn"] = "SSDP USN",
    ["ssl_server_name"] = "Název serveru SSL “,
...
    ["ipv6_only"] = "Pouze IPv6",
    ...
    ["normal"] = "Normalní",
    ["one_way_multicast"] = "Jednosměrné vysílání,
  ...
  ["graphs"] = {
    ...
    ["custom"] = "Vlastní",
    ["dns_qry_rcvd_rsp_sent"] = "DNS Rcvd Dotazy / 	odeslané odpovědi “,
    ...
    ["tcp_packets_lost"] = "Ztracené pakety TCP,
    ...
    ["total_anomalous_flows"] = "Celkový počet chybných toků",
    ["total_unreachable_flows"] = "Celkový počet Portů nedostuných toků",
    ["traffic_txrx"] = "Provoz TX / RX ",
  ...
  ["host_details"] = {
    ...
    ["blocked_traffic"] = "	Blokovaný provoz ",
    ["disabled_flow_status_help"] = "Vypnout generování výstrah toku na základě stavu toku",
    ["host"] = "Hostitel / Host",
  ...
  ["icmp_v4_msgs"] = {
    ["type_0_0_echo_reply"] = "Echo Odpověď",
    ["type_10_0_router_selection"] = "Výběr směrovače “,
    ["type_11_0_ttl_expired_in_transit"] = "Překročený čas: TTL vypršel během přepravy “,
    ["type_11_1_fragment_reassembly_time_exceeded"] = "Překročen čas: překročena doba opětovného sestavení fragmentu",
    ["type_12_0_parameter_problem"] = "Problém s parametrem",
    ["type_13_0_timestamp_request"] = "Žádost o časové razítko ",
    ["type_14_0_timestamp_reply"] = "Odpověď na časové razítko“,
    ["type_15_0_information_request"] = "Žádost o informace",
    ["type_16_0_information_reply"] = "Informační odpověď“,
    ["type_17_0_address_mask_request"] = "Adresa Mask Požadavavek ",
    ["type_18_0_address_mask_reply"] = "Adresa Mask Odpověď",
    ["type_30_0_traceroute"] = "Traceroute",
    ["type_3_0_destination_network_unreachable"] = "Cílová síť je nedostupná “,
    ["type_3_10_communication_host_prohibited"] = "Komunikace s cílovým host je administrativně zakázána“,
    ["type_3_11_destination_network_unreachable"] = "Cílová síť není dostupná pro typ služby“,
    ["type_3_12_destination_host_unreachable"] = "Cílový hostitel nedostupný pro typ služby ",
    ["type_3_13_communication_prohibited"] = "Komunikace administrativně zakázána“,
    ["type_3_14_host_precedence_violation"] = "Porušení hostitelských preferencí ",
    ["type_3_15_precedence_cutoff"] = "Účinné omezení přednosti “,
    ["type_3_1_destination_host_unreachable"] = "Cílový hostitel nedosažitelný“,
    ["type_3_2_destination_protocol_unreachable"] = "Cílový protokol nedostupný “,
    ["type_3_3_destination_port_unreachable"] = "Cílový port je nedostupný ",
    ["type_3_4_fragmentation_required"] = "Vyžaduje se fragmentace a sada příznaků DF “,
    ["type_3_5_source_route_failed"] = "Zdrojová trasa selhala “,
    ["type_3_6_destination_network_unknown"] = "Cílová síť neznámá “,
    ["type_3_7_destination_host_unknown"] = "Cílový hostitel neznámý“,
    ["type_3_8_source_isolated"] = "Zdrojový hostitel izolován“,
    ["type_3_9_communication_network_prohibited"] = "Komunikace s cílovou sítí je administrativně zakázána“,
    ["type_4_0_source_quench"] = "Zdrojové potlačení“,
    ["type_5_0_redirect"] = "Přesměrovat",
    ["type_8_0_echo_request"] = "Echo Žádost“,
    ["type_9_0_router_advertisement"] = "Router Advertisement",
  },
  ["icmp_v4_types"] = {
    ["type_0_0_echo_reply"] = "Echo Odpověď",
    ["type_10_0_route_solicitation"] = "Vyžádání trasy",
    ["type_11_0_ttl_equals_0_during_transit"] = "TTL se během přepravy rovná 0, "
    ["type_11_1_ttl_equals_0_during_reassembly"] = "TTL se během opětovné montáže rovná 0 ",
    ["type_12_0_ip_header_bad"] = "Záhlaví IP špatné (chyba catchall) ",
    ["type_12_1_required_options_missing"] = "Chybí požadované možnosti “,
    ["type_13_0_timestamp_request"] = "Žádost o časové razítko (zastaralé) “,
    ["type_14_0_timestamp_reply"] = "Odpověď na časové razítko (zastaralá) “,
    ["type_15_0_information_request"] = "Žádost o informace (zastaralá) “,
    ["type_16_0_information_reply"] = "Odpověď na informace (zastaralá)",
    ["type_17_0_address_mask_request"] = "Žádost o masku adresy ",
    ["type_18_0_address_mask_reply"] = "Odpověď masky adresy “,
    ["type_3_0_network_unreachable"] = "Síť nedostupná“,
    ["type_3_10_destination_host_administratively_prohibited"] = "Cílový hostitel je administrativně zakázán“,
    ["type_3_11_network_unreachable_for_tos"] = "Síť nedostupná pro TOS“
    ["type_3_12_host_unreachable_for_tos"] = "Hostitel nedosažitelný pro TOS “,
    ["type_3_13_communication_administratively_prohibited_by_filtering"] = "Komunikace administrativně zakázána filtrováním",
    ["type_3_14_host_precedence_violation"] = "Porušení priority hostitele“,
    ["type_3_15_precedence_cutoff_in_effect"] = "Precedence cutoff in effect",
    ["type_3_1_host_unreachable"] = "Hostitel nedostupný ",
    ["type_3_2_protocol_unreachable"] = "Protokol nedostupný",
    ["type_3_3_port_unreachable"] = "%{protocol} Port %{dst_port} Nedostupný",
    ["type_3_4_fragmentation_needed_but_no_fragment_bit_set"] = "Fragmentace nutná, ale není nastaven žádný bit fragmentů",
    ["type_3_5_source_routing_failed"] = "Směrování zdroje se nezdařilo “,
    ["type_3_6_destination_network_unknown"] = "Cílová síť neznámá “,
    ["type_3_7_destination_host_unknown"] = "Cílový hostitel je neznámý “,
    ["type_3_8_source_host_isolated"] = "Zdrojový hostitel je izolován (zastaralý) ",
    ["type_3_9_destination_network_administratively_prohibited"] = "Cílová síť administrativně zakázána“,
    ["type_4_0_source_quench"] = "Zdrojové potlačení",
    ["type_5_0_redirect_for_network"] = "Přesměrování pro síť “,
    ["type_5_1_redirect_for_host"] = "Přesměrování na hostitele “,
    ["type_5_2_redirect_for_tos_and_network"] = "Přesměrování pro TOS a síť “,
    ["type_5_3_redirect_for_tos_and_host"] = "Přesměrování pro TOS a hostitele “,
    ["type_8_0_echo_request"] = "Echo žádost",
    ["type_9_0_router_advertisement"] = "Směrová reklama",
  },
  ["icmp_v6_msgs"] = {
    ["type_128_0_echo_request"] = "Echo Žádost",
    ["type_129_0_echo_reply"] = "Echo Odpověď",
    ["type_131_0_multicast_listener_report"] = "Zpráva vícesměrového vysílání",
    ...
    ["type_143_0_multicast_listener_report_v2"] = "Zpráva Multicast posluchače verze 2",
    ["type_1_0_destination_unreachable"] = "Cíl nedosažitelný",
    ["type_2_0_packet_too_big"] = "Paket je příliš velký",
    ["type_3_0_hop_limit_exceeded_in_transit"] = "Čas překročen: překročen limit hop při přepravě",
    ["type_3_1_fragment_reassembly_time_exceeded"] = "Čas překročen: překročena doba opětovného sestavení fragmentu",
    ["type_4_0_parameter_problem"] = "Parametrový problém",
  },
  ["icmp_v6_types"] = {
  ...
  ["nedge"] = {
    ...
    ["edit_static_route"] = "Upravit politiku směřování",
    ...
    ["remote_assistance"] = "Vzdálená asistence",
  ...
  ["prefs"] = {
    ...
    ["aggregated_flows"] = "Agregované toky",
    ...
    ["ewma_alpha_percent_title"] = "EWMA alfa koeficient (v procentech)",
    ...
    ["flow_database_dump"] = "Výpis databáze toku",
    ...
    ["local_host_cache_duration_title"] = "Trvání mezipaměti místního hostitele,
    ...
    ["max_num_aggregated_flows_per_export_description"] = "Maximální počet agregovaných toků generovaných a uložených do databáze každých 5 minut. Výchozí: 1000.",
    ["max_num_aggregated_flows_per_export_title"] = "Maximální počet agregovaných toků dumpingových každých 5 minut",
    ...
    ["mgmt_acl_description"] = "Seznam sítí IPv4 oddělených čárkami. Každá síť musí být výslovně povolena nebo zakázána s vedoucím \"+\" nebo \"-\" znamením, resp. u překrývajících se sítí se používá princip nejdelší shody. Příklady: \ "+ 127.0.0.0/8 \" zpřístupní rozhraní pouze z localhost, \ "+ 0.0.0.0/0,-192.168.0.0/16 \", zpřístupní rozhraní všem kromě 192.168.0.0/16 . Aby se změny projevily, je třeba restartovat% {product}. ",
    ...
    ["n2n_supernode_description"] = "Adresa <a href=\"%{url}\">n2n</a> <i class=\"fa fa-external-link\"></i> supernode. Nastavte si vlastní supernod, abyste měli plně soukromý vzdálený přístup.<br><b>POZNÁMKA</b>: tato změna se projeví až po restartování služby vzdálená asistance.",
    ["n2n_supernode_title"] = "Supernode",
    ["nagios_host_name_description"] = "Název_hostitele přesně podle definice hostitele Nagios pro %{product} host. Výchozí: ntopng-host",
    ["nagios_host_name_title"] = "Název hostitele Nagios",
    ["nagios_integration"] = "Nagios Integration",
    ["nagios_nsca_host_description"] = "Adresa hostitele, na kterém běží Daemon Nagios NSCA. Výchozí: localhost.",
    ["nagios_nsca_host_title"] = "Nagios NSCA Host",
    ["nagios_nsca_port_description"] = "Port kde Nagios daemon's NSCA poslouchá. Výchozí: 5667.",
    ["nagios_nsca_port_title"] = "Nagios NSCA Port",
    ["nagios_send_nsca_config_description"] = "Absolutní cesta k konfiguračnímu souboru Nagios NSCA send_nsca . Výchozí: /usr/local/nagios/etc/send_nsca.cfg",
    ["nagios_send_nsca_config_title"] = "Konfigurace Nagios send_nsca",
    ["nagios_send_nsca_executable_description"] = "Absolutní cesta k obslužnému programu Nagios NSCA send_nsca. Výchozí: /usr/local/nagios/bin/send_nsca",
    ["nagios_send_nsca_executable_title"] = "Spustitelný soubor Nagios send_nsca",
    ["nagios_service_name_description"] = "Popis služby přesně podle definice v pasivní definici služby Nagios pro %{product} hostitele. Výchozí: NtopngAlert",
    ...
    ["toggle_aggregated_flows_export_limit_description"] = "Omezte maximální počet agregovaných toků, které jsou vypouštěny každých 5 minut.",
    ["toggle_aggregated_flows_export_limit_title"] = "Omezte počet agregovaných toků",
    ["toggle_alert_nagios_description"] = "Přepnout upozornění na oznámení prostřednictvím Nagios NSCA (Nagios Service Check Acceptor).",
    ["toggle_alert_nagios_title"] = "Přepnout oznámení Nagios",
    ...
    ["toggle_arp_matrix_generation_description"] = "Přepnout generování matice interakcí ARP mezi hostitely. Restartujte %{product} ,aby změny byly účinné.",
    ["toggle_arp_matrix_generation_title"] = "ARP Matrix (Experimental)",
    ...
    ["toggle_flow_db_dump_export_description"] = "Přepněte export malých toků, které jsou toky s několika pakety nebo bajty. Snižuje kardinálnost toku v databázích, urychluje vkládání a vyhledávání. Vyladění malých toků může pomoci omezit kardinálnost toku, aniž by se snížila viditelnost dumpingových informací. ",
    ["toggle_flow_db_dump_export_title"] = "Export malých toků",
    ...
    ["toggle_ssl_alerts_description"] = "Přepnout upozornění generovaná v případě, že certifikát SSL poskytovaný serverem neodpovídá certifikátu Common Name.",
  ...
  ["remote_assistance"] = {
    ["accept_and_enable"] = "Přijmout a povolit",
    ["admin_access"] = "Dočasný přístup správce",
    ["admin_access_descr"] = "Vytvořte dočasné heslo správce pro přístup k GUI pro vzdálenou asistenci.",
    ["admin_access_key_descr"] = "Dočasné heslo správce je <b>%{pwd}</b>",
    ["ask_admin"] = "Než to uděláte, požádejte o povolení správce sítě.",
    ["check_out_the_preferences"] = "Další parametry vzdálené pomoci lze vyladit pomocí <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> Předvolby vzdálené asistance</a>.",
    ["connection_script"] = "Připojovací skript",
    ["connection_script_descr"] = "Stáhněte si skript pro připojení a poskytněte jej týmu podpory, aby se mohl připojit k této instanci ntopng. Skript bude fungovat na systémech, kde je nainstalován balíček n2n. ",
    ["enable_remote_assistance"] = "Povolit vzdálenou asistenci",
    ["gui_access_restricted_info"] = "Přístup GUI je omezen nakonfigurovaným <a href='%{url_acl}'>ACL</a> nebo cli možností (%{cli_options}). Vzdálený přístup správce může být blokován.",
    ["product_remote_assistance"] = "%{product} Vzdálená asistence",
    ["remember_disable"] = "Nezapomeňte deaktivovat vzdálenou asistenci, pokud není potřeba.",
    ["remote_assistance"] = "Vzdálená asistence",
    ["remote_ip_msg"] = "Tato instance % {product} bude přístupná dálkově na IP adrese% {ip} ",
    ["tos_notice"] = "Kliknutím \"%{button}\" poskytnete vzdálený přístup k hostiteli a zaručíte, že to vaše politiky zabezpečení sítě umožňují. ntop neodpovídá za žádné škody, narušení bezpečnosti nebo zranitelnost způsobenou povolením vzdálené asistence. ",
    ["will_create_virtual_network"] = "Pokud je tato možnost povolena, vzdálená asistance vytvoří šifrovanou virtuální síť, která se bude vzdáleně připojovat k vašemu zařízení.",
  },
  ["report"] = {
    ...
    ["symbolic_host_name_at_visualization"] = "Symbolické názvy hostitelů jsou rozlišeny během vizualizace	.",
  ...
  ["show_alerts"] = {
    ...
    ["interface_drops_threshold_descr"] = "Maximální procento vyřazených paketů z celkového počtu pozorovaných paketů rozhraní	",
    ["last_day"] = "Poslední den",
    ["last_hour"] = "Poslední hodina",
    ["last_minute"] = "Poslední minuta",
    ["minute"] = "Minuta",
  ...
  ["sites_page"] = {
    ...
    ["sites"] = "Stránky",
    ["top_sites_not_enabled_message"] = "Chcete-li sledovat navštívené weby, povolte vytváření top navštěvovaných webových stránek pro místní hostitele z <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> Preference</a>.",
  ...
  ["snmp"] = {
    ...
    ["snmp_device_polling_disabled"] = "Periodické Polling zařízení je zakázáno. Zobrazené informace mohou chybět nebo mohou být neaktuální. Polling lze povolit pomocí <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> Preference</a>.",
    ...
    ["snmp_timeseries_descr"] = "Timeseries zařízení SNMP lze povolit z  <a href=\"%{url}\"><i class=\"fa fa-flask\"></i> Preference</a>. K zobrazení prvních datových bodů je třeba jen pár minut. ",
  ...
  ["system_stats"] = {
    ...
    ["descr_influxdb_exported_points"] = "Celkový počet bodů ntopng úspěšně zapsán do InfluxDB. <a target='_blank' href='%{point_url}'>Bod %{point_fa}</a> je hodnota měření v daném čase. Body se používají k vytváření časových grafů. Příkladem bodů je počet SSL bytů odeslaných daným hostitelem v poledne a celkový počet bytů přijatých v určitém rozhraní jednu minutu po poledni. ",
  ...
  ["user_activity"] = {
    ...
    ["live_capture_host_with_filter"] = "Uživatel '%memory_vs_hosts_flows"{user}' zachytil živý provoz pro hostitele %{host} odpovídající filtr '%{filter}' na rozhraní %{ifname}.",
    ...
    ["remote_assistance_disabled"] = "Uživatel '%{user}' zakázal vzdálenou asistenci.",
    ["remote_assistance_enabled"] = "Uživatel '%{user}' povolil vzdálenou asistenci.",
