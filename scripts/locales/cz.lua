local lang = {
  ...
  ["about"] = {
    ...
    ["maxmind"] = "Tento produkt obsahuje data GeoDB vytvořená <a title=\"%{maxmind_url}\">MaxMind <i class=\"fas fa-external-link-alt\"></i></a> / <a title='https://db-ip.com'>DB-IP <i class=\"fas fa-external-link-alt\"></i></a>.",
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_create_custom_scripts"] = "Dokumentace k vytvoření vlastních skriptů pro provádění zpětných volání je k dispozici zde <a title=\"%{url}\">link <i class=\"fas fa-external-link-alt\"></i></a>.",
  ...
  ["prefs"] = {
    ...
    ["n2n_supernode_description"] = "Adresa <a title=\"%{url}\">n2n <i class=\"fas fa-external-link-alt\"></i></a> supernode. Nastavte si vlastní supernod, abyste měli plně soukromý vzdálený přístup.<br><b>POZNÁMKA</b>: tato změna se projeví až po restartování služby vzdálená asistance.",
