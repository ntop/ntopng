local lang = {
  ...
  ["alerts_thresholds_config"] = {
    ...
    ["note_create_custom_scripts"] = "Dokumentace k vytvoření vlastních skriptů pro provádění zpětných volání je k dispozici zde <a href=\"%{url}\">link</a> <i class=\"fa fa-external-link-alt\"></i>.",
  ...
  ["prefs"] = {
    ...
    ["n2n_supernode_description"] = "Adresa <a href=\"%{url}\">n2n</a> <i class=\"fa fa-external-link-alt\"></i> supernode. Nastavte si vlastní supernod, abyste měli plně soukromý vzdálený přístup.<br><b>POZNÁMKA</b>: tato změna se projeví až po restartování služby vzdálená asistance.",
