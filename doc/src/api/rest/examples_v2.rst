...
.. code:: bash
   ...
   curl -s -u admin:admin "http://localhost:3000/lua/rest/v2/get/interface/data.lua?ifid=0"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/interface/address.lua?ifid=0"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/interface/l7/stats.lua?ifid=0&ndpistats_mode=count"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/ntopng/interfaces.lua"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/host/data.lua?ifid=0&host=8.241.92.250"
...
.. code:: bash
   ...
   curl --silent --insecure -u "admin:admin" \
     ...
     "https://localhost:3001/lua/rest/v2/get/host/custom_data.lua"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/host/l7/stats.lua?ifid=0&host=8.241.92.250"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/host/interfaces.lua?host=8.241.92.250"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/flow/l4/counters.lua?ifid=0"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/flow/l7/counters.lua?ifid=0"
...
.. code:: bash
   ...
   curl -u admin:admin -H "Content-Type: application/json" -d '{"ifid": 0, "select_clause": "*", "where_clause": "IPV4_SRC_ADDR = 192.168.56.1", "begin_time_clause": 1590480290, "end_time_clause": 1590480590, "maxhits_clause": 10}' http://localhost:3000/lua/pro/rest/v2/get/db/flows.lua
...
.. code:: bash
   ...
   curl -u admin:admin -H "Content-Type: application/json" -d '{"ifid": "0", "status": "historical-flows", "epoch_begin": 1590710400, "epoch_end": 1590796800}' http://localhost:3000/lua/rest/v2/get/alert/ts.lua
...
.. code:: bash
   ...
   curl -u admin:admin http://localhost:3000/lua/rest/v2/get/alert/severity/consts.lua
...
.. code:: bash
   ...
   curl -u admin:admin http://localhost:3000/lua/rest/v2/get/alert/type/consts.lua
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/alert/severity/counters.lua?ifid=0"
...
.. code:: bash
   ...
   curl -u admin:admin "http://localhost:3000/lua/rest/v2/get/alert/type/counters.lua?ifid=0"
...
.. code:: bash
   ...
   curl -u admin:admin http://localhost:3000/lua/rest/v2/get/l7/application/consts.lua
...
.. code:: bash
   ...
   curl -u admin:admin http://localhost:3000/lua/rest/v2/get/l7/category/consts.lua
...
.. code:: bash
   ...
   curl -u admin:admin http://localhost:3000/lua/rest/v2/get/l4/protocol/consts.lua
...
.. code:: bash
    ...
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"pool": 1}' http://localhost:3000/lua/rest/v2/delete/host/pool.lua
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"pool": 2}' http://localhost:3000/lua/rest/v2/delete/host/pool.lua
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"pool": 3}' http://localhost:3000/lua/rest/v2/delete/host/pool.lua
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"pool": 4}' http://localhost:3000/lua/rest/v2/delete/host/pool.lua
...
.. code:: bash
    ...
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"pool": 1}' http://localhost:3000/lua/rest/v2/get/host/pools.lua
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{}' http://localhost:3000/lua/rest/v2/get/host/pools.lua
...
.. code:: bash
    ...
    curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"pool": 2}' http://localhost:3000/lua/rest/v2/get/host/pool/members.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" curl http://devel:3000/lua/rest/v2/get/pools.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"snmp_host":"ubnt", "snmp_read_community":"public", "snmp_version": "1"}' http://localhost:3000/lua/pro/rest/v2/add/snmp/device.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"snmp_host":"192.168.2.169", "snmp_read_community":"public", "snmp_version": "1", "cidr":"32"}' http://localhost:3000/lua/pro/rest/v2/add/snmp/device.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"snmp_host":"192.168.2.0", "snmp_read_community":"public", "snmp_version": "1", "cidr":"24"}' http://localhost:3000/lua/pro/rest/v2/add/snmp/device.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" -u admin:admin -d '{"host": "192.168.2.169", "snmp_admin_status": "up", "snmp_port_idx": 26}' http://127.0.0.1:3000/lua/pro/rest/v2/change/snmp/device/interface/status.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" -u admin:admin -d '{"host": "192.168.2.169", "snmp_admin_status": "down", "snmp_port_idx": 26}' http://127.0.0.1:3000/lua/pro/rest/v2/change/snmp/device/interface/status.lua
...
.. code:: bash
   ...
   curl -s -u admin:admin  -H "Content-Type: application/json" -d '{"username": "admin"}' "http://192.168.1.1:3000/lua/rest/v2/create/ntopng/session.lua"
