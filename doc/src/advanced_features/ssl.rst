...
.. note::
  Since ntopng packages install HTTPS enabled by default (port 3001) and HTTP disabled, a
  self-signed certificate is already generated for you on first install. Read the instructions
  below to configure your own.
