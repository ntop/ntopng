...
exclude_patterns = ['_build', 'README.md', 'example.rst']
...
latex_documents = [
    (master_doc, 'ntopng.tex', u'ntopng Documentation',
     u'ntop', 'manual'),
]
...
man_pages = [
    (master_doc, 'ntopng', u'ntopng Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ntopng', u'ntopng Documentation',
     author, 'ntop', 'High-speed packet capture, filtering and analysis',
     'Miscellaneous'),
]
