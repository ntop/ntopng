...
public:
  ...
  FlowAnomalyAlert *allocAlert(HostCheck *c, Host *h, u_int8_t cli_score, u_int8_t srv_score, bool is_both, bool is_client_alert, u_int32_t _value, u_int32_t _lower_bound, u_int32_t _upper_bound) {
