...
protected:
    u_int32_t countries_contacts_threshold;
private:
    CountriesContactsAlert *allocAlert(HostCheck *c, Host *f, risk_percentage cli_pctg, u_int32_t _countries_contacts, u_int32_t _countries_contacts_threshold) { 
