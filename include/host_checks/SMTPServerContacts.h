...
private:
  ...
  HostAlert *allocAlert(HostCheck *c, Host *f, u_int8_t cli_score, u_int8_t srv_score, u_int64_t _contacts, u_int64_t _contacts_threshold) { return new SMTPServerContactsAlert(c, f, cli_score, srv_score, _contacts, _contacts_threshold); };
