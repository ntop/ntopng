...
class FlowFloodAlert : public FlowHitsAlert {
 ...
 public:
  ...
  FlowFloodAlert(HostCheck *c, Host *h, u_int8_t cli_score, u_int8_t srv_score, u_int16_t hits, u_int64_t threshold, bool is_attacker) : FlowHitsAlert(c, h, cli_score, srv_score, hits, threshold, is_attacker) {};
  ~FlowFloodAlert() {};
