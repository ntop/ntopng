...
#ifndef _FR_RISKY_DOMAIN_ALERT_H_
#define _FR_RISKY_DOMAIN_ALERT_H_

#include "ntop_includes.h"

class FlowRiskRiskyDomainAlert : public FlowRiskAlert {
 public:
  static ndpi_risk_enum getClassRisk() { return NDPI_RISKY_DOMAIN; }
