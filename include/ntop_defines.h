...
#define ALERTS_MANAGER_STORE_NAME            "alerts_v19.db"
...
#define THREADED_ACTIVITY_STATS_SLOW_RRD_MS   5  /* RRD are slow if an update takes more than 5 millis */
...
#define HTTP_MAX_POST_DATA_LEN          65536
