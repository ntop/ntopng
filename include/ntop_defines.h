...
#define CONST_IFACE_SYN_ATTACKER_ALERT      "ntopng.prefs.%s:%d.syn_attacker_threshold"
#define CONST_IFACE_SYN_VICTIM_ALERT        "ntopng.prefs.%s:%d.syn_victim_threshold"
#define CONST_IFACE_FLOW_ATTACKER_RATE      "ntopng.prefs.%s:%d.flow_attacker_threshold"
#define CONST_IFACE_FLOW_VICTIM_RATE        "ntopng.prefs.%s:%d.flow_victim_threshold"
