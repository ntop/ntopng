...
class Ntop {
 ...
 public:
  ...
  inline void recipient_delete(u_int16_t recipient_id) { recipients.delete_recipient(recipient_id); };
  inline void recipients_refresh()                     { recipients.refresh_recipients();           };
