...
class Utils {
 ...
 public:
  ...
  static u_int16_t getNumCores();
  static u_int16_t getNumHTTPServerThreads();
  static u_int16_t getNumHTTPWebSocketServerThreads();
  static u_int16_t getMaxNumHTTPServerThreadsPerHost();
